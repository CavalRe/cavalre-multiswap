...
var Swap = (props) => {
  ...
  const receiverComponent = (props2) => {
    ...
    const handleAllocationChange = (allocation) => {
      token.allocation = allocation ? allocation : 0;
      setTotalAllocation(Object.values(assetTokens).map((asset) => asset.allocation).reduce((p, c) => p + c));
    };
    return /* @__PURE__ */ React.createElement(Card, {
      radius: "md",
      mt: "xs"
  ...
  }), /* @__PURE__ */ React.createElement(Text, null, `Total allocation: ${totalAllocation}`));
};
...
//# sourceMappingURL=/build/_shared/chunk-E43YNNGP.js.map
