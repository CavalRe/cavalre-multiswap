...
function useMantineDefaultProps(component, defaultProps13, props) {
  var _a, _b;
  ...
  return __spreadValues3(__spreadValues3(__spreadValues3({}, defaultProps13), contextProps), props);
}
...
function MantineProvider({
  ...
  const overrides = {
    ...
    defaultProps: inherit ? __spreadValues3(__spreadValues3({}, ctx.defaultProps), defaultProps13) : defaultProps13
  };
...
init_react();
var useStyles10 = createStyles((theme, { fluid, size: size2, sizes: sizes3 }) => ({
  root: {
...
var Container = (0, import_react22.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Container", defaultProps9, props), { className, fluid, size: size2, styles: styles2, classNames, sizes: sizes3 } = _a, others = __objRest15(_a, ["className", "fluid", "size", "styles", "classNames", "sizes"]);
  const { classes, cx } = Container_styles_default({ fluid, size: size2, sizes: sizes3 }, { styles: styles2, classNames, name: "Container" });
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-EG542ING.js.map
