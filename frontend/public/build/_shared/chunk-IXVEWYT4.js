...
function useMantineDefaultProps(component, defaultProps26, props) {
  var _a, _b;
  ...
  return __spreadValues3(__spreadValues3(__spreadValues3({}, defaultProps26), contextProps), props);
}
...
function MantineProvider({
  ...
  const overrides = {
    ...
    defaultProps: inherit ? __spreadValues3(__spreadValues3({}, ctx.defaultProps), defaultProps26) : defaultProps26
  };
...
function createStyles(getCssObjectOrCssObject) {
  ...
  function useStyles26(params, options) {
    const theme = useMantineTheme();
...
var useStyles14 = createStyles((theme, { color, radius: radius2, variant }, getRef2) => ({
  root: __spreadProps13(__spreadValues34({}, theme.fn.fontStyles()), {
    position: "relative",
    overflow: "hidden",
  ...
  message: __spreadProps13(__spreadValues34({}, theme.fn.fontStyles()), {
    lineHeight: theme.lineHeight,
    textOverflow: "ellipsis",
    overflow: "hidden",
    fontSize: theme.fontSizes.sm,
...
var Alert_styles_default = useStyles14;
...
var Alert = (0, import_react40.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Alert", defaultProps14, props), {
    className,
    title,
    variant,
    children,
  ...
  }, icon && /* @__PURE__ */ import_react40.default.createElement("div", {
    className: classes.icon
  }, icon), /* @__PURE__ */ import_react40.default.createElement("div", {
    className: classes.body
  }, title && /* @__PURE__ */ import_react40.default.createElement("div", {
    className: classes.title
  }, /* @__PURE__ */ import_react40.default.createElement("span", {
    className: classes.label
  }, title), withCloseButton && /* @__PURE__ */ import_react40.default.createElement(CloseButton, {
...
var useStyles15 = createStyles((theme, {
  ...
  return {
    root: __spreadProps14(__spreadValues36(__spreadValues36(__spreadValues36({}, theme.fn.fontStyles()), theme.fn.focusStyles()), getLineClamp(lineClamp)), {
...
var Text_styles_default = useStyles15;
...
var Text = (0, import_react41.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Text", defaultProps15, props), {
    className,
    component,
    size: size2 = "md",
    weight,
  ...
  return /* @__PURE__ */ import_react41.default.createElement(Box, __spreadValues37({
    ref,
    component: component || "div",
...
init_react();
var useStyles16 = createStyles((theme, { scrollbarSize, offsetScrollbars, scrollbarHovered }, getRef2) => ({
  root: {
    overflow: "hidden"
  },
  viewport: {
...
var ScrollArea_styles_default = useStyles16;
...
var ScrollArea2 = (0, import_react42.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("ScrollArea", defaultProps16, props), {
    children,
    className,
    classNames,
    styles: styles2,
  ...
  const [scrollbarHovered, setScrollbarHovered] = (0, import_react42.useState)(false);
  const theme = useMantineTheme();
  ...
  return /* @__PURE__ */ import_react42.default.createElement(Root, {
    type,
    scrollHideDelay,
    dir: dir || theme.dir,
    ref,
    asChild: true
  }, /* @__PURE__ */ import_react42.default.createElement(Box, __spreadValues38({
    className: cx(classes.root, className)
  }, others), /* @__PURE__ */ import_react42.default.createElement(Viewport, {
  ...
  }, children), /* @__PURE__ */ import_react42.default.createElement(Scrollbar, {
    orientation: "horizontal",
    className: classes.scrollbar,
    forceMount: true,
    onMouseEnter: () => setScrollbarHovered(true),
    onMouseLeave: () => setScrollbarHovered(false)
  }, /* @__PURE__ */ import_react42.default.createElement(Thumb, {
    className: classes.thumb
  })), /* @__PURE__ */ import_react42.default.createElement(Scrollbar, {
    ...
    className: classes.thumb
  })), /* @__PURE__ */ import_react42.default.createElement(Corner, {
...
var SelectScrollArea = (0, import_react43.forwardRef)((_a, ref) => {
  var _b = _a, { style } = _b, others = __objRest23(_b, ["style"]);
  return /* @__PURE__ */ import_react43.default.createElement(ScrollArea2, __spreadProps15(__spreadValues39({}, others), {
    style: __spreadValues39({ width: "100%" }, style),
    viewportRef: ref
  }), others.children);
});
...
var useStyles17 = createStyles((theme, { native }) => ({
  dropdown: __spreadProps16(__spreadValues40({}, theme.fn.fontStyles()), {
    boxSizing: "border-box",
    pointerEvents: "auto",
    backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[6] : theme.white,
...
var SelectDropdown_styles_default = useStyles17;
...
var useIsomorphicLayoutEffect = typeof window !== "undefined" && window.document && window.document.createElement ? React30.useLayoutEffect : React30.useEffect;
...
function PopperContainer({
  ...
  if (withinPortal) {
    return /* @__PURE__ */ import_react44.default.createElement(Portal, {
      className,
      zIndex
    }, children);
  }
...
var useStyles18 = createStyles((theme, { arrowSize, arrowDistance }, getRef2) => {
  ...
  return {
    ...
    left: __spreadProps17(__spreadValues41({}, horizontalPlacement(arrowSize, arrowDistance, placementClasses)), {
    ...
    right: __spreadProps17(__spreadValues41({}, horizontalPlacement(arrowSize, arrowDistance, placementClasses)), {
    ...
    top: __spreadProps17(__spreadValues41({}, verticalPlacement(arrowSize, arrowDistance, placementClasses, theme)), {
      bottom: -arrowSize,
      borderLeft: theme.dir === "ltr" ? 0 : void 0,
      borderRight: theme.dir === "rtl" ? 0 : void 0,
      borderTop: 0
    }),
    bottom: __spreadProps17(__spreadValues41({}, verticalPlacement(arrowSize, arrowDistance, placementClasses, theme)), {
      top: -arrowSize,
      borderRight: theme.dir === "ltr" ? 0 : void 0,
      borderLeft: theme.dir === "rtl" ? 0 : void 0,
      borderBottom: 0
...
var Popper_styles_default = useStyles18;
...
function getTransitionStyles({
  ...
  if (typeof transition === "string") {
    ...
    return __spreadValues42(__spreadValues42(__spreadValues42({
...
function Transition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react46.default.createElement(import_react46.default.Fragment, null, children({})) : null;
  }
  return transitionStatus === "exited" ? null : /* @__PURE__ */ import_react46.default.createElement(import_react46.default.Fragment, null, children(getTransitionStyles({
    transition,
...
function Popper({
  ...
  const [popperElement, setPopperElement] = (0, import_react47.useState)(null);
  ...
  return /* @__PURE__ */ import_react47.default.createElement(Transition, {
  ...
  }, (transitionStyles) => /* @__PURE__ */ import_react47.default.createElement("div", null, /* @__PURE__ */ import_react47.default.createElement(PopperContainer, {
    withinPortal,
    zIndex
  }, /* @__PURE__ */ import_react47.default.createElement("div", __spreadValues43({
    ref: setPopperElement,
    style: __spreadProps18(__spreadValues43({}, styles2.popper), { pointerEvents: "none" })
  }, attributes.popper), /* @__PURE__ */ import_react47.default.createElement("div", {
    style: transitionStyles
  }, children, withArrow && /* @__PURE__ */ import_react47.default.createElement("div", {
    style: arrowStyle,
...
// node_modules/@mantine/core/esm/components/Select/SelectDropdown/SelectDropdown.js
var SelectDropdown = (0, import_react48.forwardRef)(({
  mounted,
  transition,
  transitionDuration,
  transitionTimingFunction,
  ...
  const previousPlacement = (0, import_react48.useRef)("bottom");
  return /* @__PURE__ */ import_react48.default.createElement(Popper, {
    referenceElement,
    mounted,
    transition,
    transitionDuration,
  ...
  }, /* @__PURE__ */ import_react48.default.createElement(Paper, {
    radius: "sm",
...
var useStyles19 = createStyles((theme, { size: size2, variant, color }) => ({
  withLabel: {
...
var Divider_styles_default = useStyles19;
...
var Divider = (0, import_react49.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react49.default.createElement(Box, __spreadValues44({
    ref,
    className: cx({
  ...
  }, others), !!label && horizontal && /* @__PURE__ */ import_react49.default.createElement(Text, __spreadProps19(__spreadValues44({}, labelProps), {
    color: _color,
...
var SelectItems_styles_default = useStyles20;
...
function SelectItems({
  ...
  const constructItemComponent = (item, index) => {
    ...
    return /* @__PURE__ */ import_react50.default.createElement(Item, __spreadValues45({
      key: item.value,
  ...
  data.forEach((item, index) => {
    if (item.creatable) {
      ...
      if (groupName !== item.group) {
        ...
        groupedItems.push(/* @__PURE__ */ import_react50.default.createElement("div", {
          className: classes.separator,
          key: index
        }, /* @__PURE__ */ import_react50.default.createElement(Divider, {
  ...
  if (creatable) {
    ...
    unGroupedItems.push(/* @__PURE__ */ import_react50.default.createElement("div", {
  ...
  if (groupedItems.length > 0 && unGroupedItems.length > 0) {
    unGroupedItems.unshift(/* @__PURE__ */ import_react50.default.createElement("div", {
      className: classes.separator
    }, /* @__PURE__ */ import_react50.default.createElement(Divider, null)));
  }
  return groupedItems.length > 0 || unGroupedItems.length > 0 ? /* @__PURE__ */ import_react50.default.createElement(import_react50.default.Fragment, null, groupedItems, unGroupedItems) : /* @__PURE__ */ import_react50.default.createElement(Text, {
    size: size2,
...
var DefaultItem = (0, import_react51.forwardRef)((_a, ref) => {
  var _b = _a, { label, value } = _b, others = __objRest25(_b, ["label", "value"]);
  return /* @__PURE__ */ import_react51.default.createElement("div", __spreadValues46({
    ref
  }, others), label || value);
});
...
var useStyles21 = createStyles((theme, { size: size2 }) => ({
  root: __spreadProps20(__spreadValues47({}, theme.fn.fontStyles()), {
    lineHeight: theme.lineHeight
  }),
  label: {
    display: "inline-block",
...
var InputWrapper_styles_default = useStyles21;
...
var InputWrapper = (0, import_react52.forwardRef)((props, ref) => {
  ...
  const inputLabel = (0, import_react52.createElement)(labelElement, __spreadProps21(__spreadValues48(__spreadValues48({}, _labelProps), labelProps), {
    id: id ? `${id}-label` : void 0,
    className: classes.label
  }), /* @__PURE__ */ import_react52.default.createElement(import_react52.default.Fragment, null, label, required && /* @__PURE__ */ import_react52.default.createElement("span", {
    className: classes.required
  }, " *")));
  return /* @__PURE__ */ import_react52.default.createElement(Box, __spreadValues48({
    className: cx(classes.root, className),
    ref
  }, others), label && inputLabel, description && /* @__PURE__ */ import_react52.default.createElement(Text, __spreadProps21(__spreadValues48({}, descriptionProps), {
    color: "gray",
    className: classes.description
  }), description), children, typeof error !== "boolean" && error && /* @__PURE__ */ import_react52.default.createElement(Text, __spreadProps21(__spreadValues48({}, errorProps), {
    size: size2,
...
var Input = (0, import_react53.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react53.default.createElement(Box, __spreadValues49(__spreadValues49({
    className: cx(classes.wrapper, className),
    sx,
    style
  }, systemStyles), wrapperProps), icon && /* @__PURE__ */ import_react53.default.createElement("div", {
    className: classes.icon
  }, icon), /* @__PURE__ */ import_react53.default.createElement(Element2, __spreadProps22(__spreadValues49({}, rest), {
    ref,
    required,
  ...
  })), rightSection && /* @__PURE__ */ import_react53.default.createElement("div", __spreadProps22(__spreadValues49({}, rightSectionProps), {
...
function OptionalPortal(_a) {
  var _b = _a, { withinPortal = true, children } = _b, others = __objRest28(_b, ["withinPortal", "children"]);
  if (withinPortal) {
    return /* @__PURE__ */ import_react54.default.createElement(Portal, __spreadValues50({}, others), children);
  }
  return /* @__PURE__ */ import_react54.default.createElement(import_react54.default.Fragment, null, children);
}
...
function GroupedTransition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react55.default.createElement(import_react55.default.Fragment, null, children({})) : null;
  }
  ...
  return /* @__PURE__ */ import_react55.default.createElement(import_react55.default.Fragment, null, children(transitionsStyles));
}
...
var Overlay = (0, import_react56.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Overlay", defaultProps20, props), { opacity, blur, color, gradient, zIndex, component, radius: radius2, sx } = _a, others = __objRest29(_a, ["opacity", "blur", "color", "gradient", "zIndex", "component", "radius", "sx"]);
  ...
  const innerOverlay = (otherProps) => /* @__PURE__ */ import_react56.default.createElement(Box, __spreadValues51({
    component: component || "div",
    ref,
    sx: [
      (theme) => __spreadProps23(__spreadValues51(__spreadValues51({}, background), baseStyles), {
        opacity,
  ...
  if (blur) {
    return /* @__PURE__ */ import_react56.default.createElement(Box, __spreadValues51({
      sx: [
        () => __spreadProps23(__spreadValues51({}, baseStyles), {
...
function Modal(props) {
  const _a = useMantineDefaultProps("Modal", defaultProps21, props), {
    className,
    opened,
    title,
    onClose,
  ...
  return /* @__PURE__ */ import_react57.default.createElement(OptionalPortal, {
    withinPortal,
    zIndex,
    target
  }, /* @__PURE__ */ import_react57.default.createElement(GroupedTransition, {
  ...
  }, (transitionStyles) => /* @__PURE__ */ import_react57.default.createElement(Box, __spreadValues52({
    className: cx(classes.root, className)
  }, others), /* @__PURE__ */ import_react57.default.createElement("div", {
    className: classes.inner,
    ...
    ref: focusTrapRef
  }, /* @__PURE__ */ import_react57.default.createElement(Paper, {
    ...
    "aria-modal": true,
    tabIndex: -1,
    style: __spreadProps24(__spreadValues52({}, transitionStyles.modal), {
      marginLeft: "calc(var(--removed-scroll-width, 0px) * -1)",
      zIndex: 3
    })
  }, (title || withCloseButton) && /* @__PURE__ */ import_react57.default.createElement("div", {
    className: classes.header
  }, /* @__PURE__ */ import_react57.default.createElement(Text, {
    id: titleId,
    className: classes.title
  }, title), withCloseButton && /* @__PURE__ */ import_react57.default.createElement(CloseButton, {
    iconSize: 16,
    onClick: onClose,
    "aria-label": closeButtonLabel,
    ...
    id: bodyId,
    className: classes.body
  }, children))), /* @__PURE__ */ import_react57.default.createElement("div", {
    style: transitionStyles.overlay
  }, /* @__PURE__ */ import_react57.default.createElement(Overlay, {
...
function DefaultValue(_a) {
  ...
  return /* @__PURE__ */ import_react58.default.createElement("div", __spreadValues53({
    className: cx(classes.defaultValue, className)
  }, others), /* @__PURE__ */ import_react58.default.createElement("span", {
    className: classes.label
  }, label), !disabled && /* @__PURE__ */ import_react58.default.createElement(CloseButton, {
    "aria-hidden": true,
...
function ChevronIcon(_a) {
  var _b = _a, { size: size2, error, style } = _b, others = __objRest32(_b, ["size", "error", "style"]);
  const theme = useMantineTheme();
  const _size = theme.fn.size({ size: size2, sizes: iconSizes2 });
  return /* @__PURE__ */ import_react59.default.createElement("svg", __spreadValues54({
    width: _size,
    height: _size,
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg",
    style: __spreadValues54({ color: error ? theme.colors.red[6] : theme.colors.gray[6] }, style),
    "data-chevron": true
  }, others), /* @__PURE__ */ import_react59.default.createElement("path", {
...
function SelectRightSection({
  ...
  return shouldClear ? /* @__PURE__ */ import_react60.default.createElement(CloseButton, {
    variant: "transparent",
    "aria-label": clearButtonLabel,
    onClick: onClear,
    size: size2
  }) : /* @__PURE__ */ import_react60.default.createElement(ChevronIcon, {
    error,
    size: size2
  });
}
...
function getSelectRightSectionProps(_a) {
  ...
  return {
    ...
    rightSection: !(props.disabled && props.shouldClear) && /* @__PURE__ */ import_react61.default.createElement(SelectRightSection, __spreadValues55({}, props)),
    styles: __spreadProps25(__spreadValues55({}, _styles), {
      rightSection: __spreadProps25(__spreadValues55({}, _styles == null ? void 0 : _styles.rightSection), {
...
var MultiSelect = (0, import_react62.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("MultiSelect", defaultProps22, props), {
    className,
    style,
    required,
    label,
  ...
  const { systemStyles, rest } = extractSystemStyles(others);
  const dropdownRef = (0, import_react62.useRef)();
  const inputRef = (0, import_react62.useRef)();
  const wrapperRef = (0, import_react62.useRef)();
  const itemsRefs = (0, import_react62.useRef)({});
  const uuid = useUuid(id);
  const [dropdownOpened, _setDropdownOpened] = (0, import_react62.useState)(initiallyOpened);
  const [hovered, setHovered] = (0, import_react62.useState)(-1);
  const [direction, setDirection] = (0, import_react62.useState)("column");
  const [searchValue, setSearchValue] = (0, import_react62.useState)("");
  ...
  const valuesOverflow = (0, import_react62.useRef)(!!maxSelectedValues && maxSelectedValues < _value.length);
  ...
  const selectedItems = _value.map((val) => {
    ...
    return selectedItem;
  }).filter((val) => !!val).map((item) => /* @__PURE__ */ import_react62.default.createElement(Value, __spreadProps26(__spreadValues56({}, item), {
    disabled,
  ...
  return /* @__PURE__ */ import_react62.default.createElement(InputWrapper, __spreadValues56(__spreadValues56({
    required,
    id: uuid,
    label,
    error,
    ...
    sx
  }, systemStyles), wrapperProps), /* @__PURE__ */ import_react62.default.createElement("div", {
    className: classes.wrapper,
    role: "combobox",
    ...
    tabIndex: -1,
    ref: wrapperRef
  }, /* @__PURE__ */ import_react62.default.createElement(Input, __spreadValues56({
    __staticSelector: "MultiSelect",
    ...
    classNames: __spreadProps26(__spreadValues56({}, classNames), {
  ...
  }, selectedItems, /* @__PURE__ */ import_react62.default.createElement("input", __spreadValues56({
    ...
    name,
    autoComplete: "nope"
  }, rest)))), /* @__PURE__ */ import_react62.default.createElement(SelectDropdown, {
    ...
    zIndex,
    dropdownPosition
  }, /* @__PURE__ */ import_react62.default.createElement(SelectItems, {
    data: filteredData,
    hovered,
    classNames,
    styles: styles2,
...
var NativeSelect = (0, import_react63.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("NativeSelect", defaultProps23, props), {
    id,
    className,
    required,
    label,
  ...
  const { systemStyles, rest } = extractSystemStyles(others);
  const formattedData = data.map((item) => typeof item === "string" ? { label: item, value: item } : item);
  const options = formattedData.map((item) => /* @__PURE__ */ import_react63.default.createElement("option", {
    key: item.value,
    value: item.value,
    disabled: item.disabled
  }, item.label));
  if (placeholder) {
    options.unshift(/* @__PURE__ */ import_react63.default.createElement("option", {
      key: "placeholder",
      value: "",
      disabled: true,
      hidden: true
  ...
  return /* @__PURE__ */ import_react63.default.createElement(InputWrapper, __spreadValues57(__spreadValues57({
    required,
    id: uuid,
    label,
    error,
  ...
  }, systemStyles), wrapperProps), /* @__PURE__ */ import_react63.default.createElement(Input, __spreadValues57(__spreadProps27(__spreadValues57({}, rest), {
    onChange,
    component: "select",
    invalid: !!error,
    style: inputStyle,
...
var __spreadProps28 = (a, b2) => __defProps28(a, __getOwnPropDescs28(b2));
...
var TextInput = (0, import_react64.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("TextInput", defaultProps24, props), {
    className,
    id,
    label,
    error,
  ...
  const uuid = useUuid(id);
  const { systemStyles, rest } = extractSystemStyles(others);
  return /* @__PURE__ */ import_react64.default.createElement(InputWrapper, __spreadValues58(__spreadValues58({
    required,
    id: uuid,
    label,
    error,
    ...
    __staticSelector,
    sx
  }, systemStyles), wrapperProps), /* @__PURE__ */ import_react64.default.createElement(Input, __spreadProps28(__spreadValues58({}, rest), {
    required,
    ref,
    id: uuid,
    type,
...
var useStyles25 = createStyles((theme, { radius: radius2, size: size2 }) => ({
  rightSection: {
    display: "flex",
    flexDirection: "column",
    height: "calc(100% - 2px)",
...
var NumberInput_styles_default = useStyles25;
...
var __spreadProps29 = (a, b2) => __defProps29(a, __getOwnPropDescs29(b2));
...
var NumberInput = (0, import_react65.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("NumberInput", defaultProps25, props), {
    disabled,
    value,
    onChange,
    decimalSeparator,
  ...
  const [_value, setValue] = (0, import_react65.useState)(typeof value === "number" ? value : typeof defaultValue === "number" ? defaultValue : void 0);
  const finalValue = typeof value === "number" ? value : _value;
  const [tempValue, setTempValue] = (0, import_react65.useState)(typeof finalValue === "number" ? finalValue.toFixed(precision) : "");
  const inputRef = (0, import_react65.useRef)();
  ...
  const incrementRef = (0, import_react65.useRef)();
  ...
  const decrementRef = (0, import_react65.useRef)();
  ...
  const onStepTimeoutRef = (0, import_react65.useRef)(null);
  const stepCountRef = (0, import_react65.useRef)(0);
  const onStepDone = () => {
  ...
  const controls = /* @__PURE__ */ import_react65.default.createElement("div", {
    className: classes.rightSection
  ...
  return /* @__PURE__ */ import_react65.default.createElement(TextInput, __spreadProps29(__spreadValues59({}, others), {
    variant,
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-IXVEWYT4.js.map
