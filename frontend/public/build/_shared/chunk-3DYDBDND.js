...
var Swap = (props) => {
  ...
  const payerComponent = (props2) => {
    ...
    return /* @__PURE__ */ React.createElement(Card, {
      ...
      onChange: (a) => handleAmountChange2(a),
      min: 0
  ...
  const receiverComponent = (props2) => {
    const { token } = props2;
    const handleAllocationChange2 = (allocation) => {
    ...
    return /* @__PURE__ */ React.createElement(Card, {
      ...
      onChange: (a) => handleAllocationChange2(a),
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(SimpleGrid, {
    ...
    handleNumberChange: handleAllocationChange,
    isPay: false,
...
//# sourceMappingURL=/build/_shared/chunk-3DYDBDND.js.map
