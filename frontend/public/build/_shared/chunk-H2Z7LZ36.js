...
var TokenSelect = (props) => {
  const { title, names, placeholder } = props;
  ...
  return /* @__PURE__ */ React.createElement(Card, {
    ...
    order: 4
  }, title), value.map((value2, key) => {
    return /* @__PURE__ */ React.createElement(PayItem, {
      value: value2,
      key
    });
...
//# sourceMappingURL=/build/_shared/chunk-H2Z7LZ36.js.map
