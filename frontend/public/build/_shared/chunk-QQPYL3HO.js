...
var TokenSelect = (props) => {
  ...
  const setToken = (v, token, totalAllocation) => {
    ...
    } else if (isPay && token.selection !== "Receive" || !isPay && token.selection !== "Pay") {
      console.log("Setting token to 'Neither'");
...
//# sourceMappingURL=/build/_shared/chunk-QQPYL3HO.js.map
