...
var Swap = (props) => {
  ...
  })), /* @__PURE__ */ React.createElement(Text, null, `Total allocation: ${(100 * totalAllocation).toFixed(2)}%`), moralis.User.current() ? /* @__PURE__ */ React.createElement(Button, {
    type: "submit",
    onClick: handleSwap,
    mt: "xl",
    size: "md",
...
//# sourceMappingURL=/build/_shared/chunk-4BOPYYTB.js.map
