...
function useMantineDefaultProps(component, defaultProps9, props) {
  var _a, _b;
  ...
  return __spreadValues3(__spreadValues3(__spreadValues3({}, defaultProps9), contextProps), props);
}
...
function MantineProvider({
  ...
  const overrides = {
    ...
    defaultProps: inherit ? __spreadValues3(__spreadValues3({}, ctx.defaultProps), defaultProps9) : defaultProps9
  };
...
init_react();
var useStyles5 = createStyles((theme, { fluid, size: size2, sizes: sizes3 }) => ({
  root: {
...
var Container = (0, import_react17.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Container", defaultProps5, props), { className, fluid, size: size2, styles: styles2, classNames, sizes: sizes3 } = _a, others = __objRest10(_a, ["className", "fluid", "size", "styles", "classNames", "sizes"]);
...
var useStyles9 = createStyles((theme, { height, fixed, position: position2, zIndex }) => ({
  root: __spreadProps9(__spreadValues22(__spreadValues22({}, theme.fn.fontStyles()), position2), {
    zIndex,
    height,
    maxHeight: height,
...
var Header = (0, import_react22.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Header", defaultProps8, props), { children, className, classNames, styles: styles2, height, fixed, position: position2, zIndex } = _a, others = __objRest14(_a, ["children", "className", "classNames", "styles", "height", "fixed", "position", "zIndex"]);
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-NGPX6DZZ.js.map
