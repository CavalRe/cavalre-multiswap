...
var Swap = (props) => {
  ...
  const TokenSelect = (props2) => {
    var _a;
    const { title, poolTokens: poolTokens2, assetTokens: assetTokens2, tokenComponent, placeholder } = props2;
    const TokenComponent = tokenComponent;
    const items = (_a = Object.values(assetTokens2)) == null ? void 0 : _a.map((t) => {
      return {
...
//# sourceMappingURL=/build/_shared/chunk-MXQLZFPK.js.map
