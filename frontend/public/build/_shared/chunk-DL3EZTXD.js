...
var Swap = (props) => {
  ...
  const TokenSelect = (props2) => {
    ...
    const items = Object.values(assetTokens).filter((t) => isPay ? true : !t.isPay).map((t) => {
      return {
    ...
    const handleSelect = (v) => {
      setValue(v);
      console.log(Object.values(assetTokens));
...
//# sourceMappingURL=/build/_shared/chunk-DL3EZTXD.js.map
