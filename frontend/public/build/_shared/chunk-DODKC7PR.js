...
var PayComponent = (props) => {
  const { token, swapState, setSwapState } = props;
...
var Swap = (props) => {
  ...
  const getQuotes = () => {
    ...
    let newPoolTokens = poolToken.outstanding + poolToken.amount;
    const selectedPayTokens = Object.values(assetTokens).filter((asset) => asset.isPay);
    const selectedReceiveTokens = Object.values(assetTokens).filter((asset) => asset.isReceive);
...
//# sourceMappingURL=/build/_shared/chunk-DODKC7PR.js.map
