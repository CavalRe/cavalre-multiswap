...
init_react();
var useStyles3 = createStyles((theme, { fluid, size: size2, sizes: sizes3 }) => ({
  root: {
...
var Container = (0, import_react12.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Container", defaultProps3, props), { className, fluid, size: size2, styles: styles2, classNames, sizes: sizes3 } = _a, others = __objRest5(_a, ["className", "fluid", "size", "styles", "classNames", "sizes"]);
...
var useStyles7 = createStyles((theme, { height, fixed, position: position2, zIndex }) => ({
  root: __spreadProps7(__spreadValues19(__spreadValues19({}, theme.fn.fontStyles()), position2), {
    zIndex,
    height,
    maxHeight: height,
...
var Header_styles_default = useStyles7;
...
var Header = (0, import_react21.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Header", defaultProps7, props), { children, className, classNames, styles: styles2, height, fixed, position: position2, zIndex } = _a, others = __objRest13(_a, ["children", "className", "classNames", "styles", "height", "fixed", "position", "zIndex"]);
...
var useStyles8 = createStyles((theme, {
  ...
  return {
    ...
    input: variant === "headless" ? {} : __spreadProps8(__spreadValues21(__spreadProps8(__spreadValues21({}, theme.fn.fontStyles()), {
...
var useStyles9 = createStyles((theme, {
  ...
  return {
    ...
    root: __spreadProps9(__spreadValues22(__spreadValues22(__spreadValues22(__spreadValues22({}, getSizeStyles({ compact, size: size2 })), theme.fn.fontStyles()), theme.fn.focusStyles()), getWidthStyles(fullWidth)), {
      borderRadius: theme.fn.radius(radius2),
      fontWeight: 600,
      position: "relative",
      lineHeight: 1,
...
var Button_styles_default = useStyles9;
...
var Button = (0, import_react22.forwardRef)((props, ref) => {
  ...
  const loader = /* @__PURE__ */ import_react22.default.createElement(Loader, __spreadValues23({
    color: colors.color,
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-P2OQPIKE.js.map
