...
var Group = (0, import_react12.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react12.default.createElement(Box, __spreadValues10({
    className: cx(classes.root, className),
    ref
  }, others), items);
});
...
var Container = (0, import_react13.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Container", defaultProps4, props), { className, fluid, size: size2, styles: styles2, classNames, sizes: sizes4 } = _a, others = __objRest6(_a, ["className", "fluid", "size", "styles", "classNames", "sizes"]);
...
function ListItem(_a) {
  ...
  }, icon), /* @__PURE__ */ import_react14.default.createElement("span", null, children)));
}
...
var List = (0, import_react16.forwardRef)((props, ref) => {
...
var useStyles7 = createStyles((theme, { captionSide, horizontalSpacing, verticalSpacing }, getRef2) => {
  ...
  return {
    striped,
    hover,
    root: __spreadProps6(__spreadValues15({}, theme.fn.fontStyles()), {
      width: "100%",
...
var Table = (0, import_react17.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Table", defaultProps6, props), {
    className,
    children,
    striped,
    highlightOnHover,
  ...
  return /* @__PURE__ */ import_react17.default.createElement(Box, __spreadProps7(__spreadValues16({}, others), {
    component: "table",
    ref,
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-CETXE4TW.js.map
