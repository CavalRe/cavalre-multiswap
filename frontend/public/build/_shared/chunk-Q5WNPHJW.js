import {
  init_extends,
  require_react_dom
} from "/build/_shared/chunk-3MEBXB56.js";
import {
  __commonJS,
  __toESM,
  init_react,
...
function useMantineDefaultProps(component, defaultProps17, props) {
  var _a, _b;
  ...
  return __spreadValues3(__spreadValues3(__spreadValues3({}, defaultProps17), contextProps), props);
}
...
function MantineProvider({
  ...
  const overrides = {
    ...
    defaultProps: inherit ? __spreadValues3(__spreadValues3({}, ctx.defaultProps), defaultProps17) : defaultProps17
  };
...
var Box = (0, import_react8.forwardRef)((_a, ref) => {
  ...
  return /* @__PURE__ */ import_react8.default.createElement(Element, __spreadValues5({
    ref,
...
var NavbarSection = (0, import_react9.forwardRef)((_a, ref) => {
  var _b = _a, { component, children, grow = false, sx } = _b, others = __objRest3(_b, ["component", "children", "grow", "sx"]);
  return /* @__PURE__ */ import_react9.default.createElement(Box, __spreadValues6({
...
var useStyles = createStyles((theme, { height, width, fixed, position: position2, hiddenBreakpoint, zIndex }) => {
  ...
  return {
    root: __spreadValues7(__spreadProps4(__spreadValues7(__spreadValues7({}, theme.fn.fontStyles()), position2), {
      zIndex,
      height,
...
var Navbar_styles_default = useStyles;
...
var Navbar = (0, import_react10.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react10.default.createElement(Box, __spreadValues8({
    component: "nav",
    ref,
    className: cx(classes.root, { [classes.hidden]: hidden2 }, className)
  }, others), children);
});
...
var useStyles2 = createStyles((theme, { height, fixed, position: position2, zIndex }) => ({
  root: __spreadProps5(__spreadValues9(__spreadValues9({}, theme.fn.fontStyles()), position2), {
    zIndex,
    height,
    maxHeight: height,
    position: fixed ? "fixed" : "static",
...
var Header = (0, import_react11.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Header", defaultProps2, props), { children, className, classNames, styles: styles2, height, fixed, position: position2, zIndex } = _a, others = __objRest5(_a, ["children", "className", "classNames", "styles", "height", "fixed", "position", "zIndex"]);
  const { classes, cx } = Header_styles_default({ height, fixed, position: position2, zIndex }, { name: "Header", classNames, styles: styles2 });
  return /* @__PURE__ */ import_react11.default.createElement(Box, __spreadValues10({
    component: "nav",
...
var AppShell = (0, import_react12.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react12.default.createElement(Box, __spreadValues12({
    className: cx(classes.root, className),
    ref
...
var useStyles4 = createStyles((theme, {
  ...
  return {
    ...
    input: variant === "headless" ? {} : __spreadProps6(__spreadValues13(__spreadProps6(__spreadValues13({}, theme.fn.fontStyles()), {
...
var useStyles5 = createStyles((theme, {
  ...
  return {
    ...
    root: __spreadProps7(__spreadValues14(__spreadValues14(__spreadValues14(__spreadValues14({}, getSizeStyles({ compact, size: size2 })), theme.fn.fontStyles()), theme.fn.focusStyles()), getWidthStyles(fullWidth)), {
      borderRadius: theme.fn.radius(radius2),
      fontWeight: 600,
      position: "relative",
      lineHeight: 1,
...
function Dots(_a) {
  ...
  return /* @__PURE__ */ import_react15.default.createElement("svg", __spreadValues17({
    width: `${size2}px`,
    height: `${size2 / 4}px`,
    viewBox: "0 0 120 30",
    xmlns: "http://www.w3.org/2000/svg",
...
var Button = (0, import_react17.forwardRef)((props, ref) => {
  ...
  const loader = /* @__PURE__ */ import_react17.default.createElement(Loader, __spreadValues19({
    color: colors.color,
...
var Group = (0, import_react19.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Group", defaultProps6, props), {
    className,
    position: position2,
    align,
    children,
  ...
  return /* @__PURE__ */ import_react19.default.createElement(Box, __spreadValues20({
    className: cx(classes.root, className),
    ref
  }, others), items);
});
...
init_react();
var useStyles7 = createStyles((theme, { fluid, size: size2, sizes: sizes6 }) => ({
  root: {
...
var Container_styles_default = useStyles7;
...
var Container = (0, import_react20.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Container", defaultProps7, props), { className, fluid, size: size2, styles: styles2, classNames, sizes: sizes6 } = _a, others = __objRest13(_a, ["className", "fluid", "size", "styles", "classNames", "sizes"]);
  const { classes, cx } = Container_styles_default({ fluid, size: size2, sizes: sizes6 }, { styles: styles2, classNames, name: "Container" });
...
init_react();
var useStyles8 = createStyles((theme, { spacing, center }, getRef2) => {
  const itemWrapper = {
...
var ListItem_styles_default = useStyles8;
...
function ListItem(_a) {
  ...
  }, icon && /* @__PURE__ */ import_react21.default.createElement("span", {
    className: classes.itemIcon
  }, icon), /* @__PURE__ */ import_react21.default.createElement("span", null, children)));
}
...
var useStyles9 = createStyles((theme, { withPadding, size: size2, listStyleType }) => ({
...
var List_styles_default = useStyles9;
...
function filterChildrenByType(children, type) {
  return import_react22.Children.toArray(children).filter((item) => Array.isArray(type) ? type.some((component) => component === item.type) : item.type === type);
}
...
var List = (0, import_react23.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("List", defaultProps8, props), {
    children,
    type,
    size: size2,
    listStyleType,
  ...
  return /* @__PURE__ */ import_react23.default.createElement(Box, __spreadValues24({
...
function useMediaQuery(query) {
  const [matches, setMatches] = (0, import_react24.useState)(getInitialValue(query));
...
function useFocusReturn({
  ...
  const lastActiveElement = (0, import_react27.useRef)();
  const returnFocus = () => {
    var _a;
...
function useFocusTrap(active = true) {
  ...
  const restoreAria = (0, import_react28.useRef)(null);
  const setRef = (0, import_react28.useCallback)((node2) => {
    if (!active) {
      return;
    }
...
function useUuid(staticId) {
  const [uuid, setUuid] = (0, import_react30.useState)("");
  useIsomorphicEffect(() => {
    setUuid(randomId());
  }, []);
...
var useStyles10 = createStyles((theme, { overflow, size: size2, centered, zIndex }) => ({
  close: {},
  overlay: {},
  root: {
    position: "fixed",
...
var Modal_styles_default = useStyles10;
...
function Portal(props) {
  const { children, zIndex, target, className, position: position2 } = useMantineDefaultProps("Portal", defaultProps9, props);
  const theme = useMantineTheme();
  ...
  return (0, import_react_dom.createPortal)(/* @__PURE__ */ import_react31.default.createElement("div", {
    className,
    dir: theme.dir,
...
function OptionalPortal(_a) {
  ...
  if (withinPortal) {
    return /* @__PURE__ */ import_react32.default.createElement(Portal, __spreadValues25({}, others), children);
  }
...
var transitions = {
  ...
  pop: __spreadProps9(__spreadValues26({}, popIn), {
    common: { transformOrigin: "center center" }
  }),
  "pop-bottom-left": __spreadProps9(__spreadValues26({}, popIn), {
    common: { transformOrigin: "bottom left" }
  }),
  "pop-bottom-right": __spreadProps9(__spreadValues26({}, popIn), {
    common: { transformOrigin: "bottom right" }
  }),
  "pop-top-left": __spreadProps9(__spreadValues26({}, popIn), {
    common: { transformOrigin: "top left" }
  }),
  "pop-top-right": __spreadProps9(__spreadValues26({}, popIn), {
...
function getTransitionStyles({
  ...
  if (typeof transition === "string") {
    ...
    return __spreadValues27(__spreadValues27(__spreadValues27({
...
function GroupedTransition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react34.default.createElement(import_react34.default.Fragment, null, children({})) : null;
  }
  ...
  return /* @__PURE__ */ import_react34.default.createElement(import_react34.default.Fragment, null, children(transitionsStyles));
}
...
var useStyles11 = createStyles((theme, { radius: radius2, shadow, withBorder }) => ({
  root: __spreadProps10(__spreadValues28({}, theme.fn.focusStyles()), {
    WebkitTapHighlightColor: "transparent",
    display: "block",
    textDecoration: "none",
    color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
...
var Paper_styles_default = useStyles11;
...
var defaultProps10 = {};
var Paper = (0, import_react35.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Paper", defaultProps10, props), { component, className, children, radius: radius2, withBorder, shadow } = _a, others = __objRest17(_a, ["component", "className", "children", "radius", "withBorder", "shadow"]);
  const { classes, cx } = Paper_styles_default({ radius: radius2, shadow, withBorder }, { name: "Paper" });
  return /* @__PURE__ */ import_react35.default.createElement(Box, __spreadValues29({
    component: component || "div",
    className: cx(classes.root, className),
    ref
  }, others), children);
...
var useStyles12 = createStyles((theme, {
  ...
  return {
    root: __spreadProps11(__spreadValues30(__spreadValues30(__spreadValues30({}, theme.fn.fontStyles()), theme.fn.focusStyles()), getLineClamp(lineClamp)), {
...
var Text = (0, import_react36.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Text", defaultProps11, props), {
    className,
    component,
    size: size2 = "md",
    weight,
...
var useStyles13 = createStyles((theme, { color, size: size2, radius: radius2 }) => ({
  root: __spreadProps12(__spreadValues32(__spreadValues32({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
    position: "relative",
    appearance: "none",
    WebkitAppearance: "none",
    WebkitTapHighlightColor: "transparent",
    ...
    minHeight: theme.fn.size({ size: size2, sizes: sizes4 }),
...
var ActionIcon = (0, import_react37.forwardRef)((props, ref) => {
  ...
  const loader = /* @__PURE__ */ import_react37.default.createElement(Loader, __spreadValues33({
    color: colors.color,
    size: theme.fn.size({ size: size2, sizes: sizes4 }) - 12
  }, loaderProps));
  return /* @__PURE__ */ import_react37.default.createElement(Box, __spreadValues33({
    component: component || "button",
...
function CloseIcon(props) {
  return /* @__PURE__ */ import_react38.default.createElement("svg", __spreadValues34({
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
...
var CloseButton = (0, import_react39.forwardRef)((_a, ref) => {
  var _b = _a, { iconSize, size: size2 = "md" } = _b, others = __objRest20(_b, ["iconSize", "size"]);
  const theme = useMantineTheme();
  const _iconSize = iconSize || theme.fn.size({ size: size2, sizes: iconSizes });
  return /* @__PURE__ */ import_react39.default.createElement(ActionIcon, __spreadValues35({
    size: size2,
    ref
  }, others), /* @__PURE__ */ import_react39.default.createElement(CloseIcon, {
    width: _iconSize,
    height: _iconSize
  }));
});
...
var Overlay = (0, import_react40.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Overlay", defaultProps13, props), { opacity, blur, color, gradient, zIndex, component, radius: radius2, sx } = _a, others = __objRest21(_a, ["opacity", "blur", "color", "gradient", "zIndex", "component", "radius", "sx"]);
  ...
  const innerOverlay = (otherProps) => /* @__PURE__ */ import_react40.default.createElement(Box, __spreadValues36({
    component: component || "div",
    ref,
    sx: [
      (theme) => __spreadProps13(__spreadValues36(__spreadValues36({}, background), baseStyles), {
        opacity,
  ...
  if (blur) {
    return /* @__PURE__ */ import_react40.default.createElement(Box, __spreadValues36({
      sx: [
        () => __spreadProps13(__spreadValues36({}, baseStyles), {
...
function Modal(props) {
  const _a = useMantineDefaultProps("Modal", defaultProps14, props), {
    className,
    opened,
    title,
    onClose,
  ...
  return /* @__PURE__ */ import_react41.default.createElement(OptionalPortal, {
    withinPortal,
    zIndex,
    target
  }, /* @__PURE__ */ import_react41.default.createElement(GroupedTransition, {
  ...
  }, (transitionStyles) => /* @__PURE__ */ import_react41.default.createElement(Box, __spreadValues37({
    className: cx(classes.root, className)
    ...
    ref: focusTrapRef
  }, /* @__PURE__ */ import_react41.default.createElement(Paper, {
    ...
    "aria-modal": true,
    tabIndex: -1,
    style: __spreadProps14(__spreadValues37({}, transitionStyles.modal), {
      marginLeft: "calc(var(--removed-scroll-width, 0px) * -1)",
      zIndex: 3
    })
  }, (title || withCloseButton) && /* @__PURE__ */ import_react41.default.createElement("div", {
  ...
  }, /* @__PURE__ */ import_react41.default.createElement(Overlay, {
...
var useStyles14 = createStyles((theme, { captionSide, horizontalSpacing, verticalSpacing }, getRef2) => {
  ...
  return {
    striped,
    hover,
    root: __spreadProps15(__spreadValues38({}, theme.fn.fontStyles()), {
      width: "100%",
...
var Table = (0, import_react42.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react42.default.createElement(Box, __spreadProps16(__spreadValues39({}, others), {
    component: "table",
    ref,
...
var useStyles15 = createStyles((theme, { color, size: size2, radius: radius2, gradientFrom, gradientTo, gradientDeg, variant }) => {
  const colors = getSharedColorScheme({
    theme,
    color,
    variant,
  ...
  return {
    root: __spreadProps17(__spreadValues40({}, theme.fn.fontStyles()), {
      display: "inline-flex",
      alignItems: "center",
      justifyContent: "center",
      boxSizing: "border-box",
...
var ThemeIcon = (0, import_react43.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("ThemeIcon", defaultProps16, props), { className, size: size2, radius: radius2, variant, color, children, gradient } = _a, others = __objRest24(_a, ["className", "size", "radius", "variant", "color", "children", "gradient"]);
  ...
  return /* @__PURE__ */ import_react43.default.createElement(Box, __spreadValues41({
    className: cx(classes.root, className),
    ref
  }, others), children);
});
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-Q5WNPHJW.js.map
