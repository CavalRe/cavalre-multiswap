...
var Swap = (props) => {
  ...
  const handleSelectedReceiveTokens = (v) => {
    console.log("Handling selected receive tokens");
    setSelectedReceiveTokens(v);
    setTotalAllocation(Object.values(assetTokens).map((a) => a.allocation).reduce((p, c) => p + c));
  };
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(SimpleGrid, {
    ...
    setSelectedTokens: handleSelectedReceiveTokens,
    isPay: false,
...
//# sourceMappingURL=/build/_shared/chunk-FZUIZEGN.js.map
