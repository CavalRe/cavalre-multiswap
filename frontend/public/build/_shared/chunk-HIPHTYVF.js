...
function useMantineDefaultProps(component, defaultProps25, props) {
  ...
  return __spreadValues3(__spreadValues3(__spreadValues3({}, defaultProps25), contextProps), props);
}
...
function MantineProvider({
  ...
  const overrides = {
    ...
    defaultProps: inherit ? __spreadValues3(__spreadValues3({}, ctx.defaultProps), defaultProps25) : defaultProps25
  };
...
var TextInput = (0, import_react63.forwardRef)((props, ref) => {
  ...
  const uuid = useUuid(id);
  const { systemStyles, rest } = extractSystemStyles(others);
  return /* @__PURE__ */ import_react63.default.createElement(InputWrapper, __spreadValues56(__spreadValues56({
    required,
    id: uuid,
    label,
    error,
    ...
    __staticSelector,
    sx
  }, systemStyles), wrapperProps), /* @__PURE__ */ import_react63.default.createElement(Input, __spreadProps27(__spreadValues56({}, rest), {
    required,
    ref,
    id: uuid,
    type,
...
var NumberInput = (0, import_react64.forwardRef)((props, ref) => {
  ...
  const [focused, setFocused] = (0, import_react64.useState)(false);
  const [_value, setValue] = (0, import_react64.useState)(typeof value === "number" ? value : typeof defaultValue === "number" ? defaultValue : void 0);
  const finalValue = typeof value === "number" ? value : _value;
  const [tempValue, setTempValue] = (0, import_react64.useState)(typeof finalValue === "number" ? finalValue.toFixed(precision) : "");
  ...
  const incrementRef = (0, import_react64.useRef)();
  ...
  const decrementRef = (0, import_react64.useRef)();
  ...
  const onStepTimeoutRef = (0, import_react64.useRef)(null);
  const stepCountRef = (0, import_react64.useRef)(0);
  const onStepDone = () => {
  ...
  const controls = /* @__PURE__ */ import_react64.default.createElement("div", {
    className: classes.rightSection
  ...
  return /* @__PURE__ */ import_react64.default.createElement(TextInput, __spreadProps28(__spreadValues57({}, others), {
    variant,
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-HIPHTYVF.js.map
