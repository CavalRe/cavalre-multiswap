import {
  ...
  init_lib,
  useMoralis
} from "/build/_shared/chunk-ZLREKQYY.js";
import {
  BigNumber
    ...
    Object.values(assetTokens).forEach(async (asset) => {
      ...
      if (increaseAmount2 > 0) {
        await Moralis.executeFunction({
          ...
          params: {
            spender: poolToken.address,
            amount: BigNumber.from((increaseAmount2 * 10 ** asset.decimals).toLocaleString("fullwide", { useGrouping: false }))
          }
        });
      }
      ;
...
//# sourceMappingURL=/build/_shared/chunk-CD4MFWGV.js.map
