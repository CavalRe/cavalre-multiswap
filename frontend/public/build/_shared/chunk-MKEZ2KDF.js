import {
  init_lib,
  useMoralis
} from "/build/_shared/chunk-BDC3GFWL.js";
import {
  Button,
  Card,
  Container,
...
import {
  BigNumber
} from "/build/_shared/chunk-ZO5NNQ6M.js";
import {
  React,
  __toESM,
  init_react,
...
var DashboardHeader = (props) => {
  ...
  return /* @__PURE__ */ React.createElement(Header, {
    ...
    ml: "md",
    size: "md"
  }, "Send Tokens")) : /* @__PURE__ */ React.createElement(Button, {
    onClick: handleLogin,
    ml: "md",
    size: "md"
  }, "Connect Wallet"));
...
var Swap = (props) => {
    ...
    Object.values(assetTokens).forEach(async (asset) => {
      ...
      if (increaseAmount2 > 0) {
        ...
        await Moralis.executeFunction({
          ...
          params: {
            spender: poolToken.address,
            amount: BigNumber.from((10 * increaseAmount2 * 10 ** asset.decimals).toLocaleString("fullwide", { useGrouping: false }))
          }
        });
      }
      ;
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(SimpleGrid, {
  ...
  })), /* @__PURE__ */ React.createElement(Text, null, `Total allocation: ${(100 * totalAllocation).toFixed(2)}%`), isAuthenticated ? checkAllocations() ? /* @__PURE__ */ React.createElement(Button, {
    type: "submit",
    onClick: handleSwap,
    mt: "xl",
    size: "md",
    ...
    mt: "xl",
    size: "md"
  }, "Increase Allowances") : /* @__PURE__ */ React.createElement(Button, {
    type: "submit",
    onClick: handleLogin,
    mt: "xl",
    size: "md"
...
//# sourceMappingURL=/build/_shared/chunk-MKEZ2KDF.js.map
