...
function useMantineDefaultProps(component, defaultProps15, props) {
  var _a, _b;
  ...
  return __spreadValues3(__spreadValues3(__spreadValues3({}, defaultProps15), contextProps), props);
}
...
function MantineProvider({
  ...
  const overrides = {
    ...
    defaultProps: inherit ? __spreadValues3(__spreadValues3({}, ctx.defaultProps), defaultProps15) : defaultProps15
  };
...
function filterFalsyChildren(children) {
  return import_react12.Children.toArray(children).filter(Boolean);
}
...
var Group = (0, import_react13.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react13.default.createElement(Box, __spreadValues11({
    className: cx(classes.root, className),
    ref
  }, others), items);
});
...
init_react();
var useStyles4 = createStyles((theme, { fluid, size: size2, sizes: sizes4 }) => ({
  root: {
...
var Container_styles_default = useStyles4;
...
var Container = (0, import_react14.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Container", defaultProps4, props), { className, fluid, size: size2, styles: styles2, classNames, sizes: sizes4 } = _a, others = __objRest7(_a, ["className", "fluid", "size", "styles", "classNames", "sizes"]);
  const { classes, cx } = Container_styles_default({ fluid, size: size2, sizes: sizes4 }, { styles: styles2, classNames, name: "Container" });
  return /* @__PURE__ */ import_react14.default.createElement(Box, __spreadValues12({
    className: cx(classes.root, className),
    ref
  }, others));
});
...
init_react();
var useStyles5 = createStyles((theme, { spacing, center }, getRef2) => {
  const itemWrapper = {
...
var ListItem_styles_default = useStyles5;
...
function ListItem(_a) {
  ...
  return /* @__PURE__ */ import_react15.default.createElement(Box, __spreadValues13({
    component: "li",
    className: cx(classes.item, { [classes.withIcon]: icon }, className)
  }, others), /* @__PURE__ */ import_react15.default.createElement("div", {
    className: classes.itemWrapper
  }, icon && /* @__PURE__ */ import_react15.default.createElement("span", {
    className: classes.itemIcon
  }, icon), /* @__PURE__ */ import_react15.default.createElement("span", null, children)));
}
...
var useStyles6 = createStyles((theme, { withPadding, size: size2, listStyleType }) => ({
  root: __spreadProps5(__spreadValues14({}, theme.fn.fontStyles()), {
    listStyleType,
    color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
...
var List_styles_default = useStyles6;
...
var List = (0, import_react17.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("List", defaultProps5, props), {
    children,
    type,
    size: size2,
    listStyleType,
...
function useMediaQuery(query) {
  const [matches, setMatches] = (0, import_react18.useState)(getInitialValue(query));
  const queryRef = (0, import_react18.useRef)();
...
var useIsomorphicEffect = typeof document !== "undefined" ? import_react19.useLayoutEffect : import_react19.useEffect;
...
function useFocusReturn({
  ...
  const lastActiveElement = (0, import_react21.useRef)();
  const returnFocus = () => {
    var _a;
...
function useFocusTrap(active = true) {
  ...
  const restoreAria = (0, import_react22.useRef)(null);
  const setRef = (0, import_react22.useCallback)((node2) => {
    if (!active) {
      return;
    }
...
function useScrollLock(lock, options = {
  ...
  const [scrollLocked, setScrollLocked] = (0, import_react23.useState)(lock || false);
  const scrollTop = (0, import_react23.useRef)(0);
  const { disableBodyPadding } = options;
  const stylesheet = (0, import_react23.useRef)(null);
  const lockScroll = () => {
...
var useStyles7 = createStyles((theme, { overflow, size: size2, centered, zIndex }) => ({
  close: {},
  overlay: {},
  root: {
    position: "fixed",
  ...
  modal: {
    position: "relative",
    zIndex: 5,
    width: theme.fn.size({ sizes, size: size2 }),
    outline: 0,
    backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[7] : theme.white,
...
function Portal(props) {
  ...
  return (0, import_react_dom.createPortal)(/* @__PURE__ */ import_react25.default.createElement("div", {
    className,
    dir: theme.dir,
...
function OptionalPortal(_a) {
  var _b = _a, { withinPortal = true, children } = _b, others = __objRest10(_b, ["withinPortal", "children"]);
  if (withinPortal) {
    return /* @__PURE__ */ import_react26.default.createElement(Portal, __spreadValues16({}, others), children);
  }
...
var transitions = {
  ...
  pop: __spreadProps6(__spreadValues17({}, popIn), {
    common: { transformOrigin: "center center" }
  }),
  "pop-bottom-left": __spreadProps6(__spreadValues17({}, popIn), {
    common: { transformOrigin: "bottom left" }
  }),
  "pop-bottom-right": __spreadProps6(__spreadValues17({}, popIn), {
    common: { transformOrigin: "bottom right" }
  }),
  "pop-top-left": __spreadProps6(__spreadValues17({}, popIn), {
    common: { transformOrigin: "top left" }
  }),
  "pop-top-right": __spreadProps6(__spreadValues17({}, popIn), {
...
function useTransition({
  ...
  const [transitionStatus, setStatus] = (0, import_react27.useState)(mounted ? "entered" : "exited");
  const [transitionDuration, setTransitionDuration] = (0, import_react27.useState)(reduceMotion ? 0 : duration);
...
function GroupedTransition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react28.default.createElement(import_react28.default.Fragment, null, children({})) : null;
  }
  ...
  return /* @__PURE__ */ import_react28.default.createElement(import_react28.default.Fragment, null, children(transitionsStyles));
}
...
var Paper = (0, import_react29.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Paper", defaultProps7, props), { component, className, children, radius: radius2, withBorder, shadow } = _a, others = __objRest11(_a, ["component", "className", "children", "radius", "withBorder", "shadow"]);
  const { classes, cx } = Paper_styles_default({ radius: radius2, shadow, withBorder }, { name: "Paper" });
  return /* @__PURE__ */ import_react29.default.createElement(Box, __spreadValues20({
    component: component || "div",
    className: cx(classes.root, className),
    ref
  }, others), children);
...
var useStyles9 = createStyles((theme, {
  ...
  return {
    root: __spreadProps8(__spreadValues21(__spreadValues21(__spreadValues21({}, theme.fn.fontStyles()), theme.fn.focusStyles()), getLineClamp(lineClamp)), {
...
var Text_styles_default = useStyles9;
...
var Text = (0, import_react30.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react30.default.createElement(Box, __spreadValues22({
    ref,
    component: component || "div",
...
var useStyles10 = createStyles((theme, { color, size: size2, radius: radius2 }) => ({
  root: __spreadProps9(__spreadValues23(__spreadValues23({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
    ...
    WebkitTapHighlightColor: "transparent",
    boxSizing: "border-box",
    height: theme.fn.size({ size: size2, sizes: sizes2 }),
    minHeight: theme.fn.size({ size: size2, sizes: sizes2 }),
    width: theme.fn.size({ size: size2, sizes: sizes2 }),
    minWidth: theme.fn.size({ size: size2, sizes: sizes2 }),
    borderRadius: theme.fn.radius(radius2),
    padding: 0,
    lineHeight: 1,
    display: "flex",
...
var ActionIcon_styles_default = useStyles10;
...
function Bars(_a) {
  var _b = _a, { size: size2, color } = _b, others = __objRest13(_b, ["size", "color"]);
  return /* @__PURE__ */ import_react31.default.createElement("svg", __spreadValues24({
    viewBox: "0 0 135 140",
    xmlns: "http://www.w3.org/2000/svg",
    fill: color,
    width: `${size2}px`
  }, others), /* @__PURE__ */ import_react31.default.createElement("rect", {
    y: "10",
    width: "15",
    height: "120",
    rx: "6"
...
function Oval(_a) {
  var _b = _a, { size: size2, color } = _b, others = __objRest14(_b, ["size", "color"]);
  return /* @__PURE__ */ import_react32.default.createElement("svg", __spreadValues25({
    width: `${size2}px`,
    height: `${size2}px`,
    viewBox: "0 0 38 38",
    xmlns: "http://www.w3.org/2000/svg",
    stroke: color
  }, others), /* @__PURE__ */ import_react32.default.createElement("g", {
    fill: "none",
    fillRule: "evenodd"
  ...
  }, /* @__PURE__ */ import_react32.default.createElement("animateTransform", {
...
function Dots(_a) {
  var _b = _a, { size: size2, color } = _b, others = __objRest15(_b, ["size", "color"]);
  return /* @__PURE__ */ import_react33.default.createElement("svg", __spreadValues26({
    width: `${size2}px`,
    height: `${size2 / 4}px`,
    viewBox: "0 0 120 30",
    xmlns: "http://www.w3.org/2000/svg",
    fill: color
  }, others), /* @__PURE__ */ import_react33.default.createElement("circle", {
    cx: "15",
    cy: "15",
    r: "15"
...
function Loader(props) {
  const _a = useMantineDefaultProps("Loader", defaultProps9, props), {
    size: size2 = "md",
    color,
    variant
  ...
  return /* @__PURE__ */ import_react34.default.createElement(Box, __spreadValues27({
    role: "presentation",
...
var ActionIcon = (0, import_react35.forwardRef)((props, ref) => {
  ...
  const loader = /* @__PURE__ */ import_react35.default.createElement(Loader, __spreadValues28({
    color: colors.color,
    size: theme.fn.size({ size: size2, sizes: sizes2 }) - 12
  }, loaderProps));
  return /* @__PURE__ */ import_react35.default.createElement(Box, __spreadValues28({
...
function CloseIcon(props) {
  return /* @__PURE__ */ import_react36.default.createElement("svg", __spreadValues29({
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
...
var CloseButton = (0, import_react37.forwardRef)((_a, ref) => {
  var _b = _a, { iconSize, size: size2 = "md" } = _b, others = __objRest18(_b, ["iconSize", "size"]);
  const theme = useMantineTheme();
  const _iconSize = iconSize || theme.fn.size({ size: size2, sizes: iconSizes });
  return /* @__PURE__ */ import_react37.default.createElement(ActionIcon, __spreadValues30({
    size: size2,
    ref
  }, others), /* @__PURE__ */ import_react37.default.createElement(CloseIcon, {
    width: _iconSize,
    height: _iconSize
  }));
});
...
var Overlay = (0, import_react38.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Overlay", defaultProps11, props), { opacity, blur, color, gradient, zIndex, component, radius: radius2, sx } = _a, others = __objRest19(_a, ["opacity", "blur", "color", "gradient", "zIndex", "component", "radius", "sx"]);
  ...
  const innerOverlay = (otherProps) => /* @__PURE__ */ import_react38.default.createElement(Box, __spreadValues31({
    component: component || "div",
    ref,
    sx: [
      (theme) => __spreadProps10(__spreadValues31(__spreadValues31({}, background), baseStyles), {
        opacity,
  ...
  if (blur) {
    return /* @__PURE__ */ import_react38.default.createElement(Box, __spreadValues31({
      sx: [
        () => __spreadProps10(__spreadValues31({}, baseStyles), {
...
function Modal(props) {
  const _a = useMantineDefaultProps("Modal", defaultProps12, props), {
    className,
    opened,
    title,
    onClose,
  ...
  return /* @__PURE__ */ import_react39.default.createElement(OptionalPortal, {
  ...
  }, (transitionStyles) => /* @__PURE__ */ import_react39.default.createElement(Box, __spreadValues32({
    className: cx(classes.root, className)
    ...
    "aria-modal": true,
    tabIndex: -1,
    style: __spreadProps11(__spreadValues32({}, transitionStyles.modal), {
...
var useStyles11 = createStyles((theme, { captionSide, horizontalSpacing, verticalSpacing }, getRef2) => {
  ...
  return {
    striped,
    hover,
    root: __spreadProps12(__spreadValues33({}, theme.fn.fontStyles()), {
      width: "100%",
...
var Table = (0, import_react40.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Table", defaultProps13, props), {
    className,
    children,
    striped,
    highlightOnHover,
  ...
  return /* @__PURE__ */ import_react40.default.createElement(Box, __spreadProps13(__spreadValues34({}, others), {
    component: "table",
    ref,
...
var useStyles12 = createStyles((theme, { color, size: size2, radius: radius2, gradientFrom, gradientTo, gradientDeg, variant }) => {
  const colors = getSharedColorScheme({
    theme,
    color,
    variant,
  ...
  const iconSize = theme.fn.size({ size: size2, sizes: sizes3 });
  return {
    root: __spreadProps14(__spreadValues35({}, theme.fn.fontStyles()), {
      display: "inline-flex",
      alignItems: "center",
      justifyContent: "center",
      boxSizing: "border-box",
...
var ThemeIcon_styles_default = useStyles12;
...
var ThemeIcon = (0, import_react41.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("ThemeIcon", defaultProps14, props), { className, size: size2, radius: radius2, variant, color, children, gradient } = _a, others = __objRest22(_a, ["className", "size", "radius", "variant", "color", "children", "gradient"]);
  ...
  return /* @__PURE__ */ import_react41.default.createElement(Box, __spreadValues36({
    className: cx(classes.root, className),
    ref
  }, others), children);
});
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-OGSELDOF.js.map
