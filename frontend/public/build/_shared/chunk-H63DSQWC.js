...
var Swap = (props) => {
  ...
  const totalAllocation = Object.values(assetTokens).map((asset) => asset.allocation).reduce((p, c) => p + c);
  ...
  const receiverComponent = (props2) => {
    ...
    const handleAllocationChange = (allocation) => {
      assetTokens[token.token_address].allocation = allocation ? allocation : 0;
    };
    return /* @__PURE__ */ React.createElement(Card, {
      radius: "md",
      mt: "xs"
...
//# sourceMappingURL=/build/_shared/chunk-H63DSQWC.js.map
