import {
  ...
  init_extends,
  require_react_dom
} from "/build/_shared/chunk-37ABIKZ2.js";
import {
  __commonJS,
  __toESM,
  init_react,
...
var Group = (0, import_react27.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react27.default.createElement(Box, __spreadValues22({
    className: cx(classes.root, className),
    ref
  }, others), items);
});
...
var Container = (0, import_react28.forwardRef)((props, ref) => {
...
var SimpleGrid = (0, import_react29.forwardRef)((props, ref) => {
...
var useStyles11 = createStyles((theme, { captionSide, horizontalSpacing, verticalSpacing, fontSize }, getRef2) => {
  const striped = { ref: getRef2("striped") };
  const hover = { ref: getRef2("hover") };
  return {
    striped,
    hover,
    root: __spreadProps8(__spreadValues26({}, theme.fn.fontStyles()), {
      width: "100%",
...
var Table = (0, import_react30.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react30.default.createElement(Box, __spreadProps9(__spreadValues27({}, others), {
    component: "table",
    ref,
...
var useStyles12 = createStyles((theme, { element, align }) => ({
  root: __spreadProps10(__spreadValues28({}, theme.fn.fontStyles()), {
...
var Title = (0, import_react31.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react31.default.createElement(Box, __spreadValues29({
    component: `h${order2}`,
    ref,
    className: cx(classes.root, className)
  }, others), children);
...
var transitions = {
  ...
  pop: __spreadProps11(__spreadValues30({}, popIn), {
    common: { transformOrigin: "center center" }
  }),
  "pop-bottom-left": __spreadProps11(__spreadValues30({}, popIn), {
    common: { transformOrigin: "bottom left" }
  }),
  "pop-bottom-right": __spreadProps11(__spreadValues30({}, popIn), {
    common: { transformOrigin: "bottom right" }
  }),
  "pop-top-left": __spreadProps11(__spreadValues30({}, popIn), {
    common: { transformOrigin: "top left" }
  }),
  "pop-top-right": __spreadProps11(__spreadValues30({}, popIn), {
...
function useFocusReturn({
  ...
  const lastActiveElement = (0, import_react35.useRef)();
  const returnFocus = () => {
    var _a;
...
function useFocusTrap(active = true) {
  ...
  const restoreAria = (0, import_react36.useRef)(null);
  const setRef = (0, import_react36.useCallback)((node2) => {
    if (!active) {
      return;
    }
...
function useMergedRef(...refs) {
  return (0, import_react38.useCallback)((node2) => {
...
function useUncontrolled({
  ...
  const modeRef = (0, import_react39.useRef)("initial");
  const initialValue = rule(defaultValue) ? defaultValue : finalValue;
  const [uncontrolledValue, setUncontrolledValue] = (0, import_react39.useState)(initialValue);
...
function useScrollIntoView({
  ...
  const frameID = (0, import_react40.useRef)(0);
  const startTime = (0, import_react40.useRef)(0);
  const shouldStop = (0, import_react40.useRef)(false);
  ...
  const scrollIntoView = (0, import_react40.useCallback)(({ alignment = "start" } = {}) => {
    var _a;
  ...
  (0, import_react40.useEffect)(() => cancel, []);
  return {
    scrollableRef,
    targetRef,
    scrollIntoView,
...
function useScrollLock(lock, options = {
  ...
  const [scrollLocked, setScrollLocked] = (0, import_react41.useState)(lock || false);
  const scrollTop = (0, import_react41.useRef)(0);
  const { disableBodyPadding } = options;
  const stylesheet = (0, import_react41.useRef)(null);
  const lockScroll = () => {
...
function useUuid(staticId) {
  const [uuid, setUuid] = (0, import_react42.useState)("");
  useIsomorphicEffect(() => {
    setUuid(randomId());
  }, []);
...
var useStyles13 = createStyles((theme, { color, size: size2, radius: radius2 }) => ({
  root: __spreadProps12(__spreadValues31(__spreadValues31({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
    position: "relative",
    appearance: "none",
    WebkitAppearance: "none",
    WebkitTapHighlightColor: "transparent",
...
var ActionIcon = (0, import_react43.forwardRef)((props, ref) => {
  ...
  const loader = /* @__PURE__ */ import_react43.default.createElement(Loader, __spreadValues32({
    color: colors.color,
...
function CloseIcon(props) {
  return /* @__PURE__ */ import_react44.default.createElement("svg", __spreadValues33({
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
...
var CloseButton = (0, import_react45.forwardRef)((_a, ref) => {
  ...
  return /* @__PURE__ */ import_react45.default.createElement(ActionIcon, __spreadValues34({
    size: size2,
    ref
  }, others), /* @__PURE__ */ import_react45.default.createElement(CloseIcon, {
    width: _iconSize,
    height: _iconSize
  }));
});
...
function Portal(props) {
  ...
  return (0, import_react_dom.createPortal)(/* @__PURE__ */ import_react46.default.createElement("div", {
    className,
    dir: theme.dir,
...
var useStyles14 = createStyles((theme, {
  ...
  return {
    root: __spreadProps13(__spreadValues35(__spreadValues35(__spreadValues35({}, theme.fn.fontStyles()), theme.fn.focusStyles()), getLineClamp(lineClamp)), {
...
var Text = (0, import_react47.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react47.default.createElement(Box, __spreadValues36({
    ref,
    component: component || "div",
...
var ScrollArea2 = (0, import_react48.forwardRef)((props, ref) => {
  ...
  const [scrollbarHovered, setScrollbarHovered] = (0, import_react48.useState)(false);
  const theme = useMantineTheme();
  ...
  return /* @__PURE__ */ import_react48.default.createElement(Root, {
    type,
    scrollHideDelay,
    dir: dir || theme.dir,
    ref,
    asChild: true
  }, /* @__PURE__ */ import_react48.default.createElement(Box, __spreadValues37({
    className: cx(classes.root, className)
  }, others), /* @__PURE__ */ import_react48.default.createElement(Viewport, {
  ...
  }, children), /* @__PURE__ */ import_react48.default.createElement(Scrollbar, {
  ...
  })), /* @__PURE__ */ import_react48.default.createElement(Scrollbar, {
    ...
    className: classes.thumb
  })), /* @__PURE__ */ import_react48.default.createElement(Corner, {
...
var SelectScrollArea = (0, import_react49.forwardRef)((_a, ref) => {
  var _b = _a, { style } = _b, others = __objRest22(_b, ["style"]);
  return /* @__PURE__ */ import_react49.default.createElement(ScrollArea2, __spreadProps14(__spreadValues38({}, others), {
    style: __spreadValues38({ width: "100%" }, style),
    viewportRef: ref
  }), others.children);
});
...
var useStyles16 = createStyles((theme, { native }) => ({
  dropdown: __spreadProps15(__spreadValues39({}, theme.fn.fontStyles()), {
    boxSizing: "border-box",
    pointerEvents: "auto",
    backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[6] : theme.white,
...
var useIsomorphicLayoutEffect = typeof window !== "undefined" && window.document && window.document.createElement ? React33.useLayoutEffect : React33.useEffect;
...
var useStyles17 = createStyles((theme, { arrowSize, arrowDistance }, getRef2) => {
  ...
  return {
    ...
    left: __spreadProps16(__spreadValues40({}, horizontalPlacement(arrowSize, arrowDistance, placementClasses)), {
    ...
    right: __spreadProps16(__spreadValues40({}, horizontalPlacement(arrowSize, arrowDistance, placementClasses)), {
    ...
    top: __spreadProps16(__spreadValues40({}, verticalPlacement(arrowSize, arrowDistance, placementClasses, theme)), {
      bottom: -arrowSize,
      borderLeft: theme.dir === "ltr" ? 0 : void 0,
      borderRight: theme.dir === "rtl" ? 0 : void 0,
      borderTop: 0
    }),
    bottom: __spreadProps16(__spreadValues40({}, verticalPlacement(arrowSize, arrowDistance, placementClasses, theme)), {
      top: -arrowSize,
      borderRight: theme.dir === "ltr" ? 0 : void 0,
      borderLeft: theme.dir === "rtl" ? 0 : void 0,
      borderBottom: 0
...
function getTransitionStyles({
  ...
  if (typeof transition === "string") {
    ...
    return __spreadValues41(__spreadValues41(__spreadValues41({
...
function Popper({
  ...
  return /* @__PURE__ */ import_react53.default.createElement(Transition, {
    ...
    withinPortal,
    zIndex
  }, /* @__PURE__ */ import_react53.default.createElement("div", __spreadValues42({
    ref: setPopperElement,
    style: __spreadValues42(__spreadProps17(__spreadValues42({}, styles2.popper), {
      pointerEvents: "none"
...
var Divider = (0, import_react55.forwardRef)((props, ref) => {
  ...
  }, others), !!label && horizontal && /* @__PURE__ */ import_react55.default.createElement(Text, __spreadProps18(__spreadValues43({}, labelProps), {
    color: _color,
...
function SelectItems({
  ...
  const constructItemComponent = (item, index) => {
    ...
    return /* @__PURE__ */ import_react56.default.createElement(Item, __spreadValues44({
      key: item.value,
  ...
  data.forEach((item, index) => {
    if (item.creatable) {
      ...
      if (groupName !== item.group) {
        ...
        groupedItems.push(/* @__PURE__ */ import_react56.default.createElement("div", {
          className: classes.separator,
          key: index
        }, /* @__PURE__ */ import_react56.default.createElement(Divider, {
  ...
  if (creatable) {
    ...
    unGroupedItems.push(/* @__PURE__ */ import_react56.default.createElement("div", {
  ...
  if (groupedItems.length > 0 && unGroupedItems.length > 0) {
    unGroupedItems.unshift(/* @__PURE__ */ import_react56.default.createElement("div", {
      className: classes.separator
    }, /* @__PURE__ */ import_react56.default.createElement(Divider, null)));
  }
  return groupedItems.length > 0 || unGroupedItems.length > 0 ? /* @__PURE__ */ import_react56.default.createElement(import_react56.default.Fragment, null, groupedItems, unGroupedItems) : /* @__PURE__ */ import_react56.default.createElement(Text, {
    size: size2,
...
var DefaultItem = (0, import_react57.forwardRef)((_a, ref) => {
  var _b = _a, { label, value } = _b, others = __objRest24(_b, ["label", "value"]);
  return /* @__PURE__ */ import_react57.default.createElement("div", __spreadValues45({
    ref
  }, others), label || value);
});
...
var useStyles20 = createStyles((theme, { size: size2 }) => ({
  root: __spreadProps19(__spreadValues46({}, theme.fn.fontStyles()), {
    lineHeight: theme.lineHeight
  }),
  label: {
    display: "inline-block",
...
var InputWrapper = (0, import_react58.forwardRef)((props, ref) => {
  ...
  const inputLabel = (0, import_react58.createElement)(labelElement, __spreadProps20(__spreadValues47(__spreadValues47({}, _labelProps), labelProps), {
    id: id ? `${id}-label` : void 0,
    className: classes.label
  }), /* @__PURE__ */ import_react58.default.createElement(import_react58.default.Fragment, null, label, required && /* @__PURE__ */ import_react58.default.createElement("span", {
    className: classes.required
  }, " *")));
  return /* @__PURE__ */ import_react58.default.createElement(Box, __spreadValues47({
    className: cx(classes.root, className),
    ref
  }, others), label && inputLabel, description && /* @__PURE__ */ import_react58.default.createElement(Text, __spreadProps20(__spreadValues47({}, descriptionProps), {
    color: "gray",
    className: classes.description
  }), description), children, typeof error !== "boolean" && error && /* @__PURE__ */ import_react58.default.createElement(Text, __spreadProps20(__spreadValues47({}, errorProps), {
    size: size2,
...
var Input = (0, import_react59.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react59.default.createElement(Box, __spreadValues48(__spreadValues48({
    className: cx(classes.wrapper, className),
    sx,
    style
  }, systemStyles), wrapperProps), icon && /* @__PURE__ */ import_react59.default.createElement("div", {
    className: classes.icon
  }, icon), /* @__PURE__ */ import_react59.default.createElement(Element2, __spreadProps21(__spreadValues48({}, rest), {
    ref,
    required,
  ...
  })), rightSection && /* @__PURE__ */ import_react59.default.createElement("div", __spreadProps21(__spreadValues48({}, rightSectionProps), {
...
function OptionalPortal(_a) {
  ...
  if (withinPortal) {
    return /* @__PURE__ */ import_react60.default.createElement(Portal, __spreadValues49({}, others), children);
  }
...
function GroupedTransition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react61.default.createElement(import_react61.default.Fragment, null, children({})) : null;
  }
  ...
  return /* @__PURE__ */ import_react61.default.createElement(import_react61.default.Fragment, null, children(transitionsStyles));
}
...
var Overlay = (0, import_react62.forwardRef)((props, ref) => {
  ...
  const innerOverlay = (otherProps) => /* @__PURE__ */ import_react62.default.createElement(Box, __spreadValues50({
    component: component || "div",
    ref,
    sx: [
      (theme) => __spreadProps22(__spreadValues50(__spreadValues50({}, background), baseStyles), {
        opacity,
  ...
  if (blur) {
    return /* @__PURE__ */ import_react62.default.createElement(Box, __spreadValues50({
      sx: [
        () => __spreadProps22(__spreadValues50({}, baseStyles), {
...
function Modal(props) {
  ...
  return /* @__PURE__ */ import_react63.default.createElement(OptionalPortal, {
    withinPortal,
    zIndex,
    target
  }, /* @__PURE__ */ import_react63.default.createElement(GroupedTransition, {
  ...
  }, (transitionStyles) => /* @__PURE__ */ import_react63.default.createElement(Box, __spreadValues51({
    className: cx(classes.root, className)
  }, others), /* @__PURE__ */ import_react63.default.createElement("div", {
    className: classes.inner,
    ...
    ref: focusTrapRef
  }, /* @__PURE__ */ import_react63.default.createElement(Paper, {
  ...
  }, (title || withCloseButton) && /* @__PURE__ */ import_react63.default.createElement("div", {
    className: classes.header
  }, /* @__PURE__ */ import_react63.default.createElement(Text, {
    id: titleId,
    className: classes.title
  }, title), withCloseButton && /* @__PURE__ */ import_react63.default.createElement(CloseButton, {
    iconSize: 16,
    onClick: onClose,
  ...
  }, /* @__PURE__ */ import_react63.default.createElement(Overlay, {
...
function DefaultValue(_a) {
  ...
  return /* @__PURE__ */ import_react64.default.createElement("div", __spreadValues52({
    className: cx(classes.defaultValue, className)
  }, others), /* @__PURE__ */ import_react64.default.createElement("span", {
    className: classes.label
  }, label), !disabled && /* @__PURE__ */ import_react64.default.createElement(CloseButton, {
    "aria-hidden": true,
...
function ChevronIcon(_a) {
  ...
  return /* @__PURE__ */ import_react65.default.createElement("svg", __spreadValues53({
    width: _size,
    height: _size,
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg",
    style: __spreadValues53({ color: error ? theme.colors.red[6] : theme.colors.gray[6] }, style),
    "data-chevron": true
  }, others), /* @__PURE__ */ import_react65.default.createElement("path", {
...
function SelectRightSection({
  ...
  return shouldClear ? /* @__PURE__ */ import_react66.default.createElement(CloseButton, {
    variant: "transparent",
    "aria-label": clearButtonLabel,
    onClick: onClear,
    size: size2
  }) : /* @__PURE__ */ import_react66.default.createElement(ChevronIcon, {
    error,
    size: size2
  });
}
...
function getSelectRightSectionProps(_a) {
  ...
  return {
    ...
    rightSection: !(props.disabled && props.shouldClear) && /* @__PURE__ */ import_react67.default.createElement(SelectRightSection, __spreadValues54({}, props)),
    styles: __spreadProps23(__spreadValues54({}, _styles), {
      rightSection: __spreadProps23(__spreadValues54({}, _styles == null ? void 0 : _styles.rightSection), {
...
var MultiSelect = (0, import_react68.forwardRef)((props, ref) => {
  ...
  const { systemStyles, rest } = extractSystemStyles(others);
  const dropdownRef = (0, import_react68.useRef)();
  const inputRef = (0, import_react68.useRef)();
  const wrapperRef = (0, import_react68.useRef)();
  const itemsRefs = (0, import_react68.useRef)({});
  const uuid = useUuid(id);
  const [dropdownOpened, _setDropdownOpened] = (0, import_react68.useState)(initiallyOpened);
  const [hovered, setHovered] = (0, import_react68.useState)(-1);
  const [direction, setDirection] = (0, import_react68.useState)("column");
  const [searchValue, setSearchValue] = (0, import_react68.useState)("");
  ...
  const valuesOverflow = (0, import_react68.useRef)(!!maxSelectedValues && maxSelectedValues < _value.length);
  ...
  const selectedItems = _value.map((val) => {
    ...
    return selectedItem;
  }).filter((val) => !!val).map((item) => /* @__PURE__ */ import_react68.default.createElement(Value, __spreadProps24(__spreadValues55({}, item), {
    disabled,
  ...
  return /* @__PURE__ */ import_react68.default.createElement(InputWrapper, __spreadValues55(__spreadValues55({
    required,
    id: uuid,
    label,
    error,
    ...
    descriptionProps,
    labelProps
  }, systemStyles), wrapperProps), /* @__PURE__ */ import_react68.default.createElement("div", {
    ...
    tabIndex: -1,
    ref: wrapperRef
  }, /* @__PURE__ */ import_react68.default.createElement(Input, __spreadValues55({
    __staticSelector: "MultiSelect",
    ...
    classNames: __spreadProps24(__spreadValues55({}, classNames), {
  ...
  }, selectedItems, /* @__PURE__ */ import_react68.default.createElement("input", __spreadValues55({
    ...
    name,
    autoComplete: "nope"
  }, rest)))), /* @__PURE__ */ import_react68.default.createElement(SelectDropdown, {
    ...
    zIndex,
    dropdownPosition
  }, /* @__PURE__ */ import_react68.default.createElement(SelectItems, {
    data: filteredData,
    hovered,
    classNames,
    styles: styles2,
...
var NativeSelect = (0, import_react69.forwardRef)((props, ref) => {
  ...
  const { systemStyles, rest } = extractSystemStyles(others);
  const formattedData = data.map((item) => typeof item === "string" ? { label: item, value: item } : item);
  const options = formattedData.map((item) => /* @__PURE__ */ import_react69.default.createElement("option", {
    key: item.value,
    value: item.value,
    disabled: item.disabled
  }, item.label));
  if (placeholder) {
    options.unshift(/* @__PURE__ */ import_react69.default.createElement("option", {
      key: "placeholder",
      value: "",
      disabled: true,
      hidden: true
  ...
  return /* @__PURE__ */ import_react69.default.createElement(InputWrapper, __spreadValues56(__spreadValues56({
    required,
    id: uuid,
    label,
    error,
    ...
    descriptionProps,
    labelProps
  }, systemStyles), wrapperProps), /* @__PURE__ */ import_react69.default.createElement(Input, __spreadValues56(__spreadProps25(__spreadValues56({}, rest), {
    onChange,
    component: "select",
    invalid: !!error,
    style: inputStyle,
...
var TextInput = (0, import_react70.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("TextInput", defaultProps23, props), {
    className,
    id,
    label,
    error,
  ...
  const uuid = useUuid(id);
  const { systemStyles, rest } = extractSystemStyles(others);
  return /* @__PURE__ */ import_react70.default.createElement(InputWrapper, __spreadValues57(__spreadValues57({
    required,
    id: uuid,
    label,
    error,
    ...
    labelProps,
    descriptionProps
  }, systemStyles), wrapperProps), /* @__PURE__ */ import_react70.default.createElement(Input, __spreadProps26(__spreadValues57({}, rest), {
    required,
    ref,
    id: uuid,
    type,
...
var useStyles24 = createStyles((theme, { radius: radius2, size: size2 }) => ({
  rightSection: {
    display: "flex",
    flexDirection: "column",
    height: "calc(100% - 2px)",
...
var NumberInput_styles_default = useStyles24;
...
var NumberInput = (0, import_react71.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("NumberInput", defaultProps24, props), {
    disabled,
    value,
    onChange,
    decimalSeparator,
  ...
  const [_value, setValue] = (0, import_react71.useState)(typeof value === "number" ? value : typeof defaultValue === "number" ? defaultValue : void 0);
  const finalValue = typeof value === "number" ? value : _value;
  const [tempValue, setTempValue] = (0, import_react71.useState)(typeof finalValue === "number" ? finalValue.toFixed(precision) : "");
  ...
  const incrementRef = (0, import_react71.useRef)();
  ...
  const decrementRef = (0, import_react71.useRef)();
  ...
  const onStepTimeoutRef = (0, import_react71.useRef)(null);
  const stepCountRef = (0, import_react71.useRef)(0);
  const onStepDone = () => {
  ...
  const controls = /* @__PURE__ */ import_react71.default.createElement("div", {
    className: classes.rightSection
  ...
  return /* @__PURE__ */ import_react71.default.createElement(TextInput, __spreadProps27(__spreadValues58({}, others), {
    variant,
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-NGN4FW2I.js.map
