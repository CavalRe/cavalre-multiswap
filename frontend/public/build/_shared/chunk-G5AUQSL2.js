...
var Swap = (props) => {
  ...
  const receiverComponent = (props2) => {
    const { token } = props2;
    const quote = (payToken, receiveToken) => {
      const g1 = payToken.reserve + payToken;
    };
  ...
  const handleSwap = () => {
    const totalAllocation = Object.values(assetTokens).map((a) => a.allocation).reduce((p, c) => p + c);
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(SimpleGrid, {
    ...
    onClick: () => console.log(Object.values(assetTokens).map((a) => {
      return {
        amount: a.amount,
...
//# sourceMappingURL=/build/_shared/chunk-G5AUQSL2.js.map
