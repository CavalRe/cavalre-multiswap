...
var useStyles11 = createStyles((theme, { spacing, breakpoints, cols }) => {
...
var SimpleGrid_styles_default = useStyles11;
...
var SimpleGrid = (0, import_react23.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("SimpleGrid", defaultProps10, props), { className, breakpoints, cols, spacing, children, classNames, styles: styles2 } = _a, others = __objRest16(_a, ["className", "breakpoints", "cols", "spacing", "children", "classNames", "styles"]);
  const { classes, cx } = SimpleGrid_styles_default({ breakpoints, cols, spacing }, { classNames, styles: styles2, name: "SimpleGrid" });
  return /* @__PURE__ */ import_react23.default.createElement(Box, __spreadValues26({
    className: cx(classes.root, className),
    ref
  }, others), children);
});
...
var useStyles12 = createStyles((theme, { captionSide, horizontalSpacing, verticalSpacing }, getRef2) => {
  const striped = { ref: getRef2("striped") };
  const hover = { ref: getRef2("hover") };
  return {
    striped,
    hover,
    root: __spreadProps9(__spreadValues27({}, theme.fn.fontStyles()), {
      width: "100%",
...
var Table_styles_default = useStyles12;
...
var Table = (0, import_react24.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Table", defaultProps11, props), {
    className,
    children,
    striped,
    highlightOnHover,
  ...
  return /* @__PURE__ */ import_react24.default.createElement(Box, __spreadProps10(__spreadValues28({}, others), {
    component: "table",
    ref,
...
var useStyles13 = createStyles((theme, { element, align }) => ({
  root: __spreadProps11(__spreadValues29({}, theme.fn.fontStyles()), {
...
var Title_styles_default = useStyles13;
...
var Title = (0, import_react25.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Title", defaultProps12, props), { className, order, children, align } = _a, others = __objRest18(_a, ["className", "order", "children", "align"]);
  const { classes, cx } = Title_styles_default({ element: `h${order}`, align }, { name: "Title" });
  if (![1, 2, 3, 4, 5, 6].includes(order)) {
    return null;
  }
  return /* @__PURE__ */ import_react25.default.createElement(Box, __spreadValues30({
    component: `h${order}`,
    ref,
    className: cx(classes.root, className)
  }, others), children);
...
var NavbarSection = (0, import_react26.forwardRef)((_a, ref) => {
  var _b = _a, { component, children, grow = false, sx } = _b, others = __objRest19(_b, ["component", "children", "grow", "sx"]);
  return /* @__PURE__ */ import_react26.default.createElement(Box, __spreadValues31({
    component: component || "div",
    ref,
...
var useStyles14 = createStyles((theme, { height, width, fixed, position: position2, hiddenBreakpoint, zIndex }) => {
  ...
  return {
    root: __spreadValues32(__spreadProps12(__spreadValues32(__spreadValues32({}, theme.fn.fontStyles()), position2), {
      zIndex,
      height,
...
var Navbar = (0, import_react27.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Navbar", defaultProps13, props), {
    width,
    height,
    fixed,
    position: position2,
  ...
  return /* @__PURE__ */ import_react27.default.createElement(Box, __spreadValues33({
    component: "nav",
    ref,
...
var ThemeIcon = (0, import_react28.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("ThemeIcon", defaultProps14, props), { className, size: size2, radius: radius2, variant, color, children, gradient } = _a, others = __objRest21(_a, ["className", "size", "radius", "variant", "color", "children", "gradient"]);
  ...
  return /* @__PURE__ */ import_react28.default.createElement(Box, __spreadValues35({
    className: cx(classes.root, className),
    ref
  }, others), children);
});
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-PBRG7SW5.js.map
