...
import {
  ...
  Text,
  Title
} from "/build/_shared/chunk-DASBXYTR.js";
import {
  useNavigate
...
var TokenSelect = (props) => {
  const { title, tokens, tokenComponent } = props;
...
var payerComponent = (props) => {
  ...
  return /* @__PURE__ */ React.createElement(Card, {
    ...
    component: "span"
  }, token.balance.toLocaleString()), /* @__PURE__ */ React.createElement(Text, {
    component: "span"
  }, token.symbol)));
};
var Swap = (props) => {
  const { assets, balances } = props;
  return /* @__PURE__ */ React.createElement(Container, null, /* @__PURE__ */ React.createElement(TokenSelect, {
    title: "Pay Tokens",
    tokens: balances,
...
//# sourceMappingURL=/build/_shared/chunk-J5TOQ4YR.js.map
