...
var MantineThemeContext = (0, import_react5.createContext)({
  theme: DEFAULT_THEME,
  styles: {},
...
function useMantineTheme() {
  var _a;
  return ((_a = (0, import_react5.useContext)(MantineThemeContext)) == null ? void 0 : _a.theme) || DEFAULT_THEME;
}
function useMantineThemeStyles() {
  var _a;
  return ((_a = (0, import_react5.useContext)(MantineThemeContext)) == null ? void 0 : _a.styles) || {};
}
...
var useStyles = createStyles((theme, { height, width, padding, fixed, position: position2, hiddenBreakpoint, zIndex }) => {
...
var Navbar = (0, import_react10.forwardRef)((_a, ref) => {
  var _b = _a, {
    width,
    height = "100vh",
    padding = 0,
    fixed = false,
    position: position2 = { top: 0, left: 0 },
  ...
  const { classes, cx } = Navbar_styles_default({ width, height, padding, fixed, position: position2, hiddenBreakpoint, zIndex }, { classNames, styles: styles2, name: "Navbar" });
...
var useStyles2 = createStyles((theme, { height, padding, fixed, position: position2, zIndex }) => ({
...
var Header = (0, import_react11.forwardRef)((_a, ref) => {
  var _b = _a, {
    children,
    className,
    classNames,
  ...
  const { classes, cx } = Header_styles_default({ height, padding, fixed, position: position2, zIndex }, { name: "Header", classNames, styles: styles2 });
...
function Loader(_a) {
  var _b = _a, { size: size2 = "md", color, variant } = _b, others = __objRest10(_b, ["size", "color", "variant"]);
  const theme = useMantineTheme();
...
var Group = (0, import_react19.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
  ...
  const items = filteredChildren.map((child) => import_react19.default.cloneElement(child, {
...
var useStyles7 = createStyles((theme, { fluid, size: size2, padding }) => ({
  root: {
    maxWidth: fluid ? "100%" : theme.fn.size({ size: size2, sizes: sizes3 }),
    marginLeft: "auto",
    marginRight: "auto",
...
var Container = (0, import_react20.forwardRef)((_a, ref) => {
  var _b = _a, { className, padding = "md", fluid, size: size2, styles: styles2, classNames } = _b, others = __objRest13(_b, ["className", "padding", "fluid", "size", "styles", "classNames"]);
  const { classes, cx } = Container_styles_default({ padding, fluid, size: size2 }, { styles: styles2, classNames, name: "Container" });
...
var List = (0, import_react23.forwardRef)((_a, ref) => {
  var _b = _a, {
    children,
    type = "unordered",
    size: size2 = "md",
...
var useStyles10 = createStyles((theme, { overflow, size: size2, centered }) => ({
  close: {},
  overlay: {},
  root: {
    position: "fixed",
...
var transitions = {
  ...
  pop: __spreadProps9(__spreadValues25({}, popIn), {
    common: { transformOrigin: "center center" }
  }),
  "pop-bottom-left": __spreadProps9(__spreadValues25({}, popIn), {
    common: { transformOrigin: "bottom left" }
  }),
  "pop-bottom-right": __spreadProps9(__spreadValues25({}, popIn), {
    common: { transformOrigin: "bottom right" }
  }),
  "pop-top-left": __spreadProps9(__spreadValues25({}, popIn), {
    common: { transformOrigin: "top left" }
  }),
  "pop-top-right": __spreadProps9(__spreadValues25({}, popIn), {
...
function getTransitionStyles({
  ...
  if (typeof transition === "string") {
    ...
    return __spreadValues26(__spreadValues26(__spreadValues26({
...
function useTransition({
  ...
  const [transitionStatus, setStatus] = (0, import_react32.useState)(mounted ? "entered" : "exited");
  const [transitionDuration, setTransitionDuration] = (0, import_react32.useState)(reduceMotion ? 0 : duration);
  const timeoutRef = (0, import_react32.useRef)(-1);
  ...
  (0, import_react32.useEffect)(() => () => window.clearTimeout(timeoutRef.current), []);
  return {
    transitionDuration,
    transitionStatus,
...
function GroupedTransition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react33.default.createElement(import_react33.default.Fragment, null, children({})) : null;
  }
  ...
  return /* @__PURE__ */ import_react33.default.createElement(import_react33.default.Fragment, null, children(transitionsStyles));
}
...
var useStyles11 = createStyles((theme, { radius, shadow, padding, withBorder }) => ({
  root: __spreadProps10(__spreadValues27({}, theme.fn.focusStyles()), {
    WebkitTapHighlightColor: "transparent",
    display: "block",
    textDecoration: "none",
    color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
...
var Paper = (0, import_react34.forwardRef)((_a, ref) => {
  var _b = _a, {
    component,
    className,
    children,
...
var useStyles12 = createStyles((theme, {
  ...
  return {
    root: __spreadProps11(__spreadValues29(__spreadValues29(__spreadValues29({}, theme.fn.fontStyles()), theme.fn.focusStyles()), getLineClamp(lineClamp)), {
...
var Text = (0, import_react35.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    component,
    size: size2 = "md",
...
var useStyles13 = createStyles((theme, { color, size: size2, radius }) => ({
...
var ActionIcon = (0, import_react36.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    color = "gray",
    children,
  ...
  const loader = /* @__PURE__ */ import_react36.default.createElement(Loader, __spreadValues32({
    color: colors.color,
    size: theme.fn.size({ size: size2, sizes: sizes5 }) - 12
  }, loaderProps));
  return /* @__PURE__ */ import_react36.default.createElement(Box, __spreadValues32({
    component: component || "button",
...
function CloseIcon(props) {
  return /* @__PURE__ */ import_react37.default.createElement("svg", __spreadValues33({
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
...
var CloseButton = (0, import_react38.forwardRef)((_a, ref) => {
  ...
  return /* @__PURE__ */ import_react38.default.createElement(ActionIcon, __spreadValues34({
    size: size2,
    ref
...
var Overlay = (0, import_react39.forwardRef)((_a, ref) => {
  var _b = _a, {
    opacity = 0.6,
    color = "#fff",
    gradient,
  ...
  return /* @__PURE__ */ import_react39.default.createElement(Box, __spreadValues35({
    ...
    ref,
    sx: [
      (theme) => __spreadProps13(__spreadValues35({}, background), {
        opacity,
        position: "absolute",
        top: 0,
        bottom: 0,
...
function MantineModal(_a) {
  ...
  const { classes, cx, theme } = Modal_styles_default({ size: size2, overflow, centered }, { classNames, styles: styles2, name: "Modal" });
  ...
  return /* @__PURE__ */ import_react40.default.createElement(GroupedTransition, {
  ...
  }, (transitionStyles) => /* @__PURE__ */ import_react40.default.createElement(Box, __spreadValues36({
    className: cx(classes.root, className)
    ...
    ref: focusTrapRef
  }, /* @__PURE__ */ import_react40.default.createElement(Paper, {
    ...
    "aria-modal": true,
    tabIndex: -1,
    style: __spreadProps14(__spreadValues36({}, transitionStyles.modal), {
      marginLeft: "calc(var(--removed-scroll-width, 0px) * -1)",
      zIndex: 3
    })
  }, (title || !hideCloseButton) && /* @__PURE__ */ import_react40.default.createElement("div", {
    className: classes.header
  }, /* @__PURE__ */ import_react40.default.createElement(Text, {
    id: titleId,
    className: classes.title
  }, title), !hideCloseButton && /* @__PURE__ */ import_react40.default.createElement(CloseButton, {
    iconSize: 16,
    onClick: onClose,
  ...
  }, /* @__PURE__ */ import_react40.default.createElement(Overlay, {
...
function Modal(_c) {
  var _d = _c, {
    zIndex = getDefaultZIndex("modal"),
    target
  } = _d, props = __objRest21(_d, [
    "zIndex",
    "target"
  ]);
  return /* @__PURE__ */ import_react40.default.createElement(Portal, {
    zIndex,
    target
  }, /* @__PURE__ */ import_react40.default.createElement(MantineModal, __spreadValues36({}, props)));
}
...
var Table = (0, import_react41.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    children,
    striped = false,
  ...
  return /* @__PURE__ */ import_react41.default.createElement(Box, __spreadProps16(__spreadValues38({}, others), {
    component: "table",
    ref,
...
var ThemeIcon = (0, import_react42.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    size: size2 = "md",
    radius = "sm",
  ...
  return /* @__PURE__ */ import_react42.default.createElement(Box, __spreadValues40({
    className: cx(classes.root, className),
    ref
  }, others), children);
});
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-KOIMQVCK.js.map
