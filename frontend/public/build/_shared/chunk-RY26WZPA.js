...
var Swap = (props) => {
  ...
  const receiverComponent = (props2) => {
    ...
    const handleAllocationChange = (allocation) => {
      let copiedSwapState = { ...swapState };
      copiedSwapState.assetTokens[token.token_address].allocation = allocation;
  ...
  }), /* @__PURE__ */ React.createElement(Text, null, `Total allocation: ${swapState.totalAllocation}`)), /* @__PURE__ */ React.createElement(Button, {
    onClick: handleSwap,
    mt: "xl",
    size: "md"
  }, "Swap"), swapState.totalAllocation !== 100 ? /* @__PURE__ */ React.createElement(Alert, {
    title: "Bummer!",
    color: "red",
    withCloseButton: true,
    variant: "outline",
    mt: "xl"
  }, "Something terrible happened! You made a mistake and there is no going back, your data was lost forever!") : null);
};
...
//# sourceMappingURL=/build/_shared/chunk-RY26WZPA.js.map
