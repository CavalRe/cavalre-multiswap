...
var TokenSelect = (props) => {
  ...
  const handleSelect = (v) => {
    ...
    if (!isPay && nSelected) {
      let totalAllocation2 = 0;
      for (let i = 0; i < nSelected - 1; i++) {
        totalAllocation2 += assetTokens[v[i]].allocation;
      }
      assetTokens[v[nSelected - 1]].allocation = Math.max(0, 100 - totalAllocation2);
    }
...
//# sourceMappingURL=/build/_shared/chunk-OPO4DMVM.js.map
