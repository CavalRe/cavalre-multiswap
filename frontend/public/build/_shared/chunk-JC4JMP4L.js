...
var useStyles6 = createStyles((theme, { overflow, size: size2, centered }) => ({
  close: {},
  overlay: {},
  root: {
    position: "fixed",
...
var Modal_styles_default = useStyles6;
...
var transitions = {
  ...
  pop: __spreadProps8(__spreadValues20({}, popIn), {
    common: { transformOrigin: "center center" }
  }),
  "pop-bottom-left": __spreadProps8(__spreadValues20({}, popIn), {
    common: { transformOrigin: "bottom left" }
  }),
  "pop-bottom-right": __spreadProps8(__spreadValues20({}, popIn), {
    common: { transformOrigin: "bottom right" }
  }),
  "pop-top-left": __spreadProps8(__spreadValues20({}, popIn), {
    common: { transformOrigin: "top left" }
  }),
  "pop-top-right": __spreadProps8(__spreadValues20({}, popIn), {
...
function getTransitionStyles({
  ...
  if (typeof transition === "string") {
    ...
    return __spreadValues21(__spreadValues21(__spreadValues21({
...
var useStyles7 = createStyles((theme, { radius, shadow, padding, withBorder }) => ({
  root: __spreadProps9(__spreadValues22({}, theme.fn.focusStyles()), {
    WebkitTapHighlightColor: "transparent",
    display: "block",
    textDecoration: "none",
    color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
...
var Paper_styles_default = useStyles7;
...
var useStyles8 = createStyles((theme, {
  ...
  return {
    root: __spreadProps10(__spreadValues24(__spreadValues24(__spreadValues24({}, theme.fn.fontStyles()), theme.fn.focusStyles()), getLineClamp(lineClamp)), {
...
var Text_styles_default = useStyles8;
...
var useStyles9 = createStyles((theme, { color, size: size2, radius }) => ({
  root: __spreadProps11(__spreadValues26(__spreadValues26({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
    position: "relative",
    appearance: "none",
    WebkitAppearance: "none",
    WebkitTapHighlightColor: "transparent",
...
var ActionIcon_styles_default = useStyles9;
...
var ActionIcon = (0, import_react30.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    color = "gray",
    children,
  ...
  const loader = /* @__PURE__ */ import_react30.default.createElement(Loader, __spreadValues27({
    color: colors.color,
    size: theme.fn.size({ size: size2, sizes: sizes4 }) - 12
  }, loaderProps));
  return /* @__PURE__ */ import_react30.default.createElement(Box, __spreadValues27({
    component: component || "button",
...
function CloseIcon(props) {
  return /* @__PURE__ */ import_react31.default.createElement("svg", __spreadValues28({
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
...
var CloseButton = (0, import_react32.forwardRef)((_a, ref) => {
  ...
  return /* @__PURE__ */ import_react32.default.createElement(ActionIcon, __spreadValues29({
    size: size2,
    ref
  }, others), /* @__PURE__ */ import_react32.default.createElement(CloseIcon, {
    width: _iconSize,
    height: _iconSize
  }));
});
...
var Overlay = (0, import_react33.forwardRef)((_a, ref) => {
  var _b = _a, {
    opacity = 0.6,
    color = "#fff",
    gradient,
  ...
  return /* @__PURE__ */ import_react33.default.createElement(Box, __spreadValues30({
    component: component || "div",
    ref,
    sx: [
      (theme) => __spreadProps12(__spreadValues30({}, background), {
        opacity,
        position: "absolute",
        top: 0,
        bottom: 0,
...
function MantineModal(_a) {
  ...
  return /* @__PURE__ */ import_react34.default.createElement(GroupedTransition, {
  ...
  }, (transitionStyles) => /* @__PURE__ */ import_react34.default.createElement(Box, __spreadValues31({
    className: cx(classes.root, className)
  }, others), /* @__PURE__ */ import_react34.default.createElement("div", {
    className: classes.inner,
    ...
    ref: focusTrapRef
  }, /* @__PURE__ */ import_react34.default.createElement(Paper, {
    ...
    "aria-modal": true,
    tabIndex: -1,
    style: __spreadProps13(__spreadValues31({}, transitionStyles.modal), {
      marginLeft: "calc(var(--removed-scroll-width, 0px) * -1)",
      zIndex: 3
    })
  }, (title || !hideCloseButton) && /* @__PURE__ */ import_react34.default.createElement("div", {
    className: classes.header
  }, /* @__PURE__ */ import_react34.default.createElement(Text, {
    id: titleId,
    className: classes.title
  }, title), !hideCloseButton && /* @__PURE__ */ import_react34.default.createElement(CloseButton, {
    iconSize: 16,
    onClick: onClose,
    ...
    id: bodyId,
    className: classes.body
  }, children))), /* @__PURE__ */ import_react34.default.createElement("div", {
...
function Modal(_c) {
  var _d = _c, {
    zIndex = getDefaultZIndex("modal"),
    target
  } = _d, props = __objRest17(_d, [
    "zIndex",
    "target"
  ]);
  return /* @__PURE__ */ import_react34.default.createElement(Portal, {
    zIndex,
    target
  }, /* @__PURE__ */ import_react34.default.createElement(MantineModal, __spreadValues31({}, props)));
}
...
var useStyles10 = createStyles((theme, { captionSide, horizontalSpacing, verticalSpacing }, getRef2) => {
  const striped = { ref: getRef2("striped") };
  const hover = { ref: getRef2("hover") };
  return {
    striped,
    hover,
    root: __spreadProps14(__spreadValues32({}, theme.fn.fontStyles()), {
      width: "100%",
...
var Table_styles_default = useStyles10;
...
var Table = (0, import_react35.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    children,
    striped = false,
  ...
  return /* @__PURE__ */ import_react35.default.createElement(Box, __spreadProps15(__spreadValues33({}, others), {
    component: "table",
    ref,
...
var useStyles11 = createStyles((theme, { color, size: size2, radius, gradientFrom, gradientTo, gradientDeg, variant }) => {
  const colors = getSharedColorScheme({
    theme,
    color,
    variant,
  ...
  return {
    root: __spreadProps16(__spreadValues34({}, theme.fn.fontStyles()), {
      display: "inline-flex",
      alignItems: "center",
      justifyContent: "center",
      boxSizing: "border-box",
...
var ThemeIcon_styles_default = useStyles11;
...
var ThemeIcon = (0, import_react36.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    size: size2 = "md",
    radius = "sm",
...
var useStyles12 = createStyles((theme, { fluid, size: size2, padding }) => ({
  root: {
...
var Container_styles_default = useStyles12;
...
var Container = (0, import_react37.forwardRef)((_a, ref) => {
  var _b = _a, { className, padding = "md", fluid, size: size2, styles: styles2, classNames } = _b, others = __objRest20(_b, ["className", "padding", "fluid", "size", "styles", "classNames"]);
  const { classes, cx } = Container_styles_default({ padding, fluid, size: size2 }, { styles: styles2, classNames, name: "Container" });
  return /* @__PURE__ */ import_react37.default.createElement(Box, __spreadValues36({
    className: cx(classes.root, className),
    ref
  }, others));
});
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-JC4JMP4L.js.map
