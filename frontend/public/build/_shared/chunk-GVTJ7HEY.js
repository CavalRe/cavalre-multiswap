...
// empty-module:~/moralis.server
var require_moralis = __commonJS({
  "empty-module:~/moralis.server"(exports, module) {
    init_react();
    module.exports = {};
  }
});
    ...
    await Moralis.Web3API.account.getTokenBalances({
      ...
      balanceData.forEach((b) => {
        if (b.token_address in assetTokens) {
          assetTokens[b.token_address].accountBalance = (0, import_moralis.decimalNumber)(b.balance, b.decimals);
        } else if (b.token_address == poolToken.address) {
          poolToken.accountBalance = (0, import_moralis.decimalNumber)(b.balance, b.decimals);
        } else {
          assetTokens[b.token_address].accountBalance = (0, import_moralis.decimalNumber)(b.accountBalance, b.decimals);
        }
        ;
      });
    });
...
//# sourceMappingURL=/build/_shared/chunk-GVTJ7HEY.js.map
