...
function useMediaQuery(query) {
  const [matches, setMatches] = (0, import_react20.useState)(getInitialValue(query));
  const queryRef = (0, import_react20.useRef)();
...
var useIsomorphicEffect = typeof document !== "undefined" ? import_react21.useLayoutEffect : import_react21.useEffect;
...
function useFocusTrap(active = true) {
  ...
  const setRef = (0, import_react24.useCallback)((node2) => {
    if (!active) {
      return;
    }
...
function useScrollLock(lock, options = {
  ...
  const [scrollLocked, setScrollLocked] = (0, import_react25.useState)(lock || false);
  const scrollTop = (0, import_react25.useRef)(0);
  const { disableBodyPadding } = options;
  const stylesheet = (0, import_react25.useRef)(null);
  const lockScroll = () => {
...
function useUuid(staticId) {
  const [uuid, setUuid] = (0, import_react26.useState)("");
  useIsomorphicEffect(() => {
    setUuid(randomId());
  }, []);
...
var transitions = {
  ...
  pop: __spreadProps8(__spreadValues21({}, popIn), {
    common: { transformOrigin: "center center" }
  }),
  "pop-bottom-left": __spreadProps8(__spreadValues21({}, popIn), {
    common: { transformOrigin: "bottom left" }
  }),
  "pop-bottom-right": __spreadProps8(__spreadValues21({}, popIn), {
    common: { transformOrigin: "bottom right" }
  }),
  "pop-top-left": __spreadProps8(__spreadValues21({}, popIn), {
    common: { transformOrigin: "top left" }
  }),
  "pop-top-right": __spreadProps8(__spreadValues21({}, popIn), {
...
function useTransition({
  ...
  const [transitionStatus, setStatus] = (0, import_react28.useState)(mounted ? "entered" : "exited");
  const [transitionDuration, setTransitionDuration] = (0, import_react28.useState)(reduceMotion ? 0 : duration);
...
function GroupedTransition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react29.default.createElement(import_react29.default.Fragment, null, children({})) : null;
  }
  ...
  return /* @__PURE__ */ import_react29.default.createElement(import_react29.default.Fragment, null, children(transitionsStyles));
}
...
var useStyles8 = createStyles((theme, { radius, shadow, padding, withBorder }) => ({
  root: __spreadProps9(__spreadValues23({}, theme.fn.focusStyles()), {
    WebkitTapHighlightColor: "transparent",
    display: "block",
    textDecoration: "none",
    color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
...
var Paper = (0, import_react30.forwardRef)((_a, ref) => {
  var _b = _a, {
    component,
    className,
    children,
  ...
  return /* @__PURE__ */ import_react30.default.createElement(Box, __spreadValues24({
    component: component || "div",
    className: cx(classes.root, className),
    ref
  }, others), children);
...
var useStyles9 = createStyles((theme, {
  ...
  return {
    root: __spreadProps10(__spreadValues25(__spreadValues25(__spreadValues25({}, theme.fn.fontStyles()), theme.fn.focusStyles()), getLineClamp(lineClamp)), {
...
var Text = (0, import_react31.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    component,
    size: size2 = "md",
...
var useStyles10 = createStyles((theme, { color, size: size2, radius }) => ({
  root: __spreadProps11(__spreadValues27(__spreadValues27({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
    position: "relative",
    appearance: "none",
    WebkitAppearance: "none",
    WebkitTapHighlightColor: "transparent",
...
var ActionIcon = (0, import_react32.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    color = "gray",
    children,
  ...
  const loader = /* @__PURE__ */ import_react32.default.createElement(Loader, __spreadValues28({
    color: colors.color,
    size: theme.fn.size({ size: size2, sizes: sizes4 }) - 12
  }, loaderProps));
  return /* @__PURE__ */ import_react32.default.createElement(Box, __spreadValues28({
    component: component || "button",
...
function CloseIcon(props) {
  return /* @__PURE__ */ import_react33.default.createElement("svg", __spreadValues29({
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
...
var CloseButton = (0, import_react34.forwardRef)((_a, ref) => {
  ...
  return /* @__PURE__ */ import_react34.default.createElement(ActionIcon, __spreadValues30({
    size: size2,
    ref
...
var Overlay = (0, import_react35.forwardRef)((_a, ref) => {
  var _b = _a, {
    opacity = 0.6,
    color = "#fff",
    gradient,
  ...
  return /* @__PURE__ */ import_react35.default.createElement(Box, __spreadValues31({
    component: component || "div",
    ref,
    sx: [
      (theme) => __spreadProps12(__spreadValues31({}, background), {
        opacity,
        position: "absolute",
        top: 0,
        bottom: 0,
...
function MantineModal(_a) {
  ...
  return /* @__PURE__ */ import_react36.default.createElement(GroupedTransition, {
  ...
  }, (transitionStyles) => /* @__PURE__ */ import_react36.default.createElement(Box, __spreadValues32({
    className: cx(classes.root, className)
  }, others), /* @__PURE__ */ import_react36.default.createElement("div", {
    className: classes.inner,
    ...
    ref: focusTrapRef
  }, /* @__PURE__ */ import_react36.default.createElement(Paper, {
    ...
    "aria-modal": true,
    tabIndex: -1,
    style: __spreadProps13(__spreadValues32({}, transitionStyles.modal), {
      marginLeft: "calc(var(--removed-scroll-width, 0px) * -1)",
      zIndex: 3
    })
  }, (title || !hideCloseButton) && /* @__PURE__ */ import_react36.default.createElement("div", {
    className: classes.header
  }, /* @__PURE__ */ import_react36.default.createElement(Text, {
    id: titleId,
    className: classes.title
  }, title), !hideCloseButton && /* @__PURE__ */ import_react36.default.createElement(CloseButton, {
    iconSize: 16,
    onClick: onClose,
    ...
    id: bodyId,
    className: classes.body
  }, children))), /* @__PURE__ */ import_react36.default.createElement("div", {
    style: transitionStyles.overlay
  }, /* @__PURE__ */ import_react36.default.createElement(Overlay, {
...
function Modal(_c) {
  var _d = _c, {
    zIndex = getDefaultZIndex("modal"),
    target
  } = _d, props = __objRest18(_d, [
    "zIndex",
    "target"
  ]);
  return /* @__PURE__ */ import_react36.default.createElement(Portal, {
    zIndex,
    target
  }, /* @__PURE__ */ import_react36.default.createElement(MantineModal, __spreadValues32({}, props)));
}
...
var useStyles11 = createStyles((theme, { captionSide, horizontalSpacing, verticalSpacing }, getRef2) => {
  ...
  return {
    striped,
    hover,
    root: __spreadProps14(__spreadValues33({}, theme.fn.fontStyles()), {
      width: "100%",
...
var Table = (0, import_react37.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    children,
    striped = false,
  ...
  return /* @__PURE__ */ import_react37.default.createElement(Box, __spreadProps15(__spreadValues34({}, others), {
    component: "table",
    ref,
...
var useStyles12 = createStyles((theme, { color, size: size2, radius, gradientFrom, gradientTo, gradientDeg, variant }) => {
  ...
  return {
    root: __spreadProps16(__spreadValues35({}, theme.fn.fontStyles()), {
      display: "inline-flex",
      alignItems: "center",
      justifyContent: "center",
      boxSizing: "border-box",
...
var ThemeIcon = (0, import_react38.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    size: size2 = "md",
    radius = "sm",
  ...
  return /* @__PURE__ */ import_react38.default.createElement(Box, __spreadValues36({
    className: cx(classes.root, className),
    ref
  }, others), children);
});
...
var useStyles13 = createStyles((theme, { fluid, size: size2, padding }) => ({
  root: {
...
var Container_styles_default = useStyles13;
...
var Container = (0, import_react39.forwardRef)((_a, ref) => {
  var _b = _a, { className, padding = "md", fluid, size: size2, styles: styles2, classNames } = _b, others = __objRest21(_b, ["className", "padding", "fluid", "size", "styles", "classNames"]);
  const { classes, cx } = Container_styles_default({ padding, fluid, size: size2 }, { styles: styles2, classNames, name: "Container" });
  return /* @__PURE__ */ import_react39.default.createElement(Box, __spreadValues37({
    className: cx(classes.root, className),
    ref
  }, others));
});
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-7XBNRXVY.js.map
