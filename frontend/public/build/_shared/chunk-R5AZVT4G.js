...
var useStyles8 = createStyles((theme, { overflow, size: size2, centered }) => ({
  close: {},
  overlay: {},
  root: {
    position: "fixed",
...
var transitions = {
  ...
  pop: __spreadProps8(__spreadValues22({}, popIn), {
    common: { transformOrigin: "center center" }
  }),
  "pop-bottom-left": __spreadProps8(__spreadValues22({}, popIn), {
    common: { transformOrigin: "bottom left" }
  }),
  "pop-bottom-right": __spreadProps8(__spreadValues22({}, popIn), {
    common: { transformOrigin: "bottom right" }
  }),
  "pop-top-left": __spreadProps8(__spreadValues22({}, popIn), {
    common: { transformOrigin: "top left" }
  }),
  "pop-top-right": __spreadProps8(__spreadValues22({}, popIn), {
...
function getTransitionStyles({
  ...
  if (typeof transition === "string") {
    ...
    return __spreadValues23(__spreadValues23(__spreadValues23({
...
function GroupedTransition({
  ...
  return /* @__PURE__ */ import_react30.default.createElement(import_react30.default.Fragment, null, children(transitionsStyles));
}
...
var useStyles9 = createStyles((theme, { radius, shadow, padding, withBorder }) => ({
  root: __spreadProps9(__spreadValues24({}, theme.fn.focusStyles()), {
    WebkitTapHighlightColor: "transparent",
    display: "block",
    textDecoration: "none",
    color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
...
var useStyles10 = createStyles((theme, {
  ...
  return {
    root: __spreadProps10(__spreadValues26(__spreadValues26(__spreadValues26({}, theme.fn.fontStyles()), theme.fn.focusStyles()), getLineClamp(lineClamp)), {
...
var Text = (0, import_react32.forwardRef)((_a, ref) => {
  ...
  return /* @__PURE__ */ import_react32.default.createElement(Box, __spreadValues27({
    ref,
    component: component || "div",
...
var useStyles11 = createStyles((theme, { color, size: size2, radius }) => ({
  root: __spreadProps11(__spreadValues28(__spreadValues28({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
    position: "relative",
    appearance: "none",
    WebkitAppearance: "none",
    WebkitTapHighlightColor: "transparent",
...
var ActionIcon = (0, import_react33.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    color = "gray",
    children,
  ...
  const loader = /* @__PURE__ */ import_react33.default.createElement(Loader, __spreadValues29({
    color: colors.color,
    size: theme.fn.size({ size: size2, sizes: sizes5 }) - 12
  }, loaderProps));
  return /* @__PURE__ */ import_react33.default.createElement(Box, __spreadValues29({
    component: component || "button",
...
function CloseIcon(props) {
  return /* @__PURE__ */ import_react34.default.createElement("svg", __spreadValues30({
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
...
var CloseButton = (0, import_react35.forwardRef)((_a, ref) => {
  ...
  return /* @__PURE__ */ import_react35.default.createElement(ActionIcon, __spreadValues31({
    size: size2,
    ref
  }, others), /* @__PURE__ */ import_react35.default.createElement(CloseIcon, {
    width: _iconSize,
    height: _iconSize
  }));
});
...
var Overlay = (0, import_react36.forwardRef)((_a, ref) => {
  ...
  return /* @__PURE__ */ import_react36.default.createElement(Box, __spreadValues32({
    ...
    ref,
    sx: [
      (theme) => __spreadProps12(__spreadValues32({}, background), {
        opacity,
        position: "absolute",
        top: 0,
        bottom: 0,
...
function MantineModal(_a) {
  ...
  return /* @__PURE__ */ import_react37.default.createElement(GroupedTransition, {
  ...
  }, (transitionStyles) => /* @__PURE__ */ import_react37.default.createElement(Box, __spreadValues33({
    className: cx(classes.root, className)
    ...
    "aria-modal": true,
    tabIndex: -1,
    style: __spreadProps13(__spreadValues33({}, transitionStyles.modal), {
...
function Modal(_c) {
  ...
  return /* @__PURE__ */ import_react37.default.createElement(Portal, {
    zIndex,
    target
  }, /* @__PURE__ */ import_react37.default.createElement(MantineModal, __spreadValues33({}, props)));
}
...
var Table = (0, import_react38.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    children,
    striped = false,
  ...
  return /* @__PURE__ */ import_react38.default.createElement(Box, __spreadProps15(__spreadValues35({}, others), {
    component: "table",
    ref,
...
var useStyles13 = createStyles((theme, { color, size: size2, radius, gradientFrom, gradientTo, gradientDeg, variant }) => {
  ...
  return {
    root: __spreadProps16(__spreadValues36({}, theme.fn.fontStyles()), {
      display: "inline-flex",
      alignItems: "center",
      justifyContent: "center",
      boxSizing: "border-box",
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-R5AZVT4G.js.map
