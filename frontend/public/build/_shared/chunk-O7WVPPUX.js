  ...
  const handleIncreaseAllowance = async () => {
    ...
    if (increaseAmount > 0) {
      ...
      await Moralis.executeFunction({
        ...
        params: {
          spender: poolToken.address,
          amount: BigNumber.from(10).pow(poolToken.decimals).mul(increaseAmount)
        }
      });
    }
    ;
    Object.values(assetTokens).forEach(async (asset) => {
      ...
      if (increaseAmount2 > 0) {
        ...
        await Moralis.executeFunction({
          ...
          params: {
            spender: poolToken.address,
            amount: BigNumber.from(10).pow(poolToken.decimals).mul(increaseAmount2)
          }
        });
      }
      ;
...
//# sourceMappingURL=/build/_shared/chunk-O7WVPPUX.js.map
