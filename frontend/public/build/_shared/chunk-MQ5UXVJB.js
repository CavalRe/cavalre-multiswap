...
var Swap = (props) => {
  ...
  const [totalAllocation, setTotalAllocation] = (0, import_react.useState)(100);
  const TokenSelect = (props2) => {
    var _a;
    const { title, tokenComponent, placeholder } = props2;
  ...
  const handleSwap = () => {
    ...
    console.log(Object.values(assetTokens).map((a) => {
      return {
        amount: a.amount,
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(SimpleGrid, {
    ...
    mt: "xl",
    size: "md"
  }, "Swap"), totalAllocation == 100 ? /* @__PURE__ */ React.createElement(Alert, {
    title: "Bummer!",
    color: "red",
...
//# sourceMappingURL=/build/_shared/chunk-MQ5UXVJB.js.map
