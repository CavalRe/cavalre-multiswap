...
var Swap = (props) => {
  ...
  })), /* @__PURE__ */ React.createElement(Text, null, `Total allocation: ${(100 * totalAllocation).toFixed(2)}%`), isAuthenticated ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Button, {
    type: "submit",
    onClick: handleSwap,
    mt: "xl",
    size: "md",
    disabled: Math.abs(totalAllocation - 1) > 1e-4 || !checkAllocations()
  }, "Execute Swap"), checkAllocations() ? null : /* @__PURE__ */ React.createElement(Text, null, "Not enough tokens to execute swap")) : /* @__PURE__ */ React.createElement(Button, {
    type: "submit",
    onClick: handleLogin,
    mt: "xl",
    size: "md"
...
//# sourceMappingURL=/build/_shared/chunk-NMHJLXRY.js.map
