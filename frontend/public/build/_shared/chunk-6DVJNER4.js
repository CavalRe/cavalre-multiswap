...
function useMantineDefaultProps(component, defaultProps11, props) {
  ...
  return __spreadValues3(__spreadValues3(__spreadValues3({}, defaultProps11), contextProps), props);
}
...
function MantineProvider({
  ...
  const overrides = {
    ...
    defaultProps: inherit ? __spreadValues3(__spreadValues3({}, ctx.defaultProps), defaultProps11) : defaultProps11
  };
...
function createStyles(getCssObjectOrCssObject) {
  ...
  function useStyles12(params, options) {
    const theme = useMantineTheme();
...
var NavbarSection = (0, import_react22.forwardRef)((_a, ref) => {
  ...
  return /* @__PURE__ */ import_react22.default.createElement(Box, __spreadValues22({
...
var useStyles9 = createStyles((theme, { height, width, fixed, position: position2, hiddenBreakpoint, zIndex }) => {
  ...
  return {
    root: __spreadValues23(__spreadProps9(__spreadValues23(__spreadValues23({}, theme.fn.fontStyles()), position2), {
      zIndex,
      height,
...
var Navbar_styles_default = useStyles9;
...
var useStyles10 = createStyles((theme, { height, fixed, position: position2, zIndex }) => ({
  root: __spreadProps10(__spreadValues25(__spreadValues25({}, theme.fn.fontStyles()), position2), {
    zIndex,
    height,
    maxHeight: height,
    position: fixed ? "fixed" : "static",
...
var Header_styles_default = useStyles10;
...
var useStyles11 = createStyles((theme, { color, size: size2, radius: radius2, gradientFrom, gradientTo, gradientDeg, variant }) => {
  const colors = getSharedColorScheme({
    theme,
    color,
    variant,
  ...
  return {
    root: __spreadProps11(__spreadValues27({}, theme.fn.fontStyles()), {
      display: "inline-flex",
      alignItems: "center",
      justifyContent: "center",
      boxSizing: "border-box",
...
var ThemeIcon = (0, import_react25.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("ThemeIcon", defaultProps10, props), { className, size: size2, radius: radius2, variant, color, children, gradient } = _a, others = __objRest17(_a, ["className", "size", "radius", "variant", "color", "children", "gradient"]);
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-6DVJNER4.js.map
