...
var TokenSelect = (props) => {
  ...
  const getItems = () => {
    ...
    ;
    items2 = items2.concat(Object.values(assetTokens).filter((t) => isPay ? t.selection == "Pay" : t.selection == "Receive").map((t) => {
      return {
...
//# sourceMappingURL=/build/_shared/chunk-NLAUR5SN.js.map
