import {
  useMoralis
} from "/build/_shared/chunk-IW2VQIS6.js";
import {
  Button,
  Card,
  Container,
  ...
  Text,
  Title
} from "/build/_shared/chunk-RCM7J53J.js";
import {
  useNavigate
...
var import_Swap = __toESM(require_Swap());
var Dashboard = (props) => {
  const {
    isInitialized,
    isAuthenticated,
  ...
  const [opened, setOpened] = (0, import_react.useState)(true);
  ...
  }, /* @__PURE__ */ React.createElement(import_Swap.default, null))) : null, /* @__PURE__ */ React.createElement(Card, {
    withBorder: true,
    p: "xl",
    radius: "md",
    mt: "lg"
...
//# sourceMappingURL=/build/_shared/chunk-NMUA262V.js.map
