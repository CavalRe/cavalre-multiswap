import {
  useMoralis
} from "/build/_shared/chunk-CCO6UATH.js";
import {
  Button,
  Card,
  Container,
  ...
  Text,
  Title
} from "/build/_shared/chunk-EOHMIR3E.js";
import {
  useNavigate
...
var Dashboard = (props) => {
  ...
  const rows = assets == null ? void 0 : assets.map((a, i) => /* @__PURE__ */ React.createElement("tr", {
    ...
    size: cellTextSize
  }, "(a.reserve / numeraire.price).toLocaleString(undefined, numberOptions)")), /* @__PURE__ */ React.createElement("td", {
    align: "right"
...
//# sourceMappingURL=/build/_shared/chunk-SKRKEZAP.js.map
