...
var Swap = (props) => {
  ...
  const [totalAllocation, setTotalAllocation] = (0, import_react.useState)(Object.values(assetTokens).map((a) => a.allocation).reduce((p, c) => p + c, 0));
...
//# sourceMappingURL=/build/_shared/chunk-F7T7PIX4.js.map
