...
var Table = (0, import_react25.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react25.default.createElement(Box, __spreadProps10(__spreadValues27({}, others), {
    component: "table",
    ref,
...
var Title = (0, import_react26.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Title", defaultProps11, props), { className, order, children, align } = _a, others = __objRest18(_a, ["className", "order", "children", "align"]);
  const { classes, cx } = Title_styles_default({ element: `h${order}`, align }, { name: "Title" });
  if (![1, 2, 3, 4, 5, 6].includes(order)) {
    return null;
  }
  return /* @__PURE__ */ import_react26.default.createElement(Box, __spreadValues29({
    component: `h${order}`,
    ref,
    className: cx(classes.root, className)
  }, others), children);
...
var NavbarSection = (0, import_react27.forwardRef)((_a, ref) => {
...
var ThemeIcon = (0, import_react29.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("ThemeIcon", defaultProps13, props), { className, size: size2, radius: radius2, variant, color, children, gradient } = _a, others = __objRest21(_a, ["className", "size", "radius", "variant", "color", "children", "gradient"]);
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-PB5IHN2T.js.map
