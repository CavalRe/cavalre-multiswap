...
var TokenSelect = (props) => {
  ...
  const { poolToken, assetTokens } = swapState;
  const [selected, setSelected] = (0, import_react2.useState)(Object.values(assetTokens).filter((asset) => isPay && asset.selection == "Pay" || !isPay && asset.selection == "Receive").map((asset) => asset.address));
...
//# sourceMappingURL=/build/_shared/chunk-3NMPPO2S.js.map
