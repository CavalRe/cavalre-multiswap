...
function useMantineDefaultProps(component, defaultProps10, props) {
  var _a, _b;
  ...
  return __spreadValues3(__spreadValues3(__spreadValues3({}, defaultProps10), contextProps), props);
}
...
function MantineProvider({
  ...
  const overrides = {
    ...
    defaultProps: inherit ? __spreadValues3(__spreadValues3({}, ctx.defaultProps), defaultProps10) : defaultProps10
  };
...
function createStyles(getCssObjectOrCssObject) {
  ...
  function useStyles11(params, options) {
    const theme = useMantineTheme();
...
init_react();
var useStyles4 = createStyles((theme, { fluid, size: size2, sizes: sizes3 }) => ({
  root: {
...
var Container = (0, import_react13.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Container", defaultProps4, props), { className, fluid, size: size2, styles: styles2, classNames, sizes: sizes3 } = _a, others = __objRest6(_a, ["className", "fluid", "size", "styles", "classNames", "sizes"]);
...
var useStyles8 = createStyles((theme, { height, fixed, position: position2, zIndex }) => ({
  root: __spreadProps8(__spreadValues21(__spreadValues21({}, theme.fn.fontStyles()), position2), {
    zIndex,
    height,
    maxHeight: height,
...
var useStyles9 = createStyles((theme, {
  ...
  return {
    ...
    input: variant === "headless" ? {} : __spreadProps9(__spreadValues23(__spreadProps9(__spreadValues23({}, theme.fn.fontStyles()), {
...
var useStyles10 = createStyles((theme, {
  ...
  return {
    ...
    root: __spreadProps10(__spreadValues24(__spreadValues24(__spreadValues24(__spreadValues24({}, getSizeStyles({ compact, size: size2 })), theme.fn.fontStyles()), theme.fn.focusStyles()), getWidthStyles(fullWidth)), {
      borderRadius: theme.fn.radius(radius2),
      fontWeight: 600,
      position: "relative",
      lineHeight: 1,
...
var Button = (0, import_react23.forwardRef)((props, ref) => {
  ...
  const loader = /* @__PURE__ */ import_react23.default.createElement(Loader, __spreadValues25({
    color: colors.color,
  ...
  }, (leftIcon || loading && loaderPosition === "left") && /* @__PURE__ */ import_react23.default.createElement("span", {
    className: cx(classes.icon, classes.leftIcon)
  }, loading && loaderPosition === "left" ? loader : leftIcon), /* @__PURE__ */ import_react23.default.createElement("span", {
    className: classes.label,
    style: { textTransform: uppercase ? "uppercase" : void 0 }
  }, children), (rightIcon || loading && loaderPosition === "right") && /* @__PURE__ */ import_react23.default.createElement("span", {
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-ABEYID2O.js.map
