...
function useMantineDefaultProps(component, defaultProps14, props) {
  var _a, _b;
  ...
  return __spreadValues3(__spreadValues3(__spreadValues3({}, defaultProps14), contextProps), props);
}
...
function MantineProvider({
  ...
  const overrides = {
    ...
    defaultProps: inherit ? __spreadValues3(__spreadValues3({}, ctx.defaultProps), defaultProps14) : defaultProps14
  };
...
init_react();
var useStyles9 = createStyles((theme, { fluid, size: size2, sizes: sizes4 }) => ({
  root: {
...
var Container = (0, import_react20.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Container", defaultProps8, props), { className, fluid, size: size2, styles: styles2, classNames, sizes: sizes4 } = _a, others = __objRest14(_a, ["className", "fluid", "size", "styles", "classNames", "sizes"]);
  const { classes, cx } = Container_styles_default({ fluid, size: size2, sizes: sizes4 }, { styles: styles2, classNames, name: "Container" });
  return /* @__PURE__ */ import_react20.default.createElement(Box, __spreadValues23({
    className: cx(classes.root, className),
    ref
  }, others));
});
...
var SimpleGrid = (0, import_react21.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react21.default.createElement(Box, __spreadValues25({
    className: cx(classes.root, className),
    ref
  }, others), children);
});
...
var useStyles11 = createStyles((theme, { captionSide, horizontalSpacing, verticalSpacing }, getRef2) => {
  ...
  return {
    striped,
    hover,
    root: __spreadProps9(__spreadValues26({}, theme.fn.fontStyles()), {
      width: "100%",
...
var Table = (0, import_react22.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react22.default.createElement(Box, __spreadProps10(__spreadValues27({}, others), {
    component: "table",
    ref,
...
var useStyles12 = createStyles((theme, { element, align }) => ({
  root: __spreadProps11(__spreadValues28({}, theme.fn.fontStyles()), {
...
var Title = (0, import_react23.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react23.default.createElement(Box, __spreadValues29({
    component: `h${order}`,
    ref,
    className: cx(classes.root, className)
  }, others), children);
...
var NavbarSection = (0, import_react24.forwardRef)((_a, ref) => {
  var _b = _a, { component, children, grow = false, sx } = _b, others = __objRest18(_b, ["component", "children", "grow", "sx"]);
  return /* @__PURE__ */ import_react24.default.createElement(Box, __spreadValues30({
    component: component || "div",
    ref,
...
var useStyles13 = createStyles((theme, { height, width, fixed, position: position2, hiddenBreakpoint, zIndex }) => {
  ...
  return {
    root: __spreadValues31(__spreadProps12(__spreadValues31(__spreadValues31({}, theme.fn.fontStyles()), position2), {
      zIndex,
      height,
...
var Navbar_styles_default = useStyles13;
...
var Navbar = (0, import_react25.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Navbar", defaultProps12, props), {
    width,
    height,
    fixed,
    position: position2,
  ...
  return /* @__PURE__ */ import_react25.default.createElement(Box, __spreadValues32({
    component: "nav",
    ref,
...
var useStyles14 = createStyles((theme, { color, size: size2, radius: radius2, gradientFrom, gradientTo, gradientDeg, variant }) => {
  const colors = getSharedColorScheme({
    theme,
    color,
    variant,
  ...
  return {
    root: __spreadProps13(__spreadValues33({}, theme.fn.fontStyles()), {
      display: "inline-flex",
      alignItems: "center",
      justifyContent: "center",
      boxSizing: "border-box",
...
var ThemeIcon_styles_default = useStyles14;
...
var ThemeIcon = (0, import_react26.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("ThemeIcon", defaultProps13, props), { className, size: size2, radius: radius2, variant, color, children, gradient } = _a, others = __objRest20(_a, ["className", "size", "radius", "variant", "color", "children", "gradient"]);
  ...
  return /* @__PURE__ */ import_react26.default.createElement(Box, __spreadValues34({
    className: cx(classes.root, className),
    ref
  }, others), children);
});
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-FSUIF3EM.js.map
