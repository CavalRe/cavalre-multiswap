import {
  init_extends,
  require_react_dom
} from "/build/_shared/chunk-AS3DLARU.js";
import {
  __commonJS,
  __toESM,
  init_react,
...
function useMantineDefaultProps(component, defaultProps16, props) {
  var _a, _b;
  ...
  return __spreadValues3(__spreadValues3(__spreadValues3({}, defaultProps16), contextProps), props);
}
...
function MantineProvider({
  ...
  const overrides = {
    ...
    defaultProps: inherit ? __spreadValues3(__spreadValues3({}, ctx.defaultProps), defaultProps16) : defaultProps16
  };
...
init_react();
var useStyles7 = createStyles((theme, { fluid, size: size2, sizes: sizes5 }) => ({
  root: {
...
var Container = (0, import_react20.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Container", defaultProps7, props), { className, fluid, size: size2, styles: styles2, classNames, sizes: sizes5 } = _a, others = __objRest13(_a, ["className", "fluid", "size", "styles", "classNames", "sizes"]);
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-MGOCVSHS.js.map
