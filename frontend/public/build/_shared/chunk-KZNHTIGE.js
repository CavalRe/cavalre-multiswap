...
function useMantineDefaultProps(component, defaultProps19, props) {
  var _a, _b;
  ...
  return __spreadValues3(__spreadValues3(__spreadValues3({}, defaultProps19), contextProps), props);
}
...
function MantineProvider({
  ...
  const overrides = {
    ...
    defaultProps: inherit ? __spreadValues3(__spreadValues3({}, ctx.defaultProps), defaultProps19) : defaultProps19
  };
...
function createStyles(getCssObjectOrCssObject) {
  ...
  function useStyles18(params, options) {
    const theme = useMantineTheme();
...
var useStyles = createStyles((theme, {
  ...
  return {
    root: __spreadProps4(__spreadValues5(__spreadValues5(__spreadValues5({}, theme.fn.fontStyles()), theme.fn.focusStyles()), getLineClamp(lineClamp)), {
...
var Text = (0, import_react9.forwardRef)((props, ref) => {
...
var useStyles2 = createStyles((theme, { height, fixed, position: position2, zIndex }) => ({
  root: __spreadProps5(__spreadValues8(__spreadValues8({}, theme.fn.fontStyles()), position2), {
    zIndex,
    height,
    maxHeight: height,
...
var Header_styles_default = useStyles2;
...
var Header = (0, import_react10.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Header", defaultProps2, props), { children, className, classNames, styles: styles2, height, fixed, position: position2, zIndex } = _a, others = __objRest4(_a, ["children", "className", "classNames", "styles", "height", "fixed", "position", "zIndex"]);
...
var useStyles3 = createStyles((theme, props) => ({
  root: {
    boxSizing: "border-box"
  },
  body: {
...
var AppShell_styles_default = useStyles3;
...
var AppShell = (0, import_react11.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("AppShell", defaultProps3, props), {
    children,
    navbar,
    header,
    fixed = false,
  ...
  const _header = header ? import_react11.default.cloneElement(header, { fixed, zIndex }) : null;
  const _navbar = navbar ? import_react11.default.cloneElement(navbar, {
    fixed,
    zIndex,
    height: navbarHeight !== "0px" ? navbarHeight : `calc(100vh - ${headerHeight})`,
    position: { top: headerHeight, left: 0 }
  }) : null;
  return /* @__PURE__ */ import_react11.default.createElement(Box, __spreadValues11({
    className: cx(classes.root, className),
    ref
  }, others), _header, /* @__PURE__ */ import_react11.default.createElement("div", {
    className: classes.body
  }, _navbar, /* @__PURE__ */ import_react11.default.createElement("main", {
...
var Button_styles_default = useStyles5;
...
function Bars(_a) {
  ...
  return /* @__PURE__ */ import_react12.default.createElement("svg", __spreadValues14({
    viewBox: "0 0 135 140",
...
function Oval(_a) {
  ...
  return /* @__PURE__ */ import_react13.default.createElement("svg", __spreadValues15({
    width: `${size2}px`,
    height: `${size2}px`,
    viewBox: "0 0 38 38",
    xmlns: "http://www.w3.org/2000/svg",
...
function Dots(_a) {
  ...
  return /* @__PURE__ */ import_react14.default.createElement("svg", __spreadValues16({
    width: `${size2}px`,
    height: `${size2 / 4}px`,
    viewBox: "0 0 120 30",
    xmlns: "http://www.w3.org/2000/svg",
...
function Loader(props) {
  const _a = useMantineDefaultProps("Loader", defaultProps4, props), {
    size: size2 = "md",
    color,
    variant
  ...
  return /* @__PURE__ */ import_react15.default.createElement(Box, __spreadValues17({
    role: "presentation",
...
var Button = (0, import_react16.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Button", defaultProps5, props), {
    className,
    size: size2,
    color,
    type,
  ...
  const loader = /* @__PURE__ */ import_react16.default.createElement(Loader, __spreadValues18({
    color: colors.color,
...
var useStyles6 = createStyles((theme, { radius: radius2, shadow, withBorder }) => ({
  root: __spreadProps8(__spreadValues19({}, theme.fn.focusStyles()), {
    WebkitTapHighlightColor: "transparent",
    display: "block",
    textDecoration: "none",
    color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
...
var defaultProps6 = {};
var Paper = (0, import_react17.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Paper", defaultProps6, props), { component, className, children, radius: radius2, withBorder, shadow } = _a, others = __objRest11(_a, ["component", "className", "children", "radius", "withBorder", "shadow"]);
  const { classes, cx } = Paper_styles_default({ radius: radius2, shadow, withBorder }, { name: "Paper" });
  return /* @__PURE__ */ import_react17.default.createElement(Box, __spreadValues20({
    component: component || "div",
    className: cx(classes.root, className),
    ref
  }, others), children);
...
init_react();
var useStyles7 = createStyles((theme, { padding, first, last: last3 }) => ({
  cardSection: {
    display: "block",
...
var CardSection_styles_default = useStyles7;
...
var CardSection = (0, import_react18.forwardRef)((_a, ref) => {
  var _b = _a, { className, padding = 0, component, first, last: last3 } = _b, others = __objRest12(_b, ["className", "padding", "component", "first", "last"]);
  const { classes, cx } = CardSection_styles_default({ padding, first, last: last3 }, { name: "Card" });
  return /* @__PURE__ */ import_react18.default.createElement(Box, __spreadValues21({
    component: component || "div",
...
var Card_styles_default = useStyles8;
...
var Card = (0, import_react19.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Card", defaultProps7, props), { component, className, p, radius: radius2, children, classNames, styles: styles2 } = _a, others = __objRest13(_a, ["component", "className", "p", "radius", "children", "classNames", "styles"]);
  const { classes, cx } = Card_styles_default(null, { name: "Card", classNames, styles: styles2 });
  const _children = import_react19.Children.toArray(children);
  ...
  return /* @__PURE__ */ import_react19.default.createElement(Paper, __spreadValues22({
    className: cx(classes.root, className),
    radius: radius2,
    p,
    component,
...
var useStyles9 = createStyles((theme, { spacing, position: position2, noWrap, direction, grow, align, count }) => ({
  root: {
    boxSizing: "border-box",
    display: "flex",
...
function filterFalsyChildren(children) {
  return import_react20.Children.toArray(children).filter(Boolean);
}
...
var Group = (0, import_react21.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Group", defaultProps8, props), {
    className,
    position: position2,
    align,
    children,
  ...
  return /* @__PURE__ */ import_react21.default.createElement(Box, __spreadValues23({
    className: cx(classes.root, className),
    ref
  }, others), items);
});
...
init_react();
var useStyles10 = createStyles((theme, { fluid, size: size2, sizes: sizes5 }) => ({
  root: {
...
var Container_styles_default = useStyles10;
...
var Container = (0, import_react22.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Container", defaultProps9, props), { className, fluid, size: size2, styles: styles2, classNames, sizes: sizes5 } = _a, others = __objRest15(_a, ["className", "fluid", "size", "styles", "classNames", "sizes"]);
...
var useIsomorphicEffect = typeof document !== "undefined" ? import_react23.useLayoutEffect : import_react23.useEffect;
...
function useUuid(staticId) {
  const [uuid, setUuid] = (0, import_react24.useState)("");
  useIsomorphicEffect(() => {
    setUuid(randomId());
  }, []);
...
var useStyles11 = createStyles((theme, { size: size2 }) => ({
  root: __spreadProps9(__spreadValues25({}, theme.fn.fontStyles()), {
    lineHeight: theme.lineHeight
  }),
  label: {
    display: "inline-block",
...
var InputWrapper_styles_default = useStyles11;
...
var InputWrapper = (0, import_react25.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("InputWrapper", defaultProps10, props), {
    className,
    label,
    children,
    required,
  ...
  const inputLabel = (0, import_react25.createElement)(labelElement, __spreadProps10(__spreadValues26(__spreadValues26({}, _labelProps), labelProps), {
  ...
  return /* @__PURE__ */ import_react25.default.createElement(Box, __spreadValues26({
    className: cx(classes.root, className),
    ref
  }, others), label && inputLabel, description && /* @__PURE__ */ import_react25.default.createElement(Text, __spreadProps10(__spreadValues26({}, descriptionProps), {
    color: "gray",
    className: classes.description
  }), description), children, typeof error !== "boolean" && error && /* @__PURE__ */ import_react25.default.createElement(Text, __spreadProps10(__spreadValues26({}, errorProps), {
    size: size2,
...
var Input = (0, import_react26.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Input", defaultProps11, props), {
    component,
    className,
    invalid,
    required,
  ...
  return /* @__PURE__ */ import_react26.default.createElement(Box, __spreadValues27(__spreadValues27({
    className: cx(classes.wrapper, className),
    sx,
    style
  }, systemStyles), wrapperProps), icon && /* @__PURE__ */ import_react26.default.createElement("div", {
    className: classes.icon
  }, icon), /* @__PURE__ */ import_react26.default.createElement(Element, __spreadProps11(__spreadValues27({}, rest), {
    ref,
    required,
  ...
  })), rightSection && /* @__PURE__ */ import_react26.default.createElement("div", __spreadProps11(__spreadValues27({}, rightSectionProps), {
...
var useStyles12 = createStyles((theme, { color, size: size2, radius: radius2 }) => ({
...
var ActionIcon_styles_default = useStyles12;
...
var ActionIcon = (0, import_react27.forwardRef)((props, ref) => {
  ...
  const loader = /* @__PURE__ */ import_react27.default.createElement(Loader, __spreadValues29({
    color: colors.color,
    size: theme.fn.size({ size: size2, sizes: sizes3 }) - 12
  }, loaderProps));
  return /* @__PURE__ */ import_react27.default.createElement(Box, __spreadValues29({
    component: component || "button",
...
function CloseIcon(props) {
  return /* @__PURE__ */ import_react28.default.createElement("svg", __spreadValues30({
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
...
var CloseButton = (0, import_react29.forwardRef)((_a, ref) => {
  ...
  return /* @__PURE__ */ import_react29.default.createElement(ActionIcon, __spreadValues31({
    size: size2,
    ref
  }, others), /* @__PURE__ */ import_react29.default.createElement(CloseIcon, {
    width: _iconSize,
    height: _iconSize
  }));
});
...
function ChevronIcon(_a) {
  var _b = _a, { size: size2, error, style } = _b, others = __objRest20(_b, ["size", "error", "style"]);
  const theme = useMantineTheme();
  const _size = theme.fn.size({ size: size2, sizes: iconSizes2 });
  return /* @__PURE__ */ import_react30.default.createElement("svg", __spreadValues32({
    width: _size,
    height: _size,
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg",
    style: __spreadValues32({ color: error ? theme.colors.red[6] : theme.colors.gray[6] }, style),
    "data-chevron": true
  }, others), /* @__PURE__ */ import_react30.default.createElement("path", {
...
function SelectRightSection({
  ...
  return shouldClear ? /* @__PURE__ */ import_react31.default.createElement(CloseButton, {
    variant: "transparent",
    "aria-label": clearButtonLabel,
    onClick: onClear,
    size: size2
  }) : /* @__PURE__ */ import_react31.default.createElement(ChevronIcon, {
    error,
    size: size2
  });
}
...
function getSelectRightSectionProps(_a) {
  ...
  return {
    ...
    rightSection: !(props.disabled && props.shouldClear) && /* @__PURE__ */ import_react32.default.createElement(SelectRightSection, __spreadValues33({}, props)),
    styles: __spreadProps13(__spreadValues33({}, _styles), {
      rightSection: __spreadProps13(__spreadValues33({}, _styles == null ? void 0 : _styles.rightSection), {
...
var NativeSelect = (0, import_react33.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("NativeSelect", defaultProps13, props), {
    id,
    className,
    required,
    label,
  ...
  const options = formattedData.map((item) => /* @__PURE__ */ import_react33.default.createElement("option", {
    key: item.value,
    value: item.value,
    disabled: item.disabled
  }, item.label));
  if (placeholder) {
    options.unshift(/* @__PURE__ */ import_react33.default.createElement("option", {
      key: "placeholder",
      value: "",
      disabled: true,
      hidden: true
  ...
  return /* @__PURE__ */ import_react33.default.createElement(InputWrapper, __spreadValues34(__spreadValues34({
    required,
    id: uuid,
    label,
    error,
  ...
  }, systemStyles), wrapperProps), /* @__PURE__ */ import_react33.default.createElement(Input, __spreadValues34(__spreadProps14(__spreadValues34({}, rest), {
    onChange,
    component: "select",
    invalid: !!error,
    style: inputStyle,
...
var useStyles13 = createStyles((theme, { spacing, breakpoints, cols }) => {
...
var SimpleGrid_styles_default = useStyles13;
...
var SimpleGrid = (0, import_react34.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("SimpleGrid", defaultProps14, props), { className, breakpoints, cols, spacing, children, classNames, styles: styles2 } = _a, others = __objRest23(_a, ["className", "breakpoints", "cols", "spacing", "children", "classNames", "styles"]);
  const { classes, cx } = SimpleGrid_styles_default({ breakpoints, cols, spacing }, { classNames, styles: styles2, name: "SimpleGrid" });
  return /* @__PURE__ */ import_react34.default.createElement(Box, __spreadValues36({
    className: cx(classes.root, className),
    ref
  }, others), children);
});
...
var useStyles14 = createStyles((theme, { captionSide, horizontalSpacing, verticalSpacing }, getRef2) => {
  const striped = { ref: getRef2("striped") };
  const hover = { ref: getRef2("hover") };
  return {
    striped,
    hover,
    root: __spreadProps15(__spreadValues37({}, theme.fn.fontStyles()), {
      width: "100%",
...
var Table_styles_default = useStyles14;
...
var Table = (0, import_react35.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Table", defaultProps15, props), {
    className,
    children,
    striped,
    highlightOnHover,
  ...
  return /* @__PURE__ */ import_react35.default.createElement(Box, __spreadProps16(__spreadValues38({}, others), {
    component: "table",
    ref,
...
var useStyles15 = createStyles((theme, { element, align }) => ({
  root: __spreadProps17(__spreadValues39({}, theme.fn.fontStyles()), {
...
var Title_styles_default = useStyles15;
...
var Title = (0, import_react36.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Title", defaultProps16, props), { className, order, children, align } = _a, others = __objRest25(_a, ["className", "order", "children", "align"]);
  const { classes, cx } = Title_styles_default({ element: `h${order}`, align }, { name: "Title" });
  if (![1, 2, 3, 4, 5, 6].includes(order)) {
    return null;
  }
  return /* @__PURE__ */ import_react36.default.createElement(Box, __spreadValues40({
    component: `h${order}`,
    ref,
    className: cx(classes.root, className)
  }, others), children);
...
// node_modules/@mantine/core/esm/components/AppShell/Navbar/NavbarSection/NavbarSection.js
init_react();
...
var NavbarSection = (0, import_react37.forwardRef)((_a, ref) => {
  var _b = _a, { component, children, grow = false, sx } = _b, others = __objRest26(_b, ["component", "children", "grow", "sx"]);
  return /* @__PURE__ */ import_react37.default.createElement(Box, __spreadValues41({
    component: component || "div",
    ref,
...
// node_modules/@mantine/core/esm/components/AppShell/Navbar/Navbar.styles.js
init_react();
...
var useStyles16 = createStyles((theme, { height, width, fixed, position: position2, hiddenBreakpoint, zIndex }) => {
  ...
  return {
    root: __spreadValues42(__spreadProps18(__spreadValues42(__spreadValues42({}, theme.fn.fontStyles()), position2), {
      zIndex,
      height,
...
var Navbar_styles_default = useStyles16;
...
var Navbar = (0, import_react38.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Navbar", defaultProps17, props), {
    width,
    height,
    fixed,
    position: position2,
  ...
  const { classes, cx } = Navbar_styles_default({ width, height, fixed, position: position2, hiddenBreakpoint, zIndex }, { classNames, styles: styles2, name: "Navbar" });
  return /* @__PURE__ */ import_react38.default.createElement(Box, __spreadValues43({
    component: "nav",
    ref,
...
var useStyles17 = createStyles((theme, { color, size: size2, radius: radius2, gradientFrom, gradientTo, gradientDeg, variant }) => {
  const colors = getSharedColorScheme({
    theme,
    color,
    variant,
  ...
  const iconSize = theme.fn.size({ size: size2, sizes: sizes4 });
  return {
    root: __spreadProps19(__spreadValues44({}, theme.fn.fontStyles()), {
      display: "inline-flex",
      alignItems: "center",
      justifyContent: "center",
      boxSizing: "border-box",
...
var ThemeIcon_styles_default = useStyles17;
...
var ThemeIcon = (0, import_react39.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("ThemeIcon", defaultProps18, props), { className, size: size2, radius: radius2, variant, color, children, gradient } = _a, others = __objRest28(_a, ["className", "size", "radius", "variant", "color", "children", "gradient"]);
  ...
  return /* @__PURE__ */ import_react39.default.createElement(Box, __spreadValues45({
    className: cx(classes.root, className),
    ref
  }, others), children);
});
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-KZNHTIGE.js.map
