...
var TokenSelect = (props) => {
  let { title, assetTokens, tokenComponent, isPay, placeholder } = props;
  const [selectedTokens, setSelectedTokens] = (0, import_react2.useState)([]);
...
var Swap = (props) => {
  ...
  const [selectedState, setSelectedState] = (0, import_react3.useState)({
    payTokensSelected: [],
    receiveTokensSelected: []
  });
  const [totalAllocation, setTotalAllocation] = (0, import_react3.useState)(0);
...
var Dashboard = (props) => {
  ...
  const [numeraire, setNumeraire] = (0, import_react4.useState)(poolToken);
...
//# sourceMappingURL=/build/_shared/chunk-LEAWL4SE.js.map
