...
var Swap = (props) => {
  ...
  const payerComponent = (props2) => {
    ...
    const handleAmountChange = (amount2) => {
      assetTokens[token.token_address].amount = amount2;
    };
  ...
  const receiverComponent = (props2) => {
    ...
    const handleAllocationChange = (allocation2) => {
      assetTokens[token.token_address].allocation = allocation2;
...
//# sourceMappingURL=/build/_shared/chunk-FXE5C6TB.js.map
