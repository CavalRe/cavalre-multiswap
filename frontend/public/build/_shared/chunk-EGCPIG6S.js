...
var Swap = (props) => {
  ...
  const [selectedPayTokens, setSelectedPayTokens] = (0, import_react2.useState)([]);
  const [selectedReceiveTokens, setSelectedReceiveTokens] = (0, import_react2.useState)([]);
  ...
  const getQuotes = () => {
    const { payTokensSelected, receiveTokensSelected } = selectedTokens;
...
//# sourceMappingURL=/build/_shared/chunk-EGCPIG6S.js.map
