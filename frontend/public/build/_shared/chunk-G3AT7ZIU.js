...
function useMediaQuery(query) {
  const [matches, setMatches] = (0, import_react19.useState)(getInitialValue(query));
  const queryRef = (0, import_react19.useRef)();
...
function useFocusReturn({
  ...
  const lastActiveElement = (0, import_react22.useRef)();
  const returnFocus = () => {
    var _a;
...
function useFocusTrap(active = true) {
  ...
  const restoreAria = (0, import_react23.useRef)(null);
  const setRef = (0, import_react23.useCallback)((node2) => {
    if (!active) {
      return;
    }
...
function useScrollLock(lock, options = {
  ...
  const [scrollLocked, setScrollLocked] = (0, import_react24.useState)(lock || false);
  const scrollTop = (0, import_react24.useRef)(0);
  const { disableBodyPadding } = options;
  const stylesheet = (0, import_react24.useRef)(null);
  const lockScroll = () => {
...
function useUuid(staticId) {
  const [uuid, setUuid] = (0, import_react25.useState)("");
  useIsomorphicEffect(() => {
    setUuid(randomId());
  }, []);
...
function Portal({
  ...
  return (0, import_react_dom.createPortal)(/* @__PURE__ */ import_react26.default.createElement("div", {
    className,
    dir: theme.dir,
...
var Paper = (0, import_react29.forwardRef)((_a, ref) => {
  var _b = _a, {
    component,
    className,
    children,
...
var Text = (0, import_react30.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    component,
    size: size2 = "md",
  ...
  return /* @__PURE__ */ import_react30.default.createElement(Box, __spreadValues26({
    ref,
    component: component || "div",
...
var ActionIcon = (0, import_react31.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    color = "gray",
    children,
...
function CloseIcon(props) {
  return /* @__PURE__ */ import_react32.default.createElement("svg", __spreadValues29({
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
...
var CloseButton = (0, import_react33.forwardRef)((_a, ref) => {
  ...
  return /* @__PURE__ */ import_react33.default.createElement(ActionIcon, __spreadValues30({
    size: size2,
    ref
  }, others), /* @__PURE__ */ import_react33.default.createElement(CloseIcon, {
    width: _iconSize,
    height: _iconSize
  }));
});
...
var Overlay = (0, import_react34.forwardRef)((_a, ref) => {
  var _b = _a, {
    opacity = 0.6,
    color = "#fff",
    gradient,
  ...
  return /* @__PURE__ */ import_react34.default.createElement(Box, __spreadValues31({
    component: component || "div",
    ref,
    sx: [
...
function MantineModal(_a) {
  ...
  return /* @__PURE__ */ import_react35.default.createElement(GroupedTransition, {
  ...
  }, (transitionStyles) => /* @__PURE__ */ import_react35.default.createElement(Box, __spreadValues32({
    className: cx(classes.root, className)
  }, others), /* @__PURE__ */ import_react35.default.createElement("div", {
    className: classes.inner,
    ...
    ref: focusTrapRef
  }, /* @__PURE__ */ import_react35.default.createElement(Paper, {
  ...
  }, (title || !hideCloseButton) && /* @__PURE__ */ import_react35.default.createElement("div", {
    className: classes.header
  }, /* @__PURE__ */ import_react35.default.createElement(Text, {
    id: titleId,
    className: classes.title
  }, title), !hideCloseButton && /* @__PURE__ */ import_react35.default.createElement(CloseButton, {
    iconSize: 16,
    onClick: onClose,
    ...
    id: bodyId,
    className: classes.body
  }, children))), /* @__PURE__ */ import_react35.default.createElement("div", {
    style: transitionStyles.overlay
  }, /* @__PURE__ */ import_react35.default.createElement(Overlay, {
...
function Modal(_c) {
  ...
  return /* @__PURE__ */ import_react35.default.createElement(Portal, {
    zIndex,
    target
  }, /* @__PURE__ */ import_react35.default.createElement(MantineModal, __spreadValues32({}, props)));
}
...
var Table = (0, import_react36.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    children,
    striped = false,
  ...
  return /* @__PURE__ */ import_react36.default.createElement(Box, __spreadProps15(__spreadValues34({}, others), {
    component: "table",
    ref,
...
var ThemeIcon = (0, import_react37.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    size: size2 = "md",
    radius = "sm",
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-G3AT7ZIU.js.map
