...
var Swap = (props) => {
  ...
  const getQuote = (swapState2) => {
    ...
    let newPoolTokens = poolToken2.outstanding - (poolToken2.isPay ? poolToken2.amount : 0);
    ...
    let totalAmountIn = assetAmountIn + (poolToken2.isPay ? poolToken2.amount : 0);
    console.log("-------------------------------");
    console.log("Before...");
    ...
    if (poolToken2.allocation !== 0) {
      const factor = 100 / poolToken2.allocation - getAssetAmountIn(selectedAssetPayTokens, 1);
      console.log(`factor: ${factor}`);
      const totalAmountOutNoFee = totalAmountIn / factor;
      const poolTokensOutNoFee = poolToken2.allocation * totalAmountOutNoFee / 100;
      const poolTokensOut = (1 - poolToken2.fee) * poolTokensOutNoFee;
      poolToken2.amount = -poolTokensOut;
      newPoolTokens = poolToken2.outstanding + poolTokensOut;
...
//# sourceMappingURL=/build/_shared/chunk-FU4RN32T.js.map
