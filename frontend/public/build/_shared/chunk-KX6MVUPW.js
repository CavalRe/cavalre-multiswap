...
var Dashboard = (props) => {
  ...
  (0, import_react.useEffect)(() => {
    if (isInitialized && !isWeb3Enabled && !isWeb3EnableLoading)
      enableWeb3();
    const newPathname = isAuthenticated && !isAuthenticating && account ? `/dashboard/${account}` : "/dashboard";
    if (isInitialized && !isAuthenticating && !isWeb3EnableLoading && newPathname !== pathname) {
      console.log("-----------------------------------");
    ...
    console.log(`isWen3EnableLoading: ${isWeb3EnableLoading}`);
  }, [isInitialized, isInitializing, isAuthenticated, isAuthenticating, isWeb3Enabled, isWeb3EnableLoading, account]);
  const assetMap = {};
...
//# sourceMappingURL=/build/_shared/chunk-KX6MVUPW.js.map
