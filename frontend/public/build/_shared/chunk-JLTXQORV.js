...
var Dashboard = (props) => {
  ...
  const poolBalance = poolToken.accountBalance;
  const poolTokens = poolToken.poolBalance;
  const price = (asset) => {
    return asset.weight ? poolTokens * asset.weight / asset.poolBalance : 1;
  };
  const balance = (asset) => {
  ...
  const rows = (_b = Object.values(assetTokens)) == null ? void 0 : _b.filter((a) => a.poolBalance > 0 && a.k !== void 0 && a.fee !== void 0).map((a, i) => /* @__PURE__ */ React.createElement("tr", {
    key: a.address
    ...
    size: cellTextSize
  }, (a.poolBalance / numeraire.price).toLocaleString(void 0, numberOptions))), /* @__PURE__ */ React.createElement("td", {
    align: "right"
  }, /* @__PURE__ */ React.createElement(Text, {
    size: cellTextSize
...
//# sourceMappingURL=/build/_shared/chunk-JLTXQORV.js.map
