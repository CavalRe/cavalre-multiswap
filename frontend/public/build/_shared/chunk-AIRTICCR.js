...
var useStyles6 = createStyles((theme, { fluid, size: size2, padding }) => ({
  root: {
...
var Container = (0, import_react18.forwardRef)((_a, ref) => {
  var _b = _a, { className, padding = "md", fluid, size: size2, styles: styles2, classNames } = _b, others = __objRest12(_b, ["className", "padding", "fluid", "size", "styles", "classNames"]);
  const { classes, cx } = Container_styles_default({ padding, fluid, size: size2 }, { styles: styles2, classNames, name: "Container" });
  return /* @__PURE__ */ import_react18.default.createElement(Box, __spreadValues20({
    className: cx(classes.root, className),
    ref
  }, others));
});
...
var useStyles7 = createStyles((theme, { captionSide, horizontalSpacing, verticalSpacing }, getRef2) => {
...
var Table_styles_default = useStyles7;
...
var Table = (0, import_react19.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    children,
    striped = false,
  ...
  return /* @__PURE__ */ import_react19.default.createElement(Box, __spreadProps9(__spreadValues22({}, others), {
    component: "table",
    ref,
...
var useStyles8 = createStyles((theme, { color, size: size2, radius, gradientFrom, gradientTo, gradientDeg, variant }) => {
  const colors = getSharedColorScheme({
    theme,
    color,
    variant,
  ...
  return {
    root: __spreadProps10(__spreadValues23({}, theme.fn.fontStyles()), {
      display: "inline-flex",
      alignItems: "center",
      justifyContent: "center",
      boxSizing: "border-box",
...
var ThemeIcon_styles_default = useStyles8;
...
var ThemeIcon = (0, import_react20.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    size: size2 = "md",
    radius = "sm",
  ...
  return /* @__PURE__ */ import_react20.default.createElement(Box, __spreadValues24({
    className: cx(classes.root, className),
    ref
  }, others), children);
});
...
var transitions = {
  ...
  pop: __spreadProps11(__spreadValues25({}, popIn), {
    common: { transformOrigin: "center center" }
  }),
  "pop-bottom-left": __spreadProps11(__spreadValues25({}, popIn), {
    common: { transformOrigin: "bottom left" }
  }),
  "pop-bottom-right": __spreadProps11(__spreadValues25({}, popIn), {
    common: { transformOrigin: "bottom right" }
  }),
  "pop-top-left": __spreadProps11(__spreadValues25({}, popIn), {
    common: { transformOrigin: "top left" }
  }),
  "pop-top-right": __spreadProps11(__spreadValues25({}, popIn), {
...
function useMediaQuery(query) {
  const [matches, setMatches] = (0, import_react21.useState)(getInitialValue(query));
  const queryRef = (0, import_react21.useRef)();
...
var useIsomorphicEffect = typeof document !== "undefined" ? import_react22.useLayoutEffect : import_react22.useEffect;
...
function useFocusReturn({
  ...
  const lastActiveElement = (0, import_react24.useRef)();
  const returnFocus = () => {
    var _a;
...
function useFocusTrap(active = true) {
  ...
  const restoreAria = (0, import_react25.useRef)(null);
  const setRef = (0, import_react25.useCallback)((node2) => {
    if (!active) {
      return;
    }
...
function useScrollLock(lock, options = {
  ...
  const [scrollLocked, setScrollLocked] = (0, import_react26.useState)(lock || false);
  const scrollTop = (0, import_react26.useRef)(0);
  const { disableBodyPadding } = options;
  const stylesheet = (0, import_react26.useRef)(null);
  const lockScroll = () => {
...
function useUuid(staticId) {
  const [uuid, setUuid] = (0, import_react27.useState)("");
  useIsomorphicEffect(() => {
    setUuid(randomId());
  }, []);
...
var useStyles9 = createStyles((theme, { color, size: size2, radius }) => ({
  root: __spreadProps12(__spreadValues26(__spreadValues26({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
    position: "relative",
    appearance: "none",
    WebkitAppearance: "none",
    WebkitTapHighlightColor: "transparent",
...
var ActionIcon = (0, import_react28.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    color = "gray",
    children,
  ...
  const loader = /* @__PURE__ */ import_react28.default.createElement(Loader, __spreadValues27({
    color: colors.color,
    size: theme.fn.size({ size: size2, sizes: sizes5 }) - 12
  }, loaderProps));
  return /* @__PURE__ */ import_react28.default.createElement(Box, __spreadValues27({
    component: component || "button",
...
function CloseIcon(props) {
  return /* @__PURE__ */ import_react29.default.createElement("svg", __spreadValues28({
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
...
var CloseButton = (0, import_react30.forwardRef)((_a, ref) => {
  var _b = _a, { iconSize, size: size2 = "md" } = _b, others = __objRest16(_b, ["iconSize", "size"]);
  const theme = useMantineTheme();
  const _iconSize = iconSize || theme.fn.size({ size: size2, sizes: iconSizes });
  return /* @__PURE__ */ import_react30.default.createElement(ActionIcon, __spreadValues29({
    size: size2,
    ref
  }, others), /* @__PURE__ */ import_react30.default.createElement(CloseIcon, {
    width: _iconSize,
    height: _iconSize
  }));
});
...
var useStyles10 = createStyles((theme, {
  color,
  variant,
  size: size2,
  lineClamp,
...
var Text_styles_default = useStyles10;
...
var Text = (0, import_react32.forwardRef)((_a, ref) => {
  var _b = _a, {
    className,
    component,
    size: size2 = "md",
...
function getTransitionStyles({
  ...
  if (typeof transition === "string") {
    ...
    return __spreadValues32(__spreadValues32(__spreadValues32({
...
var useStyles11 = createStyles((theme, { radius, shadow, padding, withBorder }) => ({
  root: __spreadProps14(__spreadValues33({}, theme.fn.focusStyles()), {
    WebkitTapHighlightColor: "transparent",
    display: "block",
    textDecoration: "none",
    color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
...
var Paper = (0, import_react34.forwardRef)((_a, ref) => {
  ...
  return /* @__PURE__ */ import_react34.default.createElement(Box, __spreadValues34({
    component: component || "div",
    className: cx(classes.root, className),
    ref
  }, others), children);
...
function GroupedTransition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react35.default.createElement(import_react35.default.Fragment, null, children({})) : null;
  }
  ...
  return /* @__PURE__ */ import_react35.default.createElement(import_react35.default.Fragment, null, children(transitionsStyles));
}
...
var Overlay = (0, import_react36.forwardRef)((_a, ref) => {
  var _b = _a, {
    opacity = 0.6,
    color = "#fff",
    gradient,
  ...
  return /* @__PURE__ */ import_react36.default.createElement(Box, __spreadValues35({
    ...
    ref,
    sx: [
      (theme) => __spreadProps15(__spreadValues35({}, background), {
        opacity,
        position: "absolute",
        top: 0,
        bottom: 0,
...
var useStyles12 = createStyles((theme, { overflow, size: size2, centered }) => ({
  close: {},
  overlay: {},
  root: {
    position: "fixed",
  ...
  modal: {
    position: "relative",
    zIndex: 5,
    width: theme.fn.size({ sizes: sizes6, size: size2 }),
    outline: 0,
    backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[7] : theme.white
  },
  header: {
...
var Modal_styles_default = useStyles12;
...
function MantineModal(_a) {
  ...
  return /* @__PURE__ */ import_react37.default.createElement(GroupedTransition, {
  ...
  }, (transitionStyles) => /* @__PURE__ */ import_react37.default.createElement(Box, __spreadValues36({
    className: cx(classes.root, className)
  }, others), /* @__PURE__ */ import_react37.default.createElement("div", {
    className: classes.inner,
    ...
    ref: focusTrapRef
  }, /* @__PURE__ */ import_react37.default.createElement(Paper, {
    ...
    "aria-modal": true,
    tabIndex: -1,
    style: __spreadProps16(__spreadValues36({}, transitionStyles.modal), {
      marginLeft: "calc(var(--removed-scroll-width, 0px) * -1)",
      zIndex: 3
    })
  }, (title || !hideCloseButton) && /* @__PURE__ */ import_react37.default.createElement("div", {
    className: classes.header
  }, /* @__PURE__ */ import_react37.default.createElement(Text, {
    id: titleId,
    className: classes.title
  }, title), !hideCloseButton && /* @__PURE__ */ import_react37.default.createElement(CloseButton, {
    iconSize: 16,
    onClick: onClose,
  ...
  }, /* @__PURE__ */ import_react37.default.createElement(Overlay, {
...
function Modal(_c) {
  var _d = _c, {
    zIndex = getDefaultZIndex("modal"),
    target
  } = _d, props = __objRest20(_d, [
    "zIndex",
    "target"
  ]);
  return /* @__PURE__ */ import_react37.default.createElement(Portal, {
    zIndex,
    target
  }, /* @__PURE__ */ import_react37.default.createElement(MantineModal, __spreadValues36({}, props)));
}
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-AIRTICCR.js.map
