...
var Dashboard = (props) => {
  const { isInitialized, isInitializing, isAuthenticated, isAuthenticating, account, isWeb3Enabled, isWeb3EnableLoading, enableWeb3 } = useMoralis();
  const { contractAddress, address, poolTokens, assets, balances, pathname } = props;
  const navigate = useNavigate();
  (0, import_react.useEffect)(() => {
    if (isAuthenticated && !isWeb3Enabled && !isWeb3EnableLoading)
      enableWeb3();
    const newPathname = isAuthenticated && !isAuthenticating ? pathname : "/dashboard";
    if (!isAuthenticating && !isWeb3EnableLoading && newPathname !== pathname)
...
//# sourceMappingURL=/build/_shared/chunk-RVWHREON.js.map
