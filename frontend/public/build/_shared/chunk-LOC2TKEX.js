...
var PayItem = (0, import_react.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ref
  }, /* @__PURE__ */ React.createElement(Button, null, /* @__PURE__ */ React.createElement(Text, {
    size: "md",
    mt: "md"
  }, value)));
});
var PayerSelect = (props) => {
  ...
  return /* @__PURE__ */ React.createElement(Card, {
    ...
    filter: (value2, selected, item) => {
      var _a;
      return !selected && (((_a = item.label) == null ? void 0 : _a.toLowerCase().includes(value2.toLowerCase().trim())) || item.description.toLowerCase().includes(value2.toLowerCase().trim()));
    }
  }));
};
...
//# sourceMappingURL=/build/_shared/chunk-LOC2TKEX.js.map
