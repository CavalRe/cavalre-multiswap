...
var PayerSelect = (props) => {
  ...
  const items = data.map((d) => {
    return {
      ...
      value: d.token_address,
      token_address: d.token_address,
      balance: d
    };
  });
  const [value, setValue] = (0, import_react.useState)([]);
  const PayItem = (0, import_react.forwardRef)(({ label, value: value2, token_address, ...others }, ref) => {
...
//# sourceMappingURL=/build/_shared/chunk-O5DBL56Y.js.map
