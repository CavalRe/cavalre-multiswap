...
var PayerSelect = (props) => {
  ...
  const PayValue = (0, import_react.forwardRef)(({
    label,
    value: value2,
    onRemove
  }, ref) => {
...
var ReceiverSelect = (props) => {
  ...
  const assetMap = {};
  const items = assets.map((a2) => {
    assetMap[a2.token_address] = a2;
    return {
      label: a2.symbol,
      value: a2.token_address
    };
  });
  const [value, setValue] = (0, import_react.useState)([]);
...
var Dashboard = (props) => {
  ...
  const assetMap = {};
  assets == null ? void 0 : assets.forEach((a2) => {
    assetMap[a2.token_address] = a2;
  });
  const balanceMap = {};
  ...
  const numeraires = [poolToken, ...assets == null ? void 0 : assets.map((a2) => ({ name: a2.name, symbol: a2.symbol, price: price(a2.token_address) }))];
  const numeraireMap = {};
  ...
  const cellTextSize2 = "md";
  const headerTextSize = "lg";
  const subTextSize = "sm";
  const rows = assets == null ? void 0 : assets.map((a2, i) => /* @__PURE__ */ React.createElement("tr", {
    key: a2.token_address
  }, /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement(Text, {
    size: cellTextSize2,
    color: "bold",
    component: "span"
  }, `${a2.name}`), /* @__PURE__ */ React.createElement(Text, {
    size: "xs",
    color: "dimmed",
    component: "span"
  }, ` (${a2.symbol})`))), address ? /* @__PURE__ */ React.createElement("td", {
    align: "right"
  }, /* @__PURE__ */ React.createElement(Text, {
    size: cellTextSize2
  }, (balance(a2.token_address) / numeraire.price).toLocaleString(void 0, numberOptions))) : null, /* @__PURE__ */ React.createElement("td", {
    align: "right"
  }, /* @__PURE__ */ React.createElement(Text, {
    size: cellTextSize2
  }, (price(a2.token_address) / numeraire.price).toLocaleString(void 0, numberOptions))), /* @__PURE__ */ React.createElement("td", {
    align: "right"
  }, /* @__PURE__ */ React.createElement(Text, {
    size: cellTextSize2
  }, (a2.reserve / numeraire.price).toLocaleString(void 0, numberOptions))), /* @__PURE__ */ React.createElement("td", {
    align: "right"
  }, /* @__PURE__ */ React.createElement(Text, {
    size: cellTextSize2
  }, (1e4 * a2.fee).toLocaleString())), /* @__PURE__ */ React.createElement("td", {
    align: "right"
  }, /* @__PURE__ */ React.createElement(Text, {
    size: cellTextSize2
  }, a2.k.toLocaleString()))));
...
//# sourceMappingURL=/build/_shared/chunk-3ZOVFIWS.js.map
