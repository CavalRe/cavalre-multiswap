...
function OptionalPortal(_a) {
  var _b = _a, { withinPortal = true, children } = _b, others = __objRest15(_b, ["withinPortal", "children"]);
  if (withinPortal) {
    return /* @__PURE__ */ import_react30.default.createElement(Portal, __spreadValues23({}, others), children);
  }
...
var transitions = {
  ...
  pop: __spreadProps8(__spreadValues24({}, popIn), {
    common: { transformOrigin: "center center" }
  }),
  "pop-bottom-left": __spreadProps8(__spreadValues24({}, popIn), {
    common: { transformOrigin: "bottom left" }
  }),
  "pop-bottom-right": __spreadProps8(__spreadValues24({}, popIn), {
    common: { transformOrigin: "bottom right" }
  }),
  "pop-top-left": __spreadProps8(__spreadValues24({}, popIn), {
    common: { transformOrigin: "top left" }
  }),
  "pop-top-right": __spreadProps8(__spreadValues24({}, popIn), {
...
function getTransitionStyles({
  ...
  if (typeof transition === "string") {
    ...
    return __spreadValues25(__spreadValues25(__spreadValues25({
...
var useStyles11 = createStyles((theme, {
  ...
  return {
    root: __spreadProps9(__spreadValues26(__spreadValues26(__spreadValues26({}, theme.fn.fontStyles()), theme.fn.focusStyles()), getLineClamp(lineClamp)), {
...
var Text = (0, import_react33.forwardRef)((props, ref) => {
...
var useStyles12 = createStyles((theme, { color, size: size2, radius: radius2 }) => ({
  root: __spreadProps10(__spreadValues28(__spreadValues28({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
    position: "relative",
    appearance: "none",
    WebkitAppearance: "none",
    WebkitTapHighlightColor: "transparent",
...
var ActionIcon = (0, import_react34.forwardRef)((props, ref) => {
  ...
  const loader = /* @__PURE__ */ import_react34.default.createElement(Loader, __spreadValues29({
    color: colors.color,
    size: theme.fn.size({ size: size2, sizes: sizes4 }) - 12
  }, loaderProps));
  return /* @__PURE__ */ import_react34.default.createElement(Box, __spreadValues29({
    component: component || "button",
...
function CloseIcon(props) {
  return /* @__PURE__ */ import_react35.default.createElement("svg", __spreadValues30({
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
...
var CloseButton = (0, import_react36.forwardRef)((_a, ref) => {
  ...
  return /* @__PURE__ */ import_react36.default.createElement(ActionIcon, __spreadValues31({
    size: size2,
    ref
...
var Overlay = (0, import_react37.forwardRef)((props, ref) => {
  ...
  const innerOverlay = (otherProps) => /* @__PURE__ */ import_react37.default.createElement(Box, __spreadValues32({
    component: component || "div",
    ref,
    sx: [
      (theme) => __spreadProps11(__spreadValues32(__spreadValues32({}, background), baseStyles), {
        opacity,
  ...
  if (blur) {
    return /* @__PURE__ */ import_react37.default.createElement(Box, __spreadValues32({
      sx: [
        () => __spreadProps11(__spreadValues32({}, baseStyles), {
...
function Modal(props) {
  ...
  return /* @__PURE__ */ import_react38.default.createElement(OptionalPortal, {
    withinPortal,
    zIndex,
    target
  }, /* @__PURE__ */ import_react38.default.createElement(GroupedTransition, {
  ...
  }, (transitionStyles) => /* @__PURE__ */ import_react38.default.createElement(Box, __spreadValues33({
    className: cx(classes.root, className)
    ...
    "aria-modal": true,
    tabIndex: -1,
    style: __spreadProps12(__spreadValues33({}, transitionStyles.modal), {
      marginLeft: "calc(var(--removed-scroll-width, 0px) * -1)",
      zIndex: 3
    })
  }, (title || withCloseButton) && /* @__PURE__ */ import_react38.default.createElement("div", {
    className: classes.header
  }, /* @__PURE__ */ import_react38.default.createElement(Text, {
    id: titleId,
    className: classes.title
  }, title), withCloseButton && /* @__PURE__ */ import_react38.default.createElement(CloseButton, {
    iconSize: 16,
    onClick: onClose,
...
var SimpleGrid = (0, import_react39.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("SimpleGrid", defaultProps14, props), { className, breakpoints, cols, spacing, children, classNames, styles: styles2 } = _a, others = __objRest21(_a, ["className", "breakpoints", "cols", "spacing", "children", "classNames", "styles"]);
...
var useStyles14 = createStyles((theme, { captionSide, horizontalSpacing, verticalSpacing }, getRef2) => {
  ...
  return {
    striped,
    hover,
    root: __spreadProps13(__spreadValues36({}, theme.fn.fontStyles()), {
      width: "100%",
...
var Table = (0, import_react40.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react40.default.createElement(Box, __spreadProps14(__spreadValues37({}, others), {
    component: "table",
    ref,
...
var Title = (0, import_react41.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Title", defaultProps16, props), { className, order, children, align } = _a, others = __objRest23(_a, ["className", "order", "children", "align"]);
  const { classes, cx } = Title_styles_default({ element: `h${order}`, align }, { name: "Title" });
  if (![1, 2, 3, 4, 5, 6].includes(order)) {
    return null;
  }
  return /* @__PURE__ */ import_react41.default.createElement(Box, __spreadValues39({
    component: `h${order}`,
    ref,
    className: cx(classes.root, className)
  }, others), children);
...
var useStyles16 = createStyles((theme, { size: size2 }) => ({
  root: __spreadProps16(__spreadValues40({}, theme.fn.fontStyles()), {
    lineHeight: theme.lineHeight
  }),
  label: {
    display: "inline-block",
...
var InputWrapper = (0, import_react42.forwardRef)((props, ref) => {
  ...
  const inputLabel = (0, import_react42.createElement)(labelElement, __spreadProps17(__spreadValues41(__spreadValues41({}, _labelProps), labelProps), {
    id: id ? `${id}-label` : void 0,
    className: classes.label
  }), /* @__PURE__ */ import_react42.default.createElement(import_react42.default.Fragment, null, label, required && /* @__PURE__ */ import_react42.default.createElement("span", {
    className: classes.required
  }, " *")));
  return /* @__PURE__ */ import_react42.default.createElement(Box, __spreadValues41({
    className: cx(classes.root, className),
    ref
  }, others), label && inputLabel, description && /* @__PURE__ */ import_react42.default.createElement(Text, __spreadProps17(__spreadValues41({}, descriptionProps), {
    color: "gray",
    className: classes.description
  }), description), children, typeof error !== "boolean" && error && /* @__PURE__ */ import_react42.default.createElement(Text, __spreadProps17(__spreadValues41({}, errorProps), {
    size: size2,
...
var Input = (0, import_react43.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react43.default.createElement(Box, __spreadValues42(__spreadValues42({
    className: cx(classes.wrapper, className),
    sx,
    style
  }, systemStyles), wrapperProps), icon && /* @__PURE__ */ import_react43.default.createElement("div", {
    className: classes.icon
  }, icon), /* @__PURE__ */ import_react43.default.createElement(Element, __spreadProps18(__spreadValues42({}, rest), {
    ref,
    required,
  ...
  })), rightSection && /* @__PURE__ */ import_react43.default.createElement("div", __spreadProps18(__spreadValues42({}, rightSectionProps), {
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-NDUZX5FN.js.map
