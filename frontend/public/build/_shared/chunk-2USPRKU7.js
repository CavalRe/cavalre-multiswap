...
init_react();
var useStyles6 = createStyles((theme, { fluid, size: size2, sizes: sizes4 }) => ({
  root: {
...
var Container = (0, import_react18.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Container", defaultProps6, props), { className, fluid, size: size2, styles: styles2, classNames, sizes: sizes4 } = _a, others = __objRest11(_a, ["className", "fluid", "size", "styles", "classNames", "sizes"]);
...
var useStyles9 = createStyles((theme, { captionSide, horizontalSpacing, verticalSpacing }, getRef2) => {
  const striped = { ref: getRef2("striped") };
  const hover = { ref: getRef2("hover") };
  return {
    striped,
    hover,
    root: __spreadProps8(__spreadValues22({}, theme.fn.fontStyles()), {
      width: "100%",
...
var Table = (0, import_react22.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react22.default.createElement(Box, __spreadProps9(__spreadValues23({}, others), {
    component: "table",
    ref,
...
var useStyles10 = createStyles((theme, { element, align }) => ({
  root: __spreadProps10(__spreadValues24({}, theme.fn.fontStyles()), {
...
var Title = (0, import_react23.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Title", defaultProps9, props), { className, order, children, align } = _a, others = __objRest15(_a, ["className", "order", "children", "align"]);
  const { classes, cx } = Title_styles_default({ element: `h${order}`, align }, { name: "Title" });
  if (![1, 2, 3, 4, 5, 6].includes(order)) {
    return null;
  }
  return /* @__PURE__ */ import_react23.default.createElement(Box, __spreadValues25({
    component: `h${order}`,
    ref,
    className: cx(classes.root, className)
  }, others), children);
...
var NavbarSection = (0, import_react24.forwardRef)((_a, ref) => {
  var _b = _a, { component, children, grow = false, sx } = _b, others = __objRest16(_b, ["component", "children", "grow", "sx"]);
...
var useStyles11 = createStyles((theme, { height, width, fixed, position: position2, hiddenBreakpoint, zIndex }) => {
  ...
  return {
    root: __spreadValues27(__spreadProps11(__spreadValues27(__spreadValues27({}, theme.fn.fontStyles()), position2), {
      zIndex,
      height,
...
var Navbar_styles_default = useStyles11;
...
var Navbar = (0, import_react25.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Navbar", defaultProps10, props), {
    width,
    height,
    fixed,
    position: position2,
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-2USPRKU7.js.map
