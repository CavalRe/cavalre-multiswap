...
var TokenSelect = (props) => {
  ...
  const handleSelect = (v) => {
    ...
    if (isPay && nSelected == 1 && selectedTokens.length == 0) {
      const oldAmount = assetTokens[v[0]].amount;
      assetTokens[v[0]].amount = oldAmount == 0 ? 1 : oldAmount;
...
//# sourceMappingURL=/build/_shared/chunk-6ECLSBZA.js.map
