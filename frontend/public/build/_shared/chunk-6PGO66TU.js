...
var PayComponent = (props) => {
  ...
  return /* @__PURE__ */ React.createElement(Card, {
    ...
    mt: "xs",
    position: "left"
  }, /* @__PURE__ */ React.createElement(Text, null, "Account Balance:"), /* @__PURE__ */ React.createElement(Text, null, token.accountBalance.toLocaleString()), /* @__PURE__ */ React.createElement(Text, null, token.symbol)), /* @__PURE__ */ React.createElement(Group, {
    mt: "xs",
    position: "left"
  }, /* @__PURE__ */ React.createElement(Text, null, "Pool Balance:"), /* @__PURE__ */ React.createElement(Text, null, token.accountBalance.toLocaleString()), /* @__PURE__ */ React.createElement(Text, null, token.symbol)));
};
...
var ReceiveComponent = (props) => {
  ...
  return /* @__PURE__ */ React.createElement(Card, {
    ...
    mt: "xs",
    position: "left"
  }, /* @__PURE__ */ React.createElement(Text, null, "Outstanding:"), /* @__PURE__ */ React.createElement(Text, null, token.contractBalance.toLocaleString()), /* @__PURE__ */ React.createElement(Text, null, token.symbol)) : /* @__PURE__ */ React.createElement(Group, {
    mt: "xs",
    position: "left"
  }, /* @__PURE__ */ React.createElement(Text, null, "Pool Reserve:"), /* @__PURE__ */ React.createElement(Text, null, token.contractBalance.toLocaleString()), /* @__PURE__ */ React.createElement(Text, null, token.symbol)));
};
...
var TokenSelect = (props) => {
  ...
  const getItems = () => {
    ...
    ;
    items2 = items2.concat(Object.values(assetTokens).filter((t) => isPay ? !t.isReceive : !t.isPay && t.contractBalance > 0).map((t) => {
      return {
...
var Swap = (props) => {
  ...
  const getQuote = (swapState2) => {
    ...
    const poolTokensPreAlloc = poolToken2.contractBalance - (poolToken2.isPay ? poolToken2.amount : 0);
...
var Dashboard = (props) => {
  ...
  return /* @__PURE__ */ React.createElement(Container, null, /* @__PURE__ */ React.createElement(Title, null, "Liquidity Pool"), isAuthenticated ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Button, {
    ...
    order: 3
  }, "Token Tokens"), /* @__PURE__ */ React.createElement(Text, {
    size: "xl",
    mt: "md"
...
//# sourceMappingURL=/build/_shared/chunk-6PGO66TU.js.map
