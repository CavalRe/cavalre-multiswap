import {
  init_extends
} from "/build/_shared/chunk-BDH2746W.js";
import {
  __commonJS,
  __toESM,
  init_react,
...
init_react();
var useStyles10 = createStyles((theme, { fluid, size: size2, sizes: sizes4 }) => ({
  root: {
    maxWidth: fluid ? "100%" : theme.fn.size({ size: size2, sizes: sizes4 }),
    marginLeft: "auto",
    marginRight: "auto"
  }
}));
...
var Container = (0, import_react22.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Container", defaultProps9, props), { className, fluid, size: size2, styles: styles2, classNames, sizes: sizes4 } = _a, others = __objRest15(_a, ["className", "fluid", "size", "styles", "classNames", "sizes"]);
  const { classes, cx } = Container_styles_default({ fluid, size: size2, sizes: sizes4 }, { styles: styles2, classNames, name: "Container" });
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-OYLQC3NK.js.map
