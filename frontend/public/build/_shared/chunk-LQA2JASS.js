...
var Dashboard = (props) => {
  ...
  (0, import_react.useEffect)(() => {
    const newPathname = isAuthenticated ? `/dashboard/${account}` : "/dashboard";
    ...
    if (isAuthenticated) {
      if (isWeb3Enabled && newPathname !== pathname)
        navigate(newPathname);
    } else {
      if (!isAuthenticating && !account && newPathname !== "/dashboard")
        navigate("/dashboard");
    }
    ;
...
//# sourceMappingURL=/build/_shared/chunk-LQA2JASS.js.map
