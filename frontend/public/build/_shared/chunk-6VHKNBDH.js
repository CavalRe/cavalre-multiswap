...
function filterFalsyChildren(children) {
  return import_react16.Children.toArray(children).filter(Boolean);
}
...
var Group = (0, import_react17.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react17.default.createElement(Box, __spreadValues17({
    className: cx(classes.root, className),
    ref
  }, others), items);
});
...
init_react();
var useStyles6 = createStyles((theme, { fluid, size: size2, sizes: sizes6 }) => ({
  root: {
...
var Container_styles_default = useStyles6;
...
var Container = (0, import_react18.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Container", defaultProps6, props), { className, fluid, size: size2, styles: styles2, classNames, sizes: sizes6 } = _a, others = __objRest11(_a, ["className", "fluid", "size", "styles", "classNames", "sizes"]);
  const { classes, cx } = Container_styles_default({ fluid, size: size2, sizes: sizes6 }, { styles: styles2, classNames, name: "Container" });
  return /* @__PURE__ */ import_react18.default.createElement(Box, __spreadValues18({
    className: cx(classes.root, className),
    ref
  }, others));
});
...
init_react();
var useStyles7 = createStyles((theme, { spacing, center }, getRef2) => {
  const itemWrapper = {
...
var ListItem_styles_default = useStyles7;
...
function ListItem(_a) {
  ...
  return /* @__PURE__ */ import_react19.default.createElement(Box, __spreadValues19({
    component: "li",
    className: cx(classes.item, { [classes.withIcon]: icon }, className)
  }, others), /* @__PURE__ */ import_react19.default.createElement("div", {
    className: classes.itemWrapper
  }, icon && /* @__PURE__ */ import_react19.default.createElement("span", {
    className: classes.itemIcon
  }, icon), /* @__PURE__ */ import_react19.default.createElement("span", null, children)));
}
...
var useStyles8 = createStyles((theme, { withPadding, size: size2, listStyleType }) => ({
  root: __spreadProps7(__spreadValues20({}, theme.fn.fontStyles()), {
    listStyleType,
    color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
    fontSize: theme.fn.size({ size: size2, sizes: theme.fontSizes }),
    lineHeight: theme.lineHeight,
...
var List_styles_default = useStyles8;
...
function filterChildrenByType(children, type) {
  return import_react20.Children.toArray(children).filter((item) => Array.isArray(type) ? type.some((component) => component === item.type) : item.type === type);
}
...
var List = (0, import_react21.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("List", defaultProps7, props), {
    children,
    type,
    size: size2,
    listStyleType,
  ...
  return /* @__PURE__ */ import_react21.default.createElement(Box, __spreadValues21({
...
function useMediaQuery(query) {
  const [matches, setMatches] = (0, import_react22.useState)(getInitialValue(query));
...
function useFocusReturn({
  ...
  const lastActiveElement = (0, import_react25.useRef)();
  const returnFocus = () => {
    var _a;
...
function useFocusTrap(active = true) {
  ...
  const restoreAria = (0, import_react26.useRef)(null);
  const setRef = (0, import_react26.useCallback)((node2) => {
    if (!active) {
      return;
    }
...
function useUuid(staticId) {
  const [uuid, setUuid] = (0, import_react28.useState)("");
  useIsomorphicEffect(() => {
    setUuid(randomId());
  }, []);
...
var useStyles9 = createStyles((theme, { overflow, size: size2, centered, zIndex }) => ({
  close: {},
  overlay: {},
  root: {
    position: "fixed",
...
var Modal_styles_default = useStyles9;
...
function Portal(props) {
  const { children, zIndex, target, className, position: position2 } = useMantineDefaultProps("Portal", defaultProps8, props);
  const theme = useMantineTheme();
...
function OptionalPortal(_a) {
  ...
  if (withinPortal) {
    return /* @__PURE__ */ import_react30.default.createElement(Portal, __spreadValues22({}, others), children);
  }
...
var transitions = {
  ...
  pop: __spreadProps8(__spreadValues23({}, popIn), {
    common: { transformOrigin: "center center" }
  }),
  "pop-bottom-left": __spreadProps8(__spreadValues23({}, popIn), {
    common: { transformOrigin: "bottom left" }
  }),
  "pop-bottom-right": __spreadProps8(__spreadValues23({}, popIn), {
    common: { transformOrigin: "bottom right" }
  }),
  "pop-top-left": __spreadProps8(__spreadValues23({}, popIn), {
    common: { transformOrigin: "top left" }
  }),
  "pop-top-right": __spreadProps8(__spreadValues23({}, popIn), {
...
function getTransitionStyles({
  ...
  if (typeof transition === "string") {
    ...
    return __spreadValues24(__spreadValues24(__spreadValues24({
...
function useTransition({
  ...
  const [transitionStatus, setStatus] = (0, import_react31.useState)(mounted ? "entered" : "exited");
  const [transitionDuration, setTransitionDuration] = (0, import_react31.useState)(reduceMotion ? 0 : duration);
  const timeoutRef = (0, import_react31.useRef)(-1);
  ...
  (0, import_react31.useEffect)(() => () => window.clearTimeout(timeoutRef.current), []);
  return {
    transitionDuration,
    transitionStatus,
...
function GroupedTransition({
  ...
  if (transitionDuration === 0) {
    return mounted ? /* @__PURE__ */ import_react32.default.createElement(import_react32.default.Fragment, null, children({})) : null;
  }
  ...
  return /* @__PURE__ */ import_react32.default.createElement(import_react32.default.Fragment, null, children(transitionsStyles));
}
...
var useStyles10 = createStyles((theme, { radius: radius2, shadow, withBorder }) => ({
  root: __spreadProps9(__spreadValues25({}, theme.fn.focusStyles()), {
    WebkitTapHighlightColor: "transparent",
    display: "block",
    textDecoration: "none",
    color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
...
var Paper_styles_default = useStyles10;
...
var defaultProps9 = {};
var Paper = (0, import_react33.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Paper", defaultProps9, props), { component, className, children, radius: radius2, withBorder, shadow } = _a, others = __objRest15(_a, ["component", "className", "children", "radius", "withBorder", "shadow"]);
  const { classes, cx } = Paper_styles_default({ radius: radius2, shadow, withBorder }, { name: "Paper" });
  return /* @__PURE__ */ import_react33.default.createElement(Box, __spreadValues26({
...
var useStyles11 = createStyles((theme, {
  color,
  variant,
  size: size2,
  lineClamp,
  ...
  return {
    root: __spreadProps10(__spreadValues27(__spreadValues27(__spreadValues27({}, theme.fn.fontStyles()), theme.fn.focusStyles()), getLineClamp(lineClamp)), {
...
var Text_styles_default = useStyles11;
...
var Text = (0, import_react34.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Text", defaultProps10, props), {
    className,
    component,
    size: size2 = "md",
    weight,
...
var useStyles12 = createStyles((theme, { color, size: size2, radius: radius2 }) => ({
  root: __spreadProps11(__spreadValues29(__spreadValues29({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
    position: "relative",
    appearance: "none",
    WebkitAppearance: "none",
    WebkitTapHighlightColor: "transparent",
...
var ActionIcon = (0, import_react35.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("ActionIcon", defaultProps11, props), {
    className,
    color,
    children,
    radius: radius2,
  ...
  const loader = /* @__PURE__ */ import_react35.default.createElement(Loader, __spreadValues30({
    color: colors.color,
    size: theme.fn.size({ size: size2, sizes: sizes4 }) - 12
  }, loaderProps));
  return /* @__PURE__ */ import_react35.default.createElement(Box, __spreadValues30({
    component: component || "button",
...
function CloseIcon(props) {
  return /* @__PURE__ */ import_react36.default.createElement("svg", __spreadValues31({
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
...
var CloseButton = (0, import_react37.forwardRef)((_a, ref) => {
  ...
  return /* @__PURE__ */ import_react37.default.createElement(ActionIcon, __spreadValues32({
    size: size2,
    ref
...
var Overlay = (0, import_react38.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Overlay", defaultProps12, props), { opacity, blur, color, gradient, zIndex, component, radius: radius2, sx } = _a, others = __objRest19(_a, ["opacity", "blur", "color", "gradient", "zIndex", "component", "radius", "sx"]);
  ...
  const innerOverlay = (otherProps) => /* @__PURE__ */ import_react38.default.createElement(Box, __spreadValues33({
    component: component || "div",
    ref,
    sx: [
      (theme) => __spreadProps12(__spreadValues33(__spreadValues33({}, background), baseStyles), {
        opacity,
  ...
  if (blur) {
    return /* @__PURE__ */ import_react38.default.createElement(Box, __spreadValues33({
      sx: [
        () => __spreadProps12(__spreadValues33({}, baseStyles), {
...
function Modal(props) {
  const _a = useMantineDefaultProps("Modal", defaultProps13, props), {
    className,
    opened,
    title,
    onClose,
  ...
  return /* @__PURE__ */ import_react39.default.createElement(OptionalPortal, {
  ...
  }, (transitionStyles) => /* @__PURE__ */ import_react39.default.createElement(Box, __spreadValues34({
    className: cx(classes.root, className)
    ...
    "aria-modal": true,
    tabIndex: -1,
    style: __spreadProps13(__spreadValues34({}, transitionStyles.modal), {
...
var useStyles13 = createStyles((theme, { captionSide, horizontalSpacing, verticalSpacing }, getRef2) => {
...
var Table_styles_default = useStyles13;
...
var Table = (0, import_react40.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Table", defaultProps14, props), {
    className,
    children,
    striped,
    highlightOnHover,
  ...
  return /* @__PURE__ */ import_react40.default.createElement(Box, __spreadProps15(__spreadValues36({}, others), {
    component: "table",
    ref,
...
var NavbarSection = (0, import_react41.forwardRef)((_a, ref) => {
  var _b = _a, { component, children, grow = false, sx } = _b, others = __objRest22(_b, ["component", "children", "grow", "sx"]);
...
var useStyles14 = createStyles((theme, { height, width, fixed, position: position2, hiddenBreakpoint, zIndex }) => {
  ...
  return {
    root: __spreadValues38(__spreadProps16(__spreadValues38(__spreadValues38({}, theme.fn.fontStyles()), position2), {
      zIndex,
      height,
...
var Navbar_styles_default = useStyles14;
...
var Navbar = (0, import_react42.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Navbar", defaultProps15, props), {
    width,
    height,
    fixed,
    position: position2,
  ...
  return /* @__PURE__ */ import_react42.default.createElement(Box, __spreadValues39({
    component: "nav",
    ref,
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-6VHKNBDH.js.map
