...
function Bars(_a) {
  ...
  return /* @__PURE__ */ import_react17.default.createElement("svg", __spreadValues15({
    viewBox: "0 0 135 140",
...
function Oval(_a) {
  ...
  return /* @__PURE__ */ import_react18.default.createElement("svg", __spreadValues16({
    width: `${size2}px`,
    height: `${size2}px`,
    viewBox: "0 0 38 38",
    xmlns: "http://www.w3.org/2000/svg",
...
function Dots(_a) {
  ...
  return /* @__PURE__ */ import_react19.default.createElement("svg", __spreadValues17({
    width: `${size2}px`,
    height: `${size2 / 4}px`,
    viewBox: "0 0 120 30",
    xmlns: "http://www.w3.org/2000/svg",
...
function Loader(props) {
  const _a = useMantineDefaultProps("Loader", defaultProps6, props), {
    size: size2 = "md",
    color,
    variant
...
var NavbarSection = (0, import_react21.forwardRef)((_a, ref) => {
  var _b = _a, { component, children, grow = false, sx } = _b, others = __objRest13(_b, ["component", "children", "grow", "sx"]);
...
var Navbar_styles_default = useStyles7;
...
var Navbar = (0, import_react22.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Navbar", defaultProps7, props), {
    width,
    height,
    fixed,
    position: position2,
...
var useStyles8 = createStyles((theme, { height, fixed, position: position2, zIndex }) => ({
  root: __spreadProps8(__spreadValues22(__spreadValues22({}, theme.fn.fontStyles()), position2), {
    zIndex,
    height,
    maxHeight: height,
    position: fixed ? "fixed" : "static",
...
var Header_styles_default = useStyles8;
...
var Header = (0, import_react23.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Header", defaultProps8, props), { children, className, classNames, styles: styles2, height, fixed, position: position2, zIndex } = _a, others = __objRest15(_a, ["children", "className", "classNames", "styles", "height", "fixed", "position", "zIndex"]);
...
var useStyles9 = createStyles((theme, {
  ...
  return {
    ...
    input: variant === "headless" ? {} : __spreadProps9(__spreadValues24(__spreadProps9(__spreadValues24({}, theme.fn.fontStyles()), {
...
var useStyles10 = createStyles((theme, {
  ...
  return {
    ...
    root: __spreadProps10(__spreadValues25(__spreadValues25(__spreadValues25(__spreadValues25({}, getSizeStyles({ compact, size: size2 })), theme.fn.fontStyles()), theme.fn.focusStyles()), getWidthStyles(fullWidth)), {
      borderRadius: theme.fn.radius(radius2),
      fontWeight: 600,
      position: "relative",
      lineHeight: 1,
...
var Button_styles_default = useStyles10;
...
var Button = (0, import_react24.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Button", defaultProps9, props), {
    className,
    size: size2,
    color,
    type,
  ...
  const loader = /* @__PURE__ */ import_react24.default.createElement(Loader, __spreadValues26({
    color: colors.color,
  ...
  }, others), /* @__PURE__ */ import_react24.default.createElement("div", {
    className: classes.inner
  }, (leftIcon || loading && loaderPosition === "left") && /* @__PURE__ */ import_react24.default.createElement("span", {
    className: cx(classes.icon, classes.leftIcon)
  }, loading && loaderPosition === "left" ? loader : leftIcon), /* @__PURE__ */ import_react24.default.createElement("span", {
    className: classes.label,
    style: { textTransform: uppercase ? "uppercase" : void 0 }
  }, children), (rightIcon || loading && loaderPosition === "right") && /* @__PURE__ */ import_react24.default.createElement("span", {
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-OG6DOG6M.js.map
